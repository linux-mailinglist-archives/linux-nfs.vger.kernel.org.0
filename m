...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B578A1C5EF1
	for <lists+linux-nfs@lfdr.de>; Tue,  5 May 2020 19:34:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730408AbgEEReg (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Tue, 5 May 2020 13:34:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52210 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-FAIL-OK-FAIL)
        by vger.kernel.org with ESMTP id S1729663AbgEERef (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Tue, 5 May 2020 13:34:35 -0400
Received: from mail-wr1-x431.google.com (mail-wr1-x431.google.com [IPv6:2a00:1450:4864:20::431])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 792A7C061A0F
        for <linux-nfs@vger.kernel.org>; Tue,  5 May 2020 10:34:35 -0700 (PDT)
Received: by mail-wr1-x431.google.com with SMTP id e16so3740163wra.7
        for <linux-nfs@vger.kernel.org>; Tue, 05 May 2020 10:34:35 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:subject:date:message-id:mime-version
         :content-transfer-encoding:thread-index:content-language;
        bh=5R6Xw32uPFyvknn2MSRki2vW9MFgEWb60lMIPOnYFJ0=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:subject:date:message-id:mime-version
         :content-transfer-encoding:thread-index:content-language;
        bh=5R6Xw32uPFyvknn2MSRki2vW9MFgEWb60lMIPOnYFJ0=;
        b=
X-Gm-Message-State: AGi0PubAhH965LoXyYMGYlcwtTeps9krjkBQ2yvALn+UorcFhq4TYBTy
        i+afMx9WilE6426x88ydcqLReCdk1QY=
X-Google-Smtp-Source: APiQypLdLrMut8fTmzeY3qp8mCnS3mi6uGUvCF8C9G/EElTk2e9VQdUxIYgJz9KPlGf5qMvj/FbfQg==
X-Received: by 2002:adf:e84f:: with SMTP id d15mr5227889wrn.296.1588700073577;
        Tue, 05 May 2020 10:34:33 -0700 (PDT)
Received: from WINDOWSSS5SP16 (cpc96954-walt26-2-0-cust383.13-2.cable.virginm.net. [82.31.89.128])
        by smtp.gmail.com with ESMTPSA id e21sm4330363wrc.1.2020.05.05.10.34.32
        for <linux-nfs@vger.kernel.org>
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Tue, 05 May 2020 10:34:32 -0700 (PDT)
From:   "Robert Milkowski" <rmilkowski@gmail.com>
To:     <linux-nfs@vger.kernel.org>
Subject: NFS v4 + kerberos: 4 minute window of slowness
Date:   Tue, 5 May 2020 18:34:32 +0100
Message-ID: <20ce01d62303$70571e80$51055b80$@gmail.com>
MIME-Version: 1.0
Content-Type: text/plain;
        charset="iso-8859-1"
Content-Transfer-Encoding: quoted-printable
X-Mailer: Microsoft Outlook 16.0
Thread-Index: AdYjA0EsG4HeF4PiRI6X+nNMAJWhhQ==
...
writes
to NFSv4 are synchronous and all dirty pages associated with the file =
being
...
buffered writes. The way it is currently implemented though is rather =
crude.
In my opinion, instead of making everything slow for the whole 4 =
minutes, it
should first try to refresh the context immediately and if successful =
things
go back to normal,
if it can't refresh the context then it should continue with the =
previous
one and revert to the current behaviour. I implemented a na=EFve quick =
fix
...
15:28:02 write(1, "aa\n", 3)            =3D 3 <0.000112>
15:28:12 write(1, "aa\n", 3)            =3D 3 <0.000112>
15:28:22 write(1, "aa\n", 3)            =3D 3 <0.001510>     <<<<<< slow
...
15:32:02 write(1, "aa\n", 3)            =3D 3 <0.001501>
15:32:12 write(1, "aa\n", 3)            =3D 3 <0.001440>
15:32:22 write(1, "aa\n", 3)            =3D 3 <0.000136>     <<<<<< fast
15:32:32 write(1, "aa\n", 3)            =3D 3 <0.000109>
15:32:42 write(1, "aa\n", 3)            =3D 3 <0.000110>
15:32:52 write(1, "aa\n", 3)            =3D 3 <0.000112>
15:33:02 write(1, "aa\n", 3)            =3D 3 <0.000103>
15:33:12 write(1, "aa\n", 3)            =3D 3 <0.000112>
15:33:22 write(1, "aa\n", 3)            =3D 3 <0.001405>     <<<<<< slow
15:33:32 write(1, "aa\n", 3)            =3D 3 <0.001393>
15:33:42 write(1, "aa\n", 3)            =3D 3 <0.001479>
...
...
{
        struct gss_cred *gss_cred =3D container_of(rc, struct gss_cred,
gc_base);
        struct gss_cl_ctx *ctx;
        unsigned long timeout =3D jiffies + (gss_key_expire_timeo * HZ);
        int ret =3D 0;
...
is to
expire (use RPCGSSDARGS=3D"-t 400" or any value larger than 300 to =
test),
it will now try to refresh the context and if successful then writes =
will be
fast again (assuming -t option is >300s and/or krb ticket is valid for =
more
than 300s).

What I haven't tested nor analysed code is what would happen if it now =
fails
to refresh the context, but after a quick glance at gss_refresh() it =
does
