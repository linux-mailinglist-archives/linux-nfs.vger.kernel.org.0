Return-Path: <linux-nfs+bounces-3663-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 2CB35904959
	for <lists+linux-nfs@lfdr.de>; Wed, 12 Jun 2024 05:08:13 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 4910D1F23548
	for <lists+linux-nfs@lfdr.de>; Wed, 12 Jun 2024 03:08:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CB302208D6;
	Wed, 12 Jun 2024 03:08:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="Xm7DgD/J"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A7086208C3
	for <linux-nfs@vger.kernel.org>; Wed, 12 Jun 2024 03:08:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1718161684; cv=none; b=pvmwSmCTRN6GxmjXty5regOgzeFvoOpl+2U0p6iuZSflfZEt6zJklpUSMIj9Kif5UUyZZfzGX3zOTUdwJhhyw/I8x8QU9J1OmxpUhJjXC33s/hqLCE9x4W2G7j4wIik5i39k0B8YJ9OQIM/f7cXs9Kw2fvlGxuDh7mF7Fkx00m8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1718161684; c=relaxed/simple;
	bh=J5x60hQDw0LQucmpfTl9sTCKr9wLkY0/cxXZaTyOSA0=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=gtLrEIFNEJzB/8iu2ROSg67quFMB3D976lAoZjrsWc8Jmurnr4KW0dpf7epeZXbK/6EcJUwdS10D9lqWtKcT+ctdNsCynLuGH9vL2TWklHD3Fl0SFTQM/OVSE1MxuqKuKDQ6tUnvyyjcW/x2NK4TBwB6BZUCRu6J+WcpwXSbPz4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=Xm7DgD/J; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 67AB4C2BD10;
	Wed, 12 Jun 2024 03:08:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1718161684;
	bh=J5x60hQDw0LQucmpfTl9sTCKr9wLkY0/cxXZaTyOSA0=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
	b=
...
Subject: [RFC PATCH v2 07/15] nfs/nfsd: add "localio" support
Date: Tue, 11 Jun 2024 23:07:44 -0400
Message-ID: <20240612030752.31754-8-snitzer@kernel.org>
...
index 958c8de072e2..62909e5594b1 100644
--- a/fs/nfs/internal.h
+++ b/fs/nfs/internal.h
@@ -451,6 +451,61 @@ extern void nfs_set_cache_invalid(struct inode *inode, unsigned long flags);
...
index 000000000000..b3996bf9c45d
--- /dev/null
+++ b/fs/nfs/localio.c
@@ -0,0 +1,798 @@
...
index b8736a82e57c..51d52fb0cd04 100644
--- a/fs/nfsd/Makefile
+++ b/fs/nfsd/Makefile
@@ -23,3 +23,5 @@ nfsd-$(CONFIG_NFSD_PNFS) += nfs4layouts.o
...
new file mode 100644
index 000000000000..6a418aa5614f
--- /dev/null
+++ b/fs/nfsd/localio.c
@@ -0,0 +1,184 @@
+// SPDX-License-Identifier: GPL-2.0-only
...
+
+	if (!rpcauth_map_to_svc_cred_local(rpc_clnt->cl_auth, cred,
+					   &rqstp->rq_cred)) {
+		dprintk("%s rpcauth_map_to_svc_cred_local failed\n", __func__);
+		status = -EINVAL;
+		goto out_err;
+	}
+
