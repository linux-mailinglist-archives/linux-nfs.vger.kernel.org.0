Return-Path: <linux-nfs+bounces-4754-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id DFED892C3A9
	for <lists+linux-nfs@lfdr.de>; Tue,  9 Jul 2024 21:05:15 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 3860C1F21C65
	for <lists+linux-nfs@lfdr.de>; Tue,  9 Jul 2024 19:05:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 80DD51DFCF;
	Tue,  9 Jul 2024 19:05:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="bj9Fe/yY"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5C6F71B86E3
	for <linux-nfs@vger.kernel.org>; Tue,  9 Jul 2024 19:05:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1720551910; cv=none; b=DOT+pJIXv7IMPkFwJUGakQV/VDNSdMye1gjh8yv4KDQkuL0AaA0Mu92jOZoCEhVh0U9u0uiWmWakR2ZS/AZtHl2MrWJ0WFj1pOPTHJqnnveDQvB/0NQf6v2c3WiZJyKVDgGAn3/kkG4pwSmJ/K4F9TW9ZztF2aptBAipu+aJi7k=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1720551910; c=relaxed/simple;
	bh=gWQan4fFX/5oDQo4DEa59K1/5r1rrsvh2F2NVq7+WZE=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=bVFzxEHFX3x+fhLuMjRRBpPWLRrfTYxo2dOluymivx3y9bRJM9VsxV8DJBeDE0LVlcVwTCw9VH1Ysxmn+uOOVJpmEkHwwrfDMvgZh4oTGFr+zpjPPWJcgjfzh1sJIeZdSYvYcgILz6WcH92j70UaAMDhE2YOXboL8E5zKduc4gY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=bj9Fe/yY; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 47371C3277B;
	Tue,  9 Jul 2024 19:05:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1720551909;
	bh=gWQan4fFX/5oDQo4DEa59K1/5r1rrsvh2F2NVq7+WZE=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <e1480c3a6ec15d6df9edd26bdb9e39a2edb51c6a.camel@kernel.org>
Subject: Re: Leaked nfsd_file due to race condition and early unhash
 (fs/nfsd/filecache.c)
From: Jeff Layton <jlayton@kernel.org>
To: Youzhong Yang <youzhong@gmail.com>
Cc: Chuck Lever <chuck.lever@oracle.com>, linux-nfs@vger.kernel.org
Date: Tue, 09 Jul 2024 15:05:07 -0400
In-Reply-To: <CADpNCvY-hTbO6OGAHO4N43UZjEtv5eyDmNU-S19ULn1iUOES3A@mail.gmail.com>
References: 
...
> =C2=A0};
>=20
> On Mon, Jul 8, 2024 at 10:55=E2=80=AFAM Jeff Layton <jlayton@kernel.org>
> wrote:
> >=20
...
> >=20
> > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 if (refcount_dec_and_test(&n=
f->nf_ref))
...
> >=20
> > > On Mon, Jul 8, 2024 at 9:35=E2=80=AFAM Jeff Layton <jlayton@kernel.or=
g>
> > > wrote:
> > > >=20
...
> > > > > =C2=A0=C2=A0=C2=A0 to 0, runs nfsd_file_unhash(), removes it from=
 the LRU
> > > > > and
> > > > > adds to
> > > > > the dispose
> > > > > =C2=A0=C2=A0=C2=A0 list [list_lru_isolate_move(lru, &nf->nf_lru, =
head)]
> > > > > =C2=A0 * nfsd_file_put() detects NFSD_FILE_HASHED bit is cleared,
> > > > > so
> > > > > it
> > > > > tries to remove
> > > > > =C2=A0=C2=A0=C2=A0 the 'nf' from the LRU [if (!nfsd_file_lru_remo=
ve(nf))].
> > > > > The
> > > > > 'nf'
> > > > > has been added
> > > > > =C2=A0=C2=A0=C2=A0 to the 'dispose' list by nfsd_file_lru_cb(), s=
o
> > > > > nfsd_file_lru_remove(nf) simply
> > > > > =C2=A0=C2=A0=C2=A0 treats it as part of the LRU and removes it, w=
hich leads
> > > > > to
> > > > > its removal from
> > > > > =C2=A0=C2=A0=C2=A0 the 'dispose' list.
> > > > > =C2=A0 * At this moment, 'nf' is unhashed with its nf_ref being 0=
,
> > > > > and
> > > > > not
> > > > > on the LRU.
...
> > > > > =C2=A0=C2=A0=C2=A0 as nf->nf_ref is already 0, nf->nf_ref is set =
to
...
.
> > > > > =C2=A0 * Some userland application runs 'exportfs -f' or somethin=
g
> > > > > like
> > > > > that, which triggers
> > > > > =C2=A0=C2=A0=C2=A0 __nfsd_file_cache_purge() -> nfsd_file_cond_qu=
eue().
...
> > > > > &nf->nf_ref))]
> > > > > =C2=A0=C2=A0=C2=A0 (with "decrement" being 2), so the nf->nf_ref =
goes to 0,
> > > > > the
> > > > > 'nf'
> > > > > is added to the
...
> > > > > although
> > > > > the 'nf' is not
> > > > > =C2=A0=C2=A0=C2=A0 in the LRU, but it is linked in the 'dispose' =
list,
> > > > > nfsd_file_lru_remove() simply
> > > > > =C2=A0=C2=A0=C2=A0 treats it as part of the LRU and removes it. T=
his leads
> > > > > to
> > > > > its removal from
> > > > > =C2=A0=C2=A0=C2=A0 the 'dispose' list!
...
> > > > on
> > > > the
> > > > dispose list.=C2=A0 I think you probably just want to do a patch
> > > > that
...
nf_lru);
> > > > > +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 list_add(&nf->nf_gc, head);
> > > > > +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 /* Unhash after removing fr=
om LRU and adding to
> > > > > dispose
> > > > > list */
> > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 nfsd_file_unhash(nf);
...
> > > > > +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0 /* Unhash after adding to dispose list */
> > > > > +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=
...
> > > > > > >=20
> > > > > > > -=C2=A0 I understand zfs is an out-of-tree file system. That'=
s
> > > > > > > fine. But
...
> > > > > > >=20
> > > > > > > -=C2=A0 I will try to come up with a reproducer using xfs or
> > > > > > > btrfs
> > > > > > > if possible.
> > > > > > >=20
...
> > > > > > > nfsd_file_lru_cb()):
> > > > > > >=20
> > > > > > > =C2=A0 * In nfsd_file_put(), nf->nf_ref is 1, so it tries to
> > > > > > > do
> > > > > > > nfsd_file_lru_add().
> > > > > > > =C2=A0 * nfsd_file_lru_add() returns true (thus
> > > > > > > NFSD_FILE_REFERENCED bit
> > > > > > > set for nf->nf_flags)
> > > > > > > =C2=A0 * garbage collector kicks in, nfsd_file_lru_cb() clear=
s
> > > > > > > REFERENCED
> > > > > > > bit and returns LRU_ROTATE.
> > > > > > > =C2=A0 * garbage collector kicks in again, nfsd_file_lru_cb()
> > > > > > > now
...
> > > > > > > from the
> > > > > > > 'dispose' list.
> > > > > > > =C2=A0 * At this moment, nf->nf_ref is 0, it's unhashed, and
> > > > > > > not
> > > > > > > on the
...
> > > > > > > do
> > > > > > > nfsd_file_lru_add().
> > > > > > > =C2=A0 * nfsd_file_lru_add() sets REFERENCED bit and returns
> > > > > > > true.
...
> > > > > > > =C2=A0 * Now nf->ref is 0, unhashed. nfsd_file_put() continue=
s
> > > > > > > its
...
> > > > > > > +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * Racing with nfsd_file_cond_queue() or
> > > > > > > nfsd_file_lru_cb(),
> > > > > > > +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * it's unhashed but then removed from
> > > > > > > the
> > > > > > > dispose list,
> > > > > > > +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * so we need to free it.
> > > > > > > +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 */
> > > > > > > +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0 if (refcount_read(&nf->nf_ref) =3D=3D 0 &&
> > > > > >=20
...
> > > > > >=20
> > > > > > > +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 !test_bit(NFSD_FILE_HASHED=
, &nf-
> > > > > > > > nf_flags) &&
> > > > > > > +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 list_empty(&nf->nf_lru)) {
> > > > > > > +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
...
=C2=A0=C2=A0=C2=A0=C2=A0 }
> > > > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 }
> > > > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 if (refcount_dec_a=
nd_test(&nf->nf_ref))
> > > > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 nfsd_file_free(nf);
> > > > > > > @@ -576,7 +587,7 @@ nfsd_file_cond_queue(struct nfsd_file
> > > > > > > *nf, struct
> > > > > > > list_head *dispose)
> > > > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 int decrement =3D =
1;
> > > > > > >=20
> > > > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 /* If we raced wit=
h someone else unhashing,
> > > > > > > ignore it
> > > > > > > */
> > > > > > > -=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 if (!nfsd_file_unhash(n=
f))
> > > > > > > +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 if (!test_bit(NFSD_FILE=
_HASHED, &nf->nf_flags))
> > > > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
...
> > > > > >=20
> > > > > > >=20
> > > > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 /* If we can't get=
 a reference, ignore it */
> > > > > > > @@ -590,6 +601,7 @@ nfsd_file_cond_queue(struct nfsd_file
> > > > > > > *nf, struct
> > > > > > > list_head *dispose)
> > > > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 /* If refcount goe=
s to 0, then put on the dispose
> > > > > > > list */
> > > > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 if (refcount_sub_a=
nd_test(decrement, &nf-
> > > > > > > >nf_ref)) {
> > > > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 list_add(&nf->nf_lru, dispose);
> > > > > > > +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0 nfsd_file_unhash(nf);
> > > > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 trace_nfsd_file_closing(nf);
> > > > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 }
> > > > > > > =C2=A0}
> > > > > > > --
> > > > > > > 2.43.0
...
> > > > > > > > what
> > > > > > > > is the
> > > > > > > > =C2=A0 simplest program that can run on an NFS client that
> > > > > > > > will
> > > > > > > > trigger
...
> > > > > > > > issues in
> > > > > > > > =C2=A0 upstream Linux first (currently that's v6.10-rc6).
> > > > > > > > Then
> > > > > > > > that fix
...
> > > > > > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 next =3D 0xffff8921fa2392f=
1
> > > > > > > > > =C2=A0=C2=A0=C2=A0 },
...
nux.git/tree/Documentation/process/submitting-patches.rst?h=3Dv6.10-rc6
> > > > > > > >=20
...
> > > > > > > > > +=C2=A0=C2=A0=C2=A0=C2=A0 !test_bit(NFSD_FILE_HASHED, &nf=
->nf_flags) &&
...
> > > > > > > > >=20
> > > > > > > > > =C2=A0 /* If we raced with someone else unhashing, ignore
> > > > > > > > > it
> > > > > > > > > */
...
> > > > > > > > > *nf, struct
> > > > > > > > > list_head *dispose)
> > > > > > > > > =C2=A0 /* If refcount goes to 0, then put on the dispose
> > > > > > > > > list
> > > > > > > > > */
