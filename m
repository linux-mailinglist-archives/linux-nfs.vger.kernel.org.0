...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D5CDCA74A8
	for <lists+linux-nfs@lfdr.de>; Tue,  3 Sep 2019 22:33:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727376AbfICUcU (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Tue, 3 Sep 2019 16:32:20 -0400
Received: from mx1.redhat.com ([209.132.183.28]:37262 "EHLO mx1.redhat.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727314AbfICUcT (ORCPT <rfc822;linux-nfs@vger.kernel.org>);
        Tue, 3 Sep 2019 16:32:19 -0400
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com [10.5.11.23])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mx1.redhat.com (Postfix) with ESMTPS id F1708308339B;
        Tue,  3 Sep 2019 20:32:18 +0000 (UTC)
Received: from coeurl.usersys.redhat.com (ovpn-121-35.rdu2.redhat.com [10.10.121.35])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 85E3F19C78;
        Tue,  3 Sep 2019 20:32:17 +0000 (UTC)
Received: by coeurl.usersys.redhat.com (Postfix, from userid 1000)
        id 0DC2520F44; Tue,  3 Sep 2019 16:32:16 -0400 (EDT)
From:   Scott Mayhew <smayhew@redhat.com>
To:     trond.myklebust@hammerspace.com, anna.schumaker@netapp.com
Cc:     dhowells@redhat.com, viro@zeniv.linux.org.uk,
        linux-nfs@vger.kernel.org, linux-fsdevel@vger.kernel.org,
        linux-kernel@vger.kernel.org
Subject: [PATCH v2 25/26] NFS: Add fs_context support.
Date:   Tue,  3 Sep 2019 16:32:14 -0400
Message-Id: <20190903203215.9157-26-smayhew@redhat.com>
In-Reply-To: <20190903203215.9157-1-smayhew@redhat.com>
References: <20190903203215.9157-1-smayhew@redhat.com>
X-Scanned-By: MIMEDefang 2.84 on 10.5.11.23
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.44]); Tue, 03 Sep 2019 20:32:19 +0000 (UTC)
...
---
 ...
 17 files changed, 896 insertions(+), 863 deletions(-)
...
index d65f5d7a488e..7284c5a18e2b 100644
...
@@ -1157,22 +1043,14 @@ static int nfs23_validate_mount_data(void *options,
 	return -EINVAL;
 }
...
-	struct nfs4_mount_data *data = (struct nfs4_mount_data *)options;
 	...
 	if (data == NULL)
@@ -1222,7 +1100,7 @@ static int nfs4_validate_mount_data(void *options,
...
@@ -1242,12 +1120,20 @@ static int nfs4_validate_mount_data(void *options,
...
@@ -1265,57 +1151,85 @@ static int nfs4_validate_mount_data(void *options,
 	return -EINVAL;
 }
...
+		}
 		...
 		if (ctx->nfs_server.protocol == XPRT_TRANSPORT_RDMA)
@@ -1324,19 +1238,219 @@ int nfs_validate_text_mount_data(void *options,
