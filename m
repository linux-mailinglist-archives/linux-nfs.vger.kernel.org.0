Return-Path: <linux-nfs+bounces-17067-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 37FAACB9FEE
	for <lists+linux-nfs@lfdr.de>; Fri, 12 Dec 2025 23:56:30 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id F068830B1DB8
	for <lists+linux-nfs@lfdr.de>; Fri, 12 Dec 2025 22:55:14 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CEDAB2F7AAA;
	Fri, 12 Dec 2025 22:55:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="IbCyoHjY"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A6D422E9EAE
	for <linux-nfs@vger.kernel.org>; Fri, 12 Dec 2025 22:55:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1765580113; cv=none; b=YTRj18FynMpm9/pl87iH4pUiQoskXkX+5kx6RacQVoGtteGMzlNUpLS4k3ooQWLEm6skuvKfPdU9beSDBxeE1amSSnMetH9N0Jt5yz0pSFzFZF2d1fnHXqAv3hOYUb+Sbs92Ik37vfILSX1K3mwdeuL+P+0mAQmceCxWJgbmwH8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1765580113; c=relaxed/simple;
	bh=2of913ZkxdVXF20aoZ4WS4WW8aMzEIe59AI3PzfYVjk=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=qEHx0G9lOwa+e1CdzhSp4PAA0suGLCYaG7uNMkOhV1of3aedTS96g2/I/6pZI03zSiXci7ZiQEyok675fqvTjjpx4sSUnMafM80Wxb/olukh7Hge6BSXM1Z0anNLwDOtP4FiJyo4nLYqSPYDc1T/AwN4CnNGGUaat4dzkMC+ZG8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=IbCyoHjY; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 9E894C4CEF1;
	Fri, 12 Dec 2025 22:55:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1765580113;
	bh=2of913ZkxdVXF20aoZ4WS4WW8aMzEIe59AI3PzfYVjk=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <d9347315a9932db375cbff30fc337ec5a2685d93.camel@kernel.org>
Subject: Re: [PATCH v2 1/1] nfsd: check that server is running in
 unlock_filesystem
...
Cc: linux-nfs@vger.kernel.org, neilb@brown.name, Dai.Ngo@oracle.com, 
	tom@talpey.com
Date: Sat, 13 Dec 2025 07:55:09 +0900
...
> @@ -1769,9 +1769,8 @@ static struct nfs4_stid *find_one_sb_stid(struct nf=
s4_client *clp,
...
> --- a/fs/nfsd/nfsctl.c
> +++ b/fs/nfsd/nfsctl.c
> @@ -259,6 +259,7 @@ static ssize_t write_unlock_fs(struct file *file, cha=
r *buf, size_t size)
>  	struct path path;
>  	char *fo_path;
>  	int error;
...
>  	/* sanity check */
>  	if (size =3D=3D 0)
> @@ -285,7 +286,15 @@ static ssize_t write_unlock_fs(struct file *file, ch=
ar *buf, size_t size)
