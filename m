Return-Path: <linux-nfs+bounces-18213-lists+linux-nfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-nfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id SP9qGw3/b2mUUgAAu9opvQ
	(envelope-from <linux-nfs+bounces-18213-lists+linux-nfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-nfs@lfdr.de>; Tue, 20 Jan 2026 23:17:49 +0100
X-Original-To: lists+linux-nfs@lfdr.de
Received: from ams.mirrors.kernel.org (ams.mirrors.kernel.org [IPv6:2a01:60a::1994:3:14])
	by mail.lfdr.de (Postfix) with ESMTPS id 14A774CD8A
	for <lists+linux-nfs@lfdr.de>; Tue, 20 Jan 2026 23:17:49 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.mirrors.kernel.org (Postfix) with ESMTPS id 964C46AE841
	for <lists+linux-nfs@lfdr.de>; Tue, 20 Jan 2026 21:28:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 58B133B8BC6;
	Tue, 20 Jan 2026 21:28:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="mYzcqKVy"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1CAE93A7DFA;
	Tue, 20 Jan 2026 21:28:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1768944497; cv=none; b=BH02zkuhlOyQMkhbmvR+y76Fw3QBBDC0dRiS54CLbsokpH+s5tgJX7SQgc6jZgAfunP94RXYLhucHk2BJMJMmcIPj6NJAZi1QeMZXvM6bCHvUCvwIp5ZK4IG5w4jNCSlwA8lhhLIGhMyROG72gvNbN3DEDaHT05eetnozT6ZVLI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1768944497; c=relaxed/simple;
	bh=ELCV1zYUJg4nN8Dg6Tc0cdwqdP7SMxumO0+9aqvzm7Q=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=cMsVGBESBH07DgKvbIcKK32HMAVL5/jzsbjegfrGtQuddcTYJ6rGRMmPmOfxs1uP26JauMqXCPT6A2CCp0gS5NCxmqFc/kQs/MBNy53TPgTvX0d6UhlzABhH9dNacKwsKbvu+ZRT8+Mwb0RtsvsSq7I9+hnciyqRGyV3tbQVp7E=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=mYzcqKVy; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id B4C1CC16AAE;
	Tue, 20 Jan 2026 21:28:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1768944496;
	bh=ELCV1zYUJg4nN8Dg6Tc0cdwqdP7SMxumO0+9aqvzm7Q=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <f2203e755aca4da45b099b18aac03b0a9d299343.camel@kernel.org>
...
Date: Tue, 20 Jan 2026 16:28:14 -0500
...
X-Spamd-Result: default: False [-0.46 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-18213-lists,linux-nfs=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
...
> > > +        bool (*lm_need_to_retry)(struct file_lease *, struct file_lo=
ck_context *);
> > >  =20
> > >   locking rules:
> > >  =20
...
> > >   	}
> > >   }
> > > @@ -1531,8 +1539,10 @@ static void time_out_leases(struct inode *inod=
...
> > >   				continue;
> > > @@ -1657,6 +1669,18 @@ int __break_lease(struct inode *inode, unsigne=
d int flags)
> > >   		goto out;
> > >   	}
> > >  =20
...
> >=20
> > >   restart:
> > >   	fl =3D list_first_entry(&ctx->flc_lease, struct file_lease, c.flc_=
list);
> > >   	break_time =3D fl->fl_break_time;
> > > @@ -1693,6 +1717,9 @@ int __break_lease(struct inode *inode, unsigned=
 int flags)
...
> > >   	return false;
> > >   }
> > > @@ -782,10 +780,69 @@ nfsd4_layout_lm_open_conflict(struct file *filp=
, int arg)
> > >   	return 0;
> > >   }
> > >  =20
...
> > > +
> > > +/**
> > > + * nfsd4_layout_lm_conflict - Handle multiple conflicts in the same =
file.
...
> > > + * to remain in __break_lease to manage the timeout for these recall=
s;
> > > + * subsequent threads should not wait in __break_lease.
> > > + *
> > > + * This is done to prevent excessive nfsd threads from becoming tied=
 up
> > > + * in __break_lease, which could hinder the server's ability to serv=
ice
> > > + * incoming requests.
> > > + *
> > > + * Return true if thread should not wait in __break_lease else retur=
n
> > > + * false.
> > > + */
> > > +static bool
