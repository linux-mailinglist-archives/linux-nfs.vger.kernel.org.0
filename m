...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 4DE59AC0BF
	for <lists+linux-nfs@lfdr.de>; Fri,  6 Sep 2019 21:46:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2392240AbfIFTqh (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Fri, 6 Sep 2019 15:46:37 -0400
Received: from mail-io1-f44.google.com ([209.85.166.44]:37174 "EHLO
        mail-io1-f44.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727053AbfIFTqh (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Fri, 6 Sep 2019 15:46:37 -0400
Received: by mail-io1-f44.google.com with SMTP id r4so15426414iop.4
        for <linux-nfs@vger.kernel.org>; Fri, 06 Sep 2019 12:46:36 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=c+qzd1t04M9iw91XTGhGIlq5TiPOqNPPuvUxmNaerE4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=c+qzd1t04M9iw91XTGhGIlq5TiPOqNPPuvUxmNaerE4=;
        b=
X-Gm-Message-State: APjAAAVMqSg5CgdAC0FRh2qqVSsN1CgGhsO84le3SiN0diO4va4lRf6z
        g8kOVXSX02mJTedSWQipxws=
X-Google-Smtp-Source: APXvYqwOQmx1HyUeVoCXG3H+7fBucjsxijQKi4ej5nsmkl+ZuS/xTlfcRIiZEOeBGclWIK8mcE/UFg==
X-Received: by 2002:a6b:b8c3:: with SMTP id i186mr7247840iof.194.1567799196067;
        Fri, 06 Sep 2019 12:46:36 -0700 (PDT)
Received: from Olgas-MBP-201.attlocal.net (172-10-226-31.lightspeed.livnmi.sbcglobal.net. [172.10.226.31])
        by smtp.gmail.com with ESMTPSA id i14sm5118085ioi.47.2019.09.06.12.46.35
...
Subject: [PATCH v6 02/19] NFS: add COPY_NOTIFY operation
Date:   Fri,  6 Sep 2019 15:46:14 -0400
Message-Id: <20190906194631.3216-3-olga.kornievskaia@gmail.com>
...
index ecfaf4b..5311def 100644
--- a/fs/nfs/nfs4proc.c
+++ b/fs/nfs/nfs4proc.c
@@ -9853,6 +9853,7 @@ static bool nfs4_match_stateid(const nfs4_stateid *s1,
 		| NFS_CAP_ALLOCATE
 		| NFS_CAP_COPY
