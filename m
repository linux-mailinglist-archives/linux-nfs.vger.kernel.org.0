Return-Path: <linux-nfs+bounces-22255-lists+linux-nfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-nfs@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id pybFIbF9IGoM4QAAu9opvQ
	(envelope-from <linux-nfs+bounces-22255-lists+linux-nfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-nfs@lfdr.de>; Wed, 03 Jun 2026 21:17:05 +0200
X-Original-To: lists+linux-nfs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id DAF6563AC8F
	for <lists+linux-nfs@lfdr.de>; Wed, 03 Jun 2026 21:17:04 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=kernel.org header.s=k20260515 header.b=IRQappFC;
	spf=pass (mail.lfdr.de: domain of "linux-nfs+bounces-22255-lists+linux-nfs=lfdr.de@vger.kernel.org" designates 2600:3c0a:e001:db::12fc:5321 as permitted sender) smtp.mailfrom="linux-nfs+bounces-22255-lists+linux-nfs=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=quarantine) header.from=kernel.org;
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id BBF68305FAD0
	for <lists+linux-nfs@lfdr.de>; Wed,  3 Jun 2026 19:15:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 78656481ABB;
	Wed,  3 Jun 2026 19:15:05 +0000 (UTC)
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-alma10-1.taild15c8.ts.net [100.103.45.18])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DDB923CF97F;
	Wed,  3 Jun 2026 19:15:03 +0000 (UTC)
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1780514105; cv=none; b=ae6tTI13XpVXhaXyfxGymF87IwmYy0wV5dCnPI1PsIhHNDvIs/Gz7LBkyhfcb91WYdtJqZOialNHuT2659R5244SvCjd3B3M0LvXHMF7k0Kv8+VmIVKi/YaUuC2hfDRuryP+cA58J7UupnsUorQxZNRhv0b2C29X1dFWT4KegqA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1780514105; c=relaxed/simple;
	bh=/NhhT5xb2rEUoT11uwpRO5zqwMAs9GZZzVCHntGxSUI=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=l65M1hQ4OIfkPgi7l2TozMeV0LL4aa575pNfLfkmrDi+atUcVIaXZpYNsXMcJJUL0ibQUA7u3kSan3YbkDcS6Ah/poP4ACtAnkJOJYkz0va8JUdluYfurZs2LoPGMHnxMPIrEcN3DhiQskLMh4+ny0NxgLLofJTJTSaVawvPhyo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=IRQappFC; arc=none smtp.client-ip=100.103.45.18
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 1DC781F00893;
	Wed,  3 Jun 2026 19:15:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=kernel.org;
	s=k20260515; t=1780514103;
	bh=e/Ns13VD0ERRmMd8K96JGUPmbRc/vnJKBeaqzSyqRaI=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References;
	b=
Message-ID: <a73e18542a62c33954279878a9ca01c0ec182cb9.camel@kernel.org>
...
Date: Wed, 03 Jun 2026 15:15:00 -0400
In-Reply-To: <0d16e520-3e78-4b2b-b624-4376a1f0e075@app.fastmail.com>
References: <20260602-nfsd-testing-v2-0-e4ea62e3cd5c@kernel.org>
	 ...
	 <0d16e520-3e78-4b2b-b624-4376a1f0e075@app.fastmail.com>
...
X-Spamd-Result: default: False [-2.16 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-22255-lists,linux-nfs=lfdr.de];
	MIME_TRACE(0.00)[0:+];
...
> > > > diff --git a/include/linux/nfslocalio.h b/include/linux/nfslocalio.=
h
...
> > > > a destroyed cache, and nfsd_file_mark_put() runs against a destroye=
d
...
> > > > refcount_dec_if_one() in nfsd_file_lru_cb(), i.e. at refcount =3D=
=3D 1.
> > > > A file with an outstanding LOCALIO reference has refcount >=3D 2, s=
o
...
> >=20
> > =E2=97=8F This is the same concern I just addressed for the previous pa=
tch's=20
