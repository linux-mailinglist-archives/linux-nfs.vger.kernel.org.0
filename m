...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 621A87EE859
	for <lists+linux-nfs@lfdr.de>; Thu, 16 Nov 2023 21:32:40 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229464AbjKPUck (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Thu, 16 Nov 2023 15:32:40 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36554 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229437AbjKPUck (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Thu, 16 Nov 2023 15:32:40 -0500
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F01CDD49
        for <linux-nfs@vger.kernel.org>; Thu, 16 Nov 2023 12:32:36 -0800 (PST)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 2AA33C433C7;
        Thu, 16 Nov 2023 20:32:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1700166756;
        bh=lBNh3hCLt7MAJQB1VFDejX0Yh1SZvb6iTtAGhKSVe4M=;
        h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
        b=
Message-ID: <465037c9585f910c2192bf896139e7bf01d587d4.camel@kernel.org>
...
Date:   Thu, 16 Nov 2023 15:32:34 -0500
In-Reply-To: <787DAC8F-5294-4876-9725-096D639B3D9C@oracle.com>
...
>=20
> > On Nov 16, 2023, at 12:11=E2=80=AFPM, Benjamin Coddington <bcodding@red=
hat.com> wrote:
> >=20
...
heavy handed right now. It currently does this:
        ...
        while ((error =3D break_layout(inode, false)) =3D=3D -EWOULDBLOCK) =
{=20
                xfs_iunlock(ip, *iolock);                             =20
                *did_unlock =3D true;                                   =
=20
                error =3D break_layout(inode, true);                    =
=20
                *iolock &=3D ~XFS_IOLOCK_SHARED;                        =
=20
                *iolock |=3D XFS_IOLOCK_EXCL;                           =
=20
                xfs_ilock(ip, *iolock);                               =20
        }
