Return-Path: <linux-nfs+bounces-1469-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 3258E83DD04
	for <lists+linux-nfs@lfdr.de>; Fri, 26 Jan 2024 16:03:46 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 9E3051F21854
	for <lists+linux-nfs@lfdr.de>; Fri, 26 Jan 2024 15:03:45 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1C0B01BF53;
	Fri, 26 Jan 2024 15:03:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="s6Q0ceYO"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E95F31B970
	for <linux-nfs@vger.kernel.org>; Fri, 26 Jan 2024 15:03:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706281421; cv=none; b=iZjHSqSVHFt+tzNibZBpLdpUej6QTqn4mVJLbjElbuBicV2muU8dW7njBG+AQaW8pf9a+C6sIyMHHtX7mzqV3qFLbgIeqhDzKZf8Uk/7utf22umHgxhNiQj7rrM318K9md4BuEnJ2Vb14v0g/B3PjlUUqmvSvAt0N/AkztiiZTQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706281421; c=relaxed/simple;
	bh=thYHaRwSRrQCo991iBdE+krE0iVxvd3FYw79sISJ378=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=BkM98M2/9quQhKWevW3Pc6tUgDgKr7//jqoQmLhe1LKrIJWVwtXaT/KiCONaQ5ENns+qTdTQDZhlAYGogv1F4EMhR7pm0GrAGmqIOhg/bLOXDCEP6bOjd5v2AR+UCLdrdvQ9IXb3FdA+u8P937Ht20R1aYBg9nGe2fCIzTr3fyA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=s6Q0ceYO; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id F1706C433F1;
	Fri, 26 Jan 2024 15:03:39 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1706281420;
	bh=thYHaRwSRrQCo991iBdE+krE0iVxvd3FYw79sISJ378=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <c1f798d6cac7299e33b23ba54148ad985263845e.camel@kernel.org>
...
Date: Fri, 26 Jan 2024 10:03:38 -0500
...
>=20
> > On Jan 26, 2024, at 9:08=E2=80=AFAM, Jeff Layton <jlayton@kernel.org> w=
rote:
> >=20
> > On Fri, 2024-01-26 at 13:48 +0000, Chuck Lever III wrote:
> > >=20
> > > > On Jan 26, 2024, at 8:01=E2=80=AFAM, Jeff Layton <jlayton@kernel.or=
g> wrote:
> > > >=20
...
> > > > > > > This is the last global stat, move it into nfsd_net and adjus=
t all the
> > > > > > > users to use that variant instead of the global one.
> > > > > >=20
> > > > > > Hm. I thought nfsd threads were a global resource -- they servi=
ce
...
> > > > > > processes?
> > > >=20
> > > > Each container is going to start /proc/fs/nfsd/threads number of th=
reads
> > > > regardless. I hadn't actually grokked that they just get tossed ont=
o the
> > > > pile of threads that service requests.
> > > >=20
> > > > Is is possible for one container to start a small number of threads=
 but
> > > > have its client load be such that it spills over and ends up steali=
ng
...
> > >=20
> >=20
> > AFAICT, the total number of threads on the system will be the sum of th=
e
...
> > threads aren't associated with the netns, per-se. The svc_rqst's howeve=
r
...
> >=20
> > >=20
> > > > > I don't think we want the network namespaces seeing how many thre=
ads exist in
...
> > >=20
> >=20
> > Yes, they're kernel threads and they aren't associated with a particula=
r
> > pid namespace.
> >=20
> > >=20
> > > > > Additionally it appears that we can have multiple threads per net=
work namespace,
> > > > > so it's not like this will just show 1 for each individual nn, it=
'll show
> > > > > however many threads have been configured for that nfsd in that n=
etwork
> > > > > namespace.
> > >=20
