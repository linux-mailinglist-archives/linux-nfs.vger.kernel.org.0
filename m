...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D8342103E5D
	for <lists+linux-nfs@lfdr.de>; Wed, 20 Nov 2019 16:28:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729033AbfKTP2D (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Wed, 20 Nov 2019 10:28:03 -0500
Received: from us-smtp-1.mimecast.com ([207.211.31.81]:39363 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1730423AbfKTP2D (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Wed, 20 Nov 2019 10:28:03 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        ...
        bh=SVFFftq1q7wpO4AYHMWHbOjc3b6JwBTPFT3BtaYqTg4=;
        b=f17yyRlMzj5fW+6Tg8SxoT32Rc7Cz3U13pJDf9DGzmQbLI9Lj1ROSOliB6g1vWNUM0eR9W
        BJfMjCNS/Idk0Qy1jvfEoHb/hF2SWpRze3hQ81p8IwCJg4gS1hhyrLEbTNzcIfEb70KqnP
        3oA6GDdyn3DPx6v27x0lAuVUGnVETPI=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-163-gAyVjfrhMVOn-jLsFTXckw-1; Wed, 20 Nov 2019 10:27:55 -0500
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com [10.5.11.23])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 92E2518B5F78;
        Wed, 20 Nov 2019 15:27:53 +0000 (UTC)
Received: from coeurl.usersys.redhat.com (ovpn-123-90.rdu2.redhat.com [10.10.123.90])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 674D22AA92;
        Wed, 20 Nov 2019 15:27:52 +0000 (UTC)
Received: by coeurl.usersys.redhat.com (Postfix, from userid 1000)
        id 75CB9209F9; Wed, 20 Nov 2019 10:27:50 -0500 (EST)
From:   Scott Mayhew <smayhew@redhat.com>
To:     anna.schumaker@netapp.com, trond.myklebust@hammerspace.com
Cc:     dhowells@redhat.com, viro@zeniv.linux.org.uk,
        linux-nfs@vger.kernel.org, linux-fsdevel@vger.kernel.org,
        linux-kernel@vger.kernel.org
Subject: [PATCH v5 16/27] NFS: Move mount parameterisation bits into their own file
Date:   Wed, 20 Nov 2019 10:27:39 -0500
Message-Id: <20191120152750.6880-17-smayhew@redhat.com>
In-Reply-To: <20191120152750.6880-1-smayhew@redhat.com>
References: <20191120152750.6880-1-smayhew@redhat.com>
X-Scanned-By: MIMEDefang 2.84 on 10.5.11.23
X-MC-Unique: gAyVjfrhMVOn-jLsFTXckw-1
...
index 000000000000..3a34c8437917
--- /dev/null
...
index c0c6cd24f73f..0818736efc57 100644
--- a/fs/nfs/internal.h
+++ b/fs/nfs/internal.h
@@ -7,6 +7,7 @@
...
index f1b5488a04c3..bfea31cf1c12 100644
--- a/fs/nfs/super.c
+++ b/fs/nfs/super.c
@@ -69,229 +69,6 @@
 #include "nfs.h"
