Return-Path: <linux-nfs+bounces-1078-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id F254582CEBA
	for <lists+linux-nfs@lfdr.de>; Sat, 13 Jan 2024 22:14:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 9CC46281FC0
	for <lists+linux-nfs@lfdr.de>; Sat, 13 Jan 2024 21:14:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 587C8107B2;
	Sat, 13 Jan 2024 21:14:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="WK1rxHFk"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3D38010797
	for <linux-nfs@vger.kernel.org>; Sat, 13 Jan 2024 21:14:22 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 569DFC433C7;
	Sat, 13 Jan 2024 21:14:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1705180462;
	bh=gNQn0TBi+NQI6quBq4+/Wh1b/2t2/bmL18krcbNi+hM=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <3bd49c4ab5ace84ab39df7a0d2c8851542bfb9b9.camel@kernel.org>
...
To: Chuck Lever III <chuck.lever@oracle.com>, Roland Mainz
	 <roland.mainz@nrubsig.org>
Cc: Linux NFS Mailing List <linux-nfs@vger.kernel.org>
Date: Sat, 13 Jan 2024 16:14:21 -0500
...
> > >=20
> > > On Sat, Jan 13, 2024 at 1:19=E2=80=AFAM Dan Shelton <dan.f.shelton@gm=
ail.com> wrote:
> > > > We've been experiencing significant nfsd performance problems with =
a
...
> > > session) into tuneables, which are set at nfsd startup ? It might hel=
p
> > > with Dan's scenario, benchmarking, client testing (e.g. my case, wher=
e
...
> > just tuning a sane value for everyone. This particular value governs th=
e
...
> > That's certainly something we should be wary of, but I don't expect tha=
t
