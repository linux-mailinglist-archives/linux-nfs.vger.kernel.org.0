31 +0000 (UTC)
Received: from dovecot-director2.suse.de ([2a07:de40:b281:106:10:150:64:167])
	by imap1.dmz-prg2.suse.org with ESMTPSA
	id a70AF1fFT2d/BwAAD6G6ig
	(envelope-from <neilb@suse.de>); Wed, 04 Dec 2024 02:58:31 +0000
From: NeilBrown <neilb@suse.de>
To: Trond Myklebust <trondmy@kernel.org>,
	Anna Schumaker <anna@kernel.org>
Cc: David Disseldorp <ddiss@suse.com>,
	linux-nfs@vger.kernel.org
Subject: [PATCH 2/2] NFS: move _maxsz and _sz #defines to the function which they describe.
Date: Wed,  4 Dec 2024 13:53:10 +1100
Message-ID: <20241204025703.2662394-3-neilb@suse.de>
...
nfs4xdr.c has lots of #define for the size of max-size of the xdr
encoding of components of requests and responses.  The #defines are a
long way from the code which does the encoding or decoding so it is
easy for changes to the code not to be reflected in the #defines.

This patch moves most of these #defines to immediately before the code
which does the encoding or decoding.

As calls to encode_op_hdr() in encode functions need to know the
expected size of the reply to be decoded, we need the encode functions
*after) the decode defines.  To achieve this while having the defines
near the relevant code, we need to move all the decode function to
before the encode functions.

That, unfortunately, makes this patch rather large.

Signed-off-by: NeilBrown <neilb@suse.de>
---
 fs/nfs/nfs4xdr.c | 11979 ++++++++++++++++++++++-----------------------
 1 file changed, 5988 insertions(+), 5991 deletions(-)

diff --git a/fs/nfs/nfs4xdr.c b/fs/nfs/nfs4xdr.c
index 71f45cc0ca74..9fce3d3366ad 100644
--- a/fs/nfs/nfs4xdr.c
+++ b/fs/nfs/nfs4xdr.c
@@ -84,24 +84,7 @@ static int decode_layoutget(struct xdr_stream *xdr, struct rpc_rqst *req,
...
@@ -124,282 +107,22 @@ static int decode_layoutget(struct xdr_stream *xdr, struct rpc_rqst *req,
...
@@ -407,40 +130,6 @@ static int decode_layoutget(struct xdr_stream *xdr, struct rpc_rqst *req,
 				1 /* notification bitmap length */ + \
 				1 /* notification bitmap, word 0 */ + \
...
@@ -450,6069 +139,6417 @@ static int decode_layoutget(struct xdr_stream *xdr, struct rpc_rqst *req,
...
+				 2 + encode_verifier_maxsz + 5 + \
+				nfs4_label_maxsz)
+static void encode_readdir(struct xdr_stream *xdr,
+			   const struct nfs4_readdir_arg *readdir,
...
@@ -6520,1089 +6557,1028 @@ static void nfs4_xdr_enc_setacl(struct rpc_rqst *req, struct xdr_stream *xdr,
 	encode_compound_hdr(xdr, req, &hdr);
 	encode_sequence(xdr, &args->seq_args, &hdr);
 	encode_putfh(xdr, args->fh, &hdr);
...
+#endif /* CONFIG_NFS_V4_1 */
 ...
 #include "nfs42xdr.c"
@@ -7719,3 +7695,24 @@ const struct rpc_version nfs_version4 = {
