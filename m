...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 07E2C669C58
	for <lists+linux-nfs@lfdr.de>; Fri, 13 Jan 2023 16:32:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230253AbjAMPcE (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Fri, 13 Jan 2023 10:32:04 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48284 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229613AbjAMPbl (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Fri, 13 Jan 2023 10:31:41 -0500
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F19B880AEF
        for <linux-nfs@vger.kernel.org>; Fri, 13 Jan 2023 07:25:06 -0800 (PST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 834DAB820D4
        for <linux-nfs@vger.kernel.org>; Fri, 13 Jan 2023 15:25:05 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id CBBD6C433D2;
        Fri, 13 Jan 2023 15:25:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1673623504;
        bh=u1Yy99ELqzK+qnBzL8AAL1+SOxlQYoUwkUWR5pRzdx4=;
        h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
        b=
Subject: [PATCH v1 34/41] SUNRPC: Add Kunit tests for RFC 3962-defined
 encryption/decryption
From:   Chuck Lever <cel@kernel.org>
To:     linux-nfs@vger.kernel.org
Cc:     dhowells@redhat.com, simo@redhat.com
Date:   Fri, 13 Jan 2023 10:25:02 -0500
Message-ID: <167362350292.8960.8697643253733066455.stgit@bazille.1015granger.net>
...
index 986d8908d172..f5c086471881 100644
...
@@ -635,14 +636,28 @@ gss_krb5_cts_crypt(struct crypto_sync_skcipher *cipher, struct xdr_buf *buf,
 	return ret;
 }
...
@@ -686,8 +701,11 @@ krb5_cbc_cts_encrypt(struct crypto_sync_skcipher *cts_tfm,
 	if (err)
 		return err;
...
@@ -795,7 +813,7 @@ gss_krb5_aes_encrypt(struct krb5_ctx *kctx, u32 offset,
...
@@ -987,7 +1005,7 @@ krb5_etm_encrypt(struct krb5_ctx *kctx, u32 offset,
...
index a24e67938c80..3d4d1208ba19 100644
--- a/net/sunrpc/auth_gss/gss_krb5_internal.h
+++ b/net/sunrpc/auth_gss/gss_krb5_internal.h
@@ -220,6 +220,10 @@ u32 krb5_etm_decrypt(struct krb5_ctx *kctx, u32 offset, u32 len,
