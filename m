Return-Path: <linux-nfs+bounces-16966-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B1E4CA9C40
	for <lists+linux-nfs@lfdr.de>; Sat, 06 Dec 2025 01:47:00 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id A5F913026A96
	for <lists+linux-nfs@lfdr.de>; Sat,  6 Dec 2025 00:43:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0ABB630E0C0;
	Sat,  6 Dec 2025 00:32:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="vMFlEBc3"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CE9C430DEB7;
	Sat,  6 Dec 2025 00:32:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1764981174; cv=none; b=uBuiCdwyDeiAvgk/iaRESX1ErDs+3s6tChmRWCL4qKhUvG2DnS4jOcCtGTY2prZzHvWpJ7jYZrnfOl/vV5+lbkOYGRMo22WCU8FsslUX1rHVzZBc3aPteeUC97sKLkelZrpzrzZPQ8OVt+Or/s70Tdgc1tNfNVJl9eX8Vd87gbI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1764981174; c=relaxed/simple;
	bh=lOJtQr0le+x63OIQUZLVAD4blFN6Mb1Ol3ATvzlgEHc=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=GE17U1YFvTnr0eWYGcXL5j+QTJ+lGj7SmnnJm1O9qJZw0TdTw89TfNyXyhqplfTLLKTpZe2umVfBLcNCx1QSNOPGSalRUzkbRWB2hVSc4zfnXUgS4zCGAGEJVYwgdYBc5x5m2wxE2unJhXBMr1s/ypXVVbSyBJva7pzUDqmASNY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=vMFlEBc3; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id B6E6AC116C6;
	Sat,  6 Dec 2025 00:32:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1764981174;
	bh=lOJtQr0le+x63OIQUZLVAD4blFN6Mb1Ol3ATvzlgEHc=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <0db6443f0fc01db7e75933e43381d9b10a99ffe9.camel@kernel.org>
...
> > > upstream
> > > maintainer when your tree is submitted for merging.=C2=A0 You may als=
o
> > > want
...
> >=20
> > =C2=A094afb627dfc2 ("nfs: use credential guards in
> > nfs_local_call_read()")
...
> > Cc: linux-stable@vger.kernel.org=C2=A0# a custom 6.18-stable backport i=
s
> > required
...
> > +			status =3D filp->f_op->read_iter(&iocb-
> > >kiocb,
> > &iocb->iters[i]);
> > +
...
> > =C2=A0			iocb->kiocb.ki_flags &=3D ~IOCB_DIRECT;
> > =C2=A0
> > -		status =3D filp->f_op->write_iter(&iocb->kiocb,
> > &iocb-
> > > iters[i]);
> > +		scoped_with_creds(filp->f_cred)
...
> > =C2=A0			if (unlikely(status >=3D 0 && status < iocb-
> > > iters[i].count))
> > =C2=A0				force_done =3D true; /* Partial
> > write
> > */
...
> patch directly to stable@vger.kernel.org=C2=A0as a fix for 6.18? That
> would
