Return-Path: <linux-nfs+bounces-3773-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 4461A907888
	for <lists+linux-nfs@lfdr.de>; Thu, 13 Jun 2024 18:44:43 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 6CF991F22AFA
	for <lists+linux-nfs@lfdr.de>; Thu, 13 Jun 2024 16:44:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DE3D71494B8;
	Thu, 13 Jun 2024 16:44:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="dO3RLUbX"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A66631494B5
	for <linux-nfs@vger.kernel.org>; Thu, 13 Jun 2024 16:44:27 +0000 (UTC)
...
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1718297067; c=relaxed/simple;
	bh=4qb2kmkoK+Rx/cWHSvyD8FXQMkyziBIjjNQ6TXmH+Ho=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=nMfc+E+xISb0ttzzSWuypct+Wmy7efaAZQ6lJiG/yYEq5zDGg4yTSsk/zWBVsa4LGwdS5qysEZSRoTQaT3hAlVpj6QYh+usseg7ZKlKlc5CBKTdoDCsgjzA2BuIdADwE9jGxxuKrdfjTCoNKA9te7uPiEAsBKupqU9+rLDDC6Ag=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=dO3RLUbX; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 5A291C32789;
	Thu, 13 Jun 2024 16:44:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1718297067;
	bh=4qb2kmkoK+Rx/cWHSvyD8FXQMkyziBIjjNQ6TXmH+Ho=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:From;
	b=
From: Jeff Layton <jlayton@kernel.org>
Date: Thu, 13 Jun 2024 12:44:06 -0400
Subject: [PATCH nfs-utils v5 1/4] nfsdctl: add the nfsdctl utility to
 nfs-utils
Precedence: bulk
...
Message-Id: <20240613-nfsdctl-v5-1-0b7a39102bac@kernel.org>
...
X-Mailer: b4 0.13.0
X-Developer-Signature: v=1; a=openpgp-sha256; l=50619; i=jlayton@kernel.org;
 h=from:subject:message-id; bh=gWb9e6aeUk7g1y77egltRiZ8y4QwNlEKd4N54L9ublk=;
 b=
...
---
 ...
 utils/nfsdctl/nfsdctl.c      | 1460 ++++++++++++++++++++++++++++++++++++++++++
 utils/nfsdctl/nfsdctl.h      |   93 +++
 7 files changed, 1949 insertions(+)

diff --git a/configure.ac b/configure.ac
index 58d1728c5bc6..8cb42ebc5846 100644
--- a/configure.ac
+++ b/configure.ac
...
new file mode 100644
index 000000000000..986c937b620d
--- /dev/null
