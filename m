...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B753D118F24
	for <lists+linux-nfs@lfdr.de>; Tue, 10 Dec 2019 18:37:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727592AbfLJRh1 (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Tue, 10 Dec 2019 12:37:27 -0500
Received: from userp2120.oracle.com ([156.151.31.85]:36856 "EHLO
        userp2120.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727527AbfLJRh1 (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Tue, 10 Dec 2019 12:37:27 -0500
Received: from pps.filterd (userp2120.oracle.com [127.0.0.1])
        by userp2120.oracle.com (8.16.0.27/8.16.0.27) with SMTP id xBAHOE0H078129;
        Tue, 10 Dec 2019 17:37:21 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=content-type :
 mime-version : subject : from : in-reply-to : date : cc :
 content-transfer-encoding : message-id : references : to;
 s=corp-2019-08-05; bh=1SUPXaerdfD3jJMW2gFC5JUPcQ0Za1cnIYsb3822TZU=;
 b= +g== 
Received: from aserp3030.oracle.com (aserp3030.oracle.com [141.146.126.71])
        by userp2120.oracle.com with ESMTP id 2wr4qrfmsh-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Tue, 10 Dec 2019 17:37:21 +0000
Received: from pps.filterd (aserp3030.oracle.com [127.0.0.1])
        by aserp3030.oracle.com (8.16.0.27/8.16.0.27) with SMTP id xBAHOS5R155548;
        Tue, 10 Dec 2019 17:37:20 GMT
Received: from aserv0121.oracle.com (aserv0121.oracle.com [141.146.126.235])
        by aserp3030.oracle.com with ESMTP id 2wt13df3s9-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Tue, 10 Dec 2019 17:37:20 +0000
Received: from abhmp0008.oracle.com (abhmp0008.oracle.com [141.146.116.14])
        by aserv0121.oracle.com (8.14.4/8.13.8) with ESMTP id xBAHbJe1005516;
        Tue, 10 Dec 2019 17:37:19 GMT
Received: from anon-dhcp-152.1015granger.net (/68.61.232.219)
        by default (Oracle Beehive Gateway v4.0)
        with ESMTP ; Tue, 10 Dec 2019 09:37:19 -0800
Content-Type: text/plain;
        charset=us-ascii
Mime-Version: 1.0 (Mac OS X Mail 12.4 \(3445.104.11\))
Subject: Re: oops in 5.4 on rdma
From:   Chuck Lever <chuck.lever@oracle.com>
In-Reply-To: <CAN-5tyFxPbQru_VWSx0zSwOTUHqneJYX_=i=eeyH=sAmiJks=w@mail.gmail.com>
Date:   Tue, 10 Dec 2019 12:37:18 -0500
Cc:     Linux NFS Mailing List <linux-nfs@vger.kernel.org>
Content-Transfer-Encoding: quoted-printable
Message-Id: <4C697DAB-A780-4477-A94E-95B95A66E1A1@oracle.com>
References: <CAN-5tyFxPbQru_VWSx0zSwOTUHqneJYX_=i=eeyH=sAmiJks=w@mail.gmail.com>
...
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 suspectscore=2 malwarescore=0
 ...
 engine=8.0.1-1911140001 definitions=main-1912100149
X-Proofpoint-Virus-Version: vendor=nai engine=6000 definitions=9467 signatures=668685
...
> On Dec 10, 2019, at 12:34 PM, Olga Kornievskaia <aglo@umich.edu> =
wrote:
>=20
> Hi Chuck,
>=20
...
> [  155.086407] CPU: 14 PID: 975 Comm: kworker/u52:0 Not tainted 5.4.0+ =
#1
...
> [  155.697624] RAX: 0000000000000001 RBX: ffff8b85efdb8000 RCX: =
0000000000000000
> [  155.783015] RDX: ffff8b861516ae80 RSI: 0000000000000000 RDI: =
ffff8b8df0087000
> [  155.868404] RBP: ffff8b8df0087000 R08: 0000000000000001 R09: =
0000000000000000
> [  155.953795] R10: ffff8b8e1724b000 R11: ffffffffffffffa6 R12: =
ffff8b85efdb8000
> [  156.039186] R13: 0000000000000000 R14: ffff8b86071cb000 R15: =
ffff8b85efdb8448
> [  156.124577] FS:  0000000000000000(0000) GS:ffff8b861fa00000(0000)
> knlGS:0000000000000000
> [  156.221405] CS:  0010 DS: 0000 ES: 0000 CR0: 0000000080050033
> [  156.290157] CR2: 00007fde99d85000 CR3: 000000025f20a003 CR4: =
00000000000606e0
...
> Dec 10 12:39:54 localhost kernel:      Tainted: G        W         =
5.4.0+ #1
> Dec 10 12:39:54 localhost kernel: "echo 0 >
> /proc/sys/kernel/hung_task_timeout_secs" disables this message.
> Dec 10 12:39:55 localhost kernel: kworker/6:2     D    0   295      2 =
0x80004000
> Dec 10 12:39:55 localhost kernel: Workqueue: events xprt_destroy_cb =
[sunrpc]
...
> Dec 10 12:39:55 localhost kernel: xprt_rdma_destroy+0x22/0xb0 =
[rpcrdma]
