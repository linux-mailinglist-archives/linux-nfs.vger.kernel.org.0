Return-Path: <linux-nfs+bounces-22725-lists+linux-nfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-nfs@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id Fl+kJjanNWqt2QYAu9opvQ
	(envelope-from <linux-nfs+bounces-22725-lists+linux-nfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-nfs@lfdr.de>; Fri, 19 Jun 2026 22:31:50 +0200
X-Original-To: lists+linux-nfs@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 03D876A7A34
	for <lists+linux-nfs@lfdr.de>; Fri, 19 Jun 2026 22:31:50 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=linux.microsoft.com header.s=default header.b="Vw/Gnjvf";
	spf=pass (mail.lfdr.de: domain of "linux-nfs+bounces-22725-lists+linux-nfs=lfdr.de@vger.kernel.org" designates 172.105.105.114 as permitted sender) smtp.mailfrom="linux-nfs+bounces-22725-lists+linux-nfs=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=none) header.from=linux.microsoft.com;
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id F2BB73016B9F
	for <lists+linux-nfs@lfdr.de>; Fri, 19 Jun 2026 20:31:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4567D35E926;
...
X-Spamd-Result: default: False [-3.66 / 15.00];
 ...
 com,m:ernis@linux.microsoft.com,m:jgg@nvidia.com,s:lists@lfdr.de];
	...
	FROM_HAS_DN(0.00)[];
	TAGGED_FROM(0.00)[bounces-22725-lists,linux-nfs=lfdr.de];
	ALIAS_RESOLVED(0.00)[];
