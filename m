Return-Path: <linux-nfs+bounces-1051-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A199982B917
	for <lists+linux-nfs@lfdr.de>; Fri, 12 Jan 2024 02:25:05 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id D8E57B232E8
	for <lists+linux-nfs@lfdr.de>; Fri, 12 Jan 2024 01:25:02 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0C2CD4A10;
	Fri, 12 Jan 2024 01:24:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="MQQ2RNaL"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E5BBA4A13
	for <linux-nfs@vger.kernel.org>; Fri, 12 Jan 2024 01:24:58 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 1E001C433C7;
	Fri, 12 Jan 2024 01:24:58 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1705022698;
	bh=woCbhz3aT/ll+Lk4DFpcUdJi6z9QT/AZdG3Q0nm7uOc=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <6065a76f32face0fa5cf84a238bcb1f2eebec7b5.camel@kernel.org>
Subject: Re: NFSv4.1 mandatory locks working in Linux nfsd ?
From: Jeff Layton <jlayton@kernel.org>
To: Dan Shelton <dan.f.shelton@gmail.com>
Cc: Roland Mainz <roland.mainz@nrubsig.org>, Linux NFS Mailing List
	 <linux-nfs@vger.kernel.org>
Date: Thu, 11 Jan 2024 20:24:57 -0500
In-Reply-To: <CAAvCNcCC7xB1oWoSxaL269T62TuOYx64A+49fRoJTFJZ6xD+EA@mail.gmail.com>
References: 
	<CAKAoaQniGNGuPm5CTTs3oJRuCH40HTt6K91nCAPRnt0tECxkBA@mail.gmail.com>
...
> > > On Thu, Jan 11, 2024 at 4:55=E2=80=AFPM Jeff Layton <jlayton@kernel.o=
rg> wrote:
> > > > On Thu, 2024-01-11 at 10:54 -0500, Jeff Layton wrote:
> > > > > On Sun, 2023-12-24 at 18:29 +0100, Roland Mainz wrote:
> > > > > > Are there any known issues with NFSv4.1 mandatory locking nfsd =
code in
> > > > > > the Linux 5.10.0-22-rt-amd64 kernel (technically the Debian Bul=
lseye
> > > > > > RT kernel) ? Is there any kernel or NFS test suite module which=
 covers
> > > > > > NFSv4.1 client mandatory locking ?
> > > > >=20
> > > > > Linux doesn't support mandatory locking at all since 2021 [1]. Th=
e Linux
> > > > > NFS client and server therefore do not support v4.1 mandatory loc=
king.
> > > >=20
> > > > Forgot the footnote!
> > > >=20
> > > > [1]: https://patchwork.kernel.org/project/linux-fsdevel/patch/20210=
820114046.69282-1-jlayton@kernel.org/
> > >=20
