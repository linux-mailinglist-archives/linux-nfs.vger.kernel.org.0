Return-Path: <linux-nfs+bounces-7650-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 6007B9BB78F
	for <lists+linux-nfs@lfdr.de>; Mon,  4 Nov 2024 15:22:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 8442A1C224F1
	for <lists+linux-nfs@lfdr.de>; Mon,  4 Nov 2024 14:22:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 31F37146A69;
	Mon,  4 Nov 2024 14:22:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="lm3LKDXv"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0D2B72AD0C
	for <linux-nfs@vger.kernel.org>; Mon,  4 Nov 2024 14:22:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1730730141; cv=none; b=XH85RVpqMAWDEVteiQSeLwNYoJvgm7mQDb66WCu4sE7NFhTA5GiWZqv5iju9EamoEeAWAyzg/gIcFCVlOLdAp2vlvVp2NSAYJUbTTQD2Tv7fse/1Y1AGP/kpZJ+uk+1DpqsPo8YBuDm/dsvdeBYpY9Kl+EleRn/8i2ugz6axOy0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1730730141; c=relaxed/simple;
	bh=3YNiOeJRY8DUVQaeLdRLtkD4uc2sawzYuDUhxexj3+U=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=QwqxTkI0/DvosO0kB4G57OYaYWBEn7GdkOUxFIsY4TfiCnciFPYMFioaVPrKNsiFnd9t1269M0t3Q/pU89EJAnAKKMImbsdTzr6R09TIgPumXeD40KGJbxMT8DQS1Ou6Hl8TEF3QqNN5kUVxpdtddTI1PdSjA4DAkKZYltwolMM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=lm3LKDXv; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id F2720C4CECE;
	Mon,  4 Nov 2024 14:22:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1730730140;
	bh=3YNiOeJRY8DUVQaeLdRLtkD4uc2sawzYuDUhxexj3+U=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <c2da4004d3ae67d51f319d356da211b1956658ca.camel@kernel.org>
...
Date: Mon, 04 Nov 2024 09:22:18 -0500
In-Reply-To: <1a996261-3e3d-80f0-4af5-926733e58fee@huawei.com>
...
> > >=20
> > > The action force umount(umount -f) will attempt to kill all rpc_task =
even
> > > umount operation may ultimately fail if some files remain open.
> > > Consequently, if an action attempts to open a file, it can potentiall=
y
...
> > > two rpc_task can attempt to open the same file simultaneously from th=
e
> > > client to server, and because two instances of nfsd can run
> > > concurrently, this situation can lead to lots of memory leak.
> > > Additionally, when we echo 0 to /proc/fs/nfsd/threads, warning will b=
e
> > > triggered.
> > >=20
> > >                      NFS SERVER
...
> > >=20
> > > Add nfs4_openowner_unhashed to help found unhashed nfs4_openowner, an=
d
...
> > > @@ -1660,6 +1660,12 @@ static void release_open_stateid(struct nfs4_o=
l_stateid *stp)
...
> > > @@ -4975,6 +4981,12 @@ init_open_stateid(struct nfs4_file *fp, struct=
 nfsd4_open *open)
...
> > >   	if (retstp)
> > >   		goto out_unlock;
> > > @@ -6127,6 +6139,11 @@ nfsd4_process_open2(struct svc_rqst *rqstp, st=
ruct svc_fh *current_fh, struct nf
> > >  =20
> > >   	if (!stp) {
