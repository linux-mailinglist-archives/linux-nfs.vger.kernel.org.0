...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7949D6D59F8
	for <lists+linux-nfs@lfdr.de>; Tue,  4 Apr 2023 09:51:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233212AbjDDHvE (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Tue, 4 Apr 2023 03:51:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53966 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230193AbjDDHvD (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Tue, 4 Apr 2023 03:51:03 -0400
Received: from lithops.sigma-star.at (lithops.sigma-star.at [195.201.40.130])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ED20210FA
        for <linux-nfs@vger.kernel.org>; Tue,  4 Apr 2023 00:50:58 -0700 (PDT)
Received: from localhost (localhost [127.0.0.1])
        by lithops.sigma-star.at (Postfix) with ESMTP id EDE7B64548A1;
        Tue,  4 Apr 2023 09:50:56 +0200 (CEST)
Received: from lithops.sigma-star.at ([127.0.0.1])
        by localhost (lithops.sigma-star.at [127.0.0.1]) (amavisd-new, port 10032)
        with ESMTP id ZaYXwOcaZW0P; Tue,  4 Apr 2023 09:50:55 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
        by lithops.sigma-star.at (Postfix) with ESMTP id 6904D6431C4A;
        Tue,  4 Apr 2023 09:50:55 +0200 (CEST)
Received: from lithops.sigma-star.at ([127.0.0.1])
        by localhost (lithops.sigma-star.at [127.0.0.1]) (amavisd-new, port 10026)
        with ESMTP id QObWlG3EpgzZ; Tue,  4 Apr 2023 09:50:55 +0200 (CEST)
Received: from blindfold.corp.sigma-star.at (213-47-184-186.cable.dynamic.surfer.at [213.47.184.186])
        by lithops.sigma-star.at (Postfix) with ESMTPSA id 02C9864551A4;
...
Date:   Tue,  4 Apr 2023 09:50:38 +0200
Message-Id: <20230404075039.10802-2-richard@nod.at>
X-Mailer: git-send-email 2.26.2
In-Reply-To: <20230404075039.10802-1-richard@nod.at>
References: <20230404075039.10802-1-richard@nod.at>
MIME-Version: 1.0
...
+
 ...
 {
@@ -687,8 +698,13 @@ static int match_fsid(struct parsed_fsid *parsed, nf=
...
@@ -935,7 +957,7 @@ static void write_fsloc(char **bp, int *blen, struct =
exportent *ep)
...
t flag_mask, int extra_flag)
 {
 	struct sec_entry *p;
=20
@@ -950,11 +972,20 @@ static void write_secinfo(char **bp, int *blen, str=
...
+
 ...
 {
@@ -971,17 +1002,48 @@ static int dump_to_cache(int f, char *buf, int ble=
n, char *domain,
 	if (exp) {
...
@@ -69,8 +69,10 @@ rpc_pipefs_generator_SOURCES =3D $(COMMON_SRCS) rpc-pi=
pefs-generator.c
