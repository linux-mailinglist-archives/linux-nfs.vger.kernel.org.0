-0800 (PST)
Precedence: bulk
...
MIME-Version: 1.0
References: <CAKAoaQmkDwVXEmhr7u4cc5tKqd5h=b0wUXRqR_uD+DpoQ=B2Zg@mail.gmail.com>
 <CAKAoaQ=vpL-85m5JSHzsiNpnrt7+PGW2=b4vs-tsWc5H6Onnhg@mail.gmail.com>
In-Reply-To: <CAKAoaQ=vpL-85m5JSHzsiNpnrt7+PGW2=b4vs-tsWc5H6Onnhg@mail.gmail.com>
From: Martin Wege <martin.l.wege@gmail.com>
Date: Sat, 22 Feb 2025 14:46:00 +0100
X-Gm-Features: AWEUYZkWX9bOThJfUPjgK2uUZYENetwpiz-yzzm0WLiLDxAJFGiaGfqfCDoV3dU
Message-ID: <CANH4o6MHVxK8iM4_vSF89w451WNugwdMBkTvHVd_reMY2HK6YQ@mail.gmail.com>
Subject: Fwd: [Ms-nfs41-client-devel] Fwd: ANN: NFSv4.2/NFSv4.1 filesystem
...
Date: Fri, Feb 21, 2025 at 8:59=E2=80=AFPM
...
2019/2022 for testing, 2025-02-21 ...
...
filesystem client driver for Windows 10/11+Windows Server 2019/2022,
based on https://github.com/kofemann/ms-nfs41-client (commit id
#6ed49f2fc9cad8d46c295408a62fbde113a885ad, git bundle in tarball), for
...
- Symlink translation, e.g. symlinks in Win32 format are converted
from/to POSIX format on the NFS server side. This makes symlinks
compatible between platforms&&toolkits, e.g. symlinks created with
PowerShell or Cygwin can be used by any Win32 application and POSIX
applications on other NFS clients
- Solaris 11.4 NFSv4.1 server is now supported (only required minor bug fix=
es)
...
** RELEASE README (full version at
http://www.nrubsig.org/people/gisburn/work/msnfs41client/releases/testing/m=
snfs41client_cygwin_64bit32bit_binaries_20250221_13h15m_git6ed49f2.readme):
---------------- snip ----------------
# 1. What is this ?
NFSv4.2/NFSv4.1 filesystem driver for Windows 10/11&Windows Server 2019+202=
2
...
- Sparse file support
    ...
    - Cygwin sparse file support requires >=3D Cygwin 3.6 to support
      POSIX-1.2024 |lseek(...,SEEK_HOLE/SEEK_DATA,...)|, which is
      needed for coreutils /usr/bin/fallocate and
      $ /usr/bin/cp --sparse=3Dauto src dest #
    ...
    - /cygdrive/c/Windows/system32/xcopy /sparse can be
      ...
      Requires on Win11 >=3D 22H2 because it relies on |CopyFile2()|
...
esting/msnfs41client_cygwin_64bit32bit_binaries_20250221_13h15m_git6ed49f2.=
tar.bz2'
$ openssl sha256
"msnfs41client_cygwin_64bit32bit_binaries_20250221_13h15m_git6ed49f2.tar.bz=
2"
SHA2-256(msnfs41client_cygwin_64bit32bit_binaries_20250221_13h15m_git6ed49f=
2.tar.bz2)=3D
2cf76698779a711a5dde88c61c61d8f67d38df874ffe0088aa1ed1240491e90f

# 7. Installation (as "Administrator"):
$ (cd / && tar -xf
~/download/msnfs41client_cygwin_64bit32bit_binaries_20250221_13h15m_git6ed4=
9f2.tar.bz2
)
