Return-Path: <linux-nfs+bounces-2961-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id F027E8AF426
	for <lists+linux-nfs@lfdr.de>; Tue, 23 Apr 2024 18:32:06 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id A100D28EBC5
	for <lists+linux-nfs@lfdr.de>; Tue, 23 Apr 2024 16:32:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CAD8A160;
	Tue, 23 Apr 2024 16:32:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="hXGJ/53T"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 919021E485
	for <linux-nfs@vger.kernel.org>; Tue, 23 Apr 2024 16:32:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713889921; cv=none; b=fDL9LsK4mLVSo7ForjYOR1ZQepjOAPBgXsN/iECeG7g6SYPdJM/6eZaix9XoKa4XGMGkwusG0YETh7BlGP/R0tiB4sf+QWSj7/dhlXs1KspjaKSEBlTaRwd7xm8OUyltRqEHLyqWiZS+GzrHQQWUxqwWPLQpNFvwA76oxFZQdvk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713889921; c=relaxed/simple;
	bh=0qv8hCpy0xZ3ik++mbd8hK8loEyDEK7rc/TBoqSJNMs=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=T4AR4nzgO4pAbKsp7iGIjCOBP1ST6dAANDvahhy4/uLu7p+AevjWchYTFI1cLt3kvTaQdXn9Q1PInUcPhnmt+kApGMPylGFdcEfa+f+Rcs0BLT8XMjUbNahyfzWGzplnwB06fc6t3fz2H5jSbPJVAGJcMEoEqhY/9Vleeq039S0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=hXGJ/53T; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id C3A7FC2BD11;
	Tue, 23 Apr 2024 16:32:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1713889921;
	bh=0qv8hCpy0xZ3ik++mbd8hK8loEyDEK7rc/TBoqSJNMs=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:From;
	b=
From: Jeff Layton <jlayton@kernel.org>
Date: Tue, 23 Apr 2024 12:31:53 -0400
Subject: [PATCH nfs-utils v3 1/3] nfsdctl: add the nfsdctl utility to
 nfs-utils
Precedence: bulk
...
Message-Id: <20240423-nfsdctl-v3-1-9e68181c846d@kernel.org>
...
X-Mailer: b4 0.13.0
X-Developer-Signature: v=1; a=openpgp-sha256; l=49601; i=jlayton@kernel.org;
 h=from:subject:message-id; bh=Z7XrDR0Ne20PL+3GOJmXmeXw/F/MpsXLAsH/lJqTWoQ=;
 b=
 QAV/x
...
new file mode 100644
index 000000000000..44d3dd266ad2
--- /dev/null
...
+
+	return threads_doit(sock, NFSD_CMD_THREADS_SET, grace, lease, 1,
+			    &threads, scope);
+}
+
