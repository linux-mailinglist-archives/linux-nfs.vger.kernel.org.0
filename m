> > On Oct 17, 2024, at 4:34=E2=80=AFAM, Dmitry Vyukov <dvyukov@google.com>=
 wrote:
> >
...
> >>
> >>
> >>> On Sep 20, 2024, at 3:13=E2=80=AFPM, Jeff Layton <jlayton@kernel.org>=
 wrote:
> >>>
> >>> On Fri, 2024-09-20 at 18:51 +0000, Chuck Lever III wrote:
> >>>>
> >>>>> On Sep 19, 2024, at 10:57=E2=80=AFPM, NeilBrown <neilb@suse.de> wro=
te:
> >>>>>
...
> >>>>>>>
> >>>>>>> HEAD commit:    a430d95c5efa Merge tag 'lsm-pr-20240911' of git:/=
/git.kern..
> >>>>>>> git tree:       upstream
> >>>>>>> console output: https://syzkaller.appspot.com/x/log.txt?x=3D17c74=
69f980000
> >>>>>>> kernel config:  https://syzkaller.appspot.com/x/.config?x=3Da69c6=
6e868285a9d
> >>>>>>> dashboard link: https://syzkaller.appspot.com/bug?extid=3D24cd636=
199753ac5e0ca
...
> >>>>>>>
> >>>>>>> Downloadable assets:
> >>>>>>> disk image: https://storage.googleapis.com/syzbot-assets/7f3aff90=
5e91/disk-a430d95c.raw.xz
> >>>>>>> vmlinux: https://storage.googleapis.com/syzbot-assets/a468ce8431f=
0/vmlinux-a430d95c.xz
> >>>>>>> kernel image: https://storage.googleapis.com/syzbot-assets/80d4f1=
150155/bzImage-a430d95c.xz
> >>>>>>>
> >>>>>>> IMPORTANT: if you fix the issue, please add the following tag to =
the commit:
> >>>>>>> Reported-by: syzbot+24cd636199753ac5e0ca@syzkaller.appspotmail.co=
m
> >>>>>>>
...
> >>>>>>> BUG: KASAN: slab-use-after-free in list_add include/linux/list.h:=
169 [inline]
> >>>>>>> BUG: KASAN: slab-use-after-free in rhashtable_walk_enter+0x333/0x=
370 lib/rhashtable.c:684
> >>>>>>> Read of size 8 at addr ffff8880773fa010 by task syz.2.11924/9970
> >>>>>>>
> >>>>>>> CPU: 0 UID: 0 PID: 9970 Comm: syz.2.11924 Not tainted 6.11.0-syzk=
...
> >>>>>>> RSP: 002b:00007fd948e38038 EFLAGS: 00000246 ORIG_RAX: 00000000000=
0002e
...
> >>>>>>> nsim_dev_trap_report_work+0x878/0xc80 drivers/net/netdevsim/dev.c=
:850
> >>>>>>> process_one_work+0x958/0x1ad0 kernel/workqueue.c:3231
> >>>>>>> process_scheduled_works kernel/workqueue.c:3312 [inline]
> >>>>>>> worker_thread+0x6c8/0xf00 kernel/workqueue.c:3393
...
> >>>>>>> raw: 00fff00000000040 ffff88801ac42140 ffffea0001e63600 dead00000=
0000002
> >>>>>>> raw: 0000000000000000 0000000000040004 00000001fdffffff 000000000=
0000000
> >>>>>>> head: 00fff00000000040 ffff88801ac42140 ffffea0001e63600 dead0000=
00000002
> >>>>>>> head: 0000000000000000 0000000000040004 00000001fdffffff 00000000=
00000000
> >>>>>>> head: 00fff00000000003 ffffea0001dcfe01 ffffffffffffffff 00000000=
00000000
> >>>>>>> head: 0000000700000008 0000000000000000 00000000ffffffff 00000000=
00000000
> >>>>>>> page dumped because: kasan: bad access detected
> >>>>>>> page_owner tracks the page as allocated
> >>>>>>> page last allocated via order 3, migratetype Unmovable, gfp_mask =
0xd2040(__GFP_IO|__GFP_NOWARN|__GFP_NORETRY|__GFP_COMP|__GFP_NOMEMALLOC), p=
id 5240, tgid 5240 (syz-executor), ts 74499202771, free_ts 74134964798
...
> >>>>>>> tomoyo_realpath_from_path+0xbf/0x710 security/tomoyo/realpath.c:2=
51
...
> >>>>>>>> ffff8880773fa000: fa fb fb fb fb fb fb fb fb fb fb fb fb fb fb f=
b
> >>>>>>>                       ^
...
> >>>>>>> #syz undup
> >>>>>>
> >>>>>> So we're tearing down the server and cleaning out the nfsd_file ha=
sh,
> >>>>>> and we hit a UAF. That probably means that we freed a nfsd_file wi=
thout
...
> >>>>>>
> >>>>>> It is strange though. struct nfsd_file is 112 bytes on my machine,=
 but
> >>>>>> the warning is about a 4k allocation. I guess that just means that=
 the
> >>>>>> page got recycled into a different slabcache.
> >>>>>
> >>>>> The code that is crashing hasn't come close to touching anything th=
at is
> >>>>> thought to be an nfsd_file.
> >>>>> The error is detected in the list_add() in rhashtable_walk_enter() =
when
> >>>>> the new on-stack iterator is being attached to the bucket_table tha=
t is being
> >>>>> iterated.  So that bucket_table must (now) be an invalid address.
> >>>>>
> >>>>> The handling of NFSD_FILE_CACHE_UP is strange.  nfsd_file_cache_ini=
t()
> >>>>> sets it, but doesn't clear it on failure.  So if nfsd_file_cache_in=
it()
> >>>>> fails for some reason, nfsd_file_cache_shutdown() would still try t=
o
> >>>>> clean up if it was called.
> >>>>>
> >>>>> So suppose nfsd_startup_generic() is called.  It increments nfsd_us=
ers
...
> >>>>> decrement nfsd_users back to zero, but NFSD_FILE_CACHE_UP will stil=
l be
> >>>>> set.
> >>>>>
> >>>>> When nfsd_startup_generic() is called again, nfsd_file_cache_init()=
 will
> >>>>> skip initialisation because NFSD_FILE_CACHE_UP is set.  When
> >>>>> nfsd_file_cache_shutdown() is then called it will clean up an rhlta=
ble
> >>>>> that has already been destroyed.  We get exactly the reported sympt=
om.
> >>>>>
> >>>>> I *think* nfsd_file_cache_init() can only fail with -ENOMEM and I w=
ould
...
.
> >>>>>
> >>>>> So I think there are problems with NFSD_FILE_CACHE_UP settings and =
I
> >>>>> think they could trigger this bug if a kmalloc failed, but I don't =
think
> >>>>> that a kmalloc failed and I think there must be some other explanat=
ion
> >>>>> here.
> >>>>
...
> >
> > [ 3239.085992][ T8199] __kmem_cache_create_args(nfsd_file) failed with =
error -22
...
> > [ 3245.419913][ T8295] svc: failed to register nfsdv3 RPC service (errn=
o 111).
> > [ 3245.467727][ T8295] svc: failed to register nfsaclv3 RPC service (er=
rno 111).
> > [ 3245.693668][ T8295]
...
> > ffff8880301ac000
> > [ 3246.311330][ T8295]  which belongs to the cache kmalloc-4k of size 4=
096
...
=3Dnfsd-fixes&id=3Ddc0d0f885aa422f621bc1c2124133eff566b0bc8
>
> is in the v6.12-rc pile. We think it addresses this crasher.

Let's tell syzbot about the fix:

#syz fix: NFSD: Mark filecache "down" if init fails
