Return-Path: <linux-nfs+bounces-19208-lists+linux-nfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-nfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id yCVdHhoDnmk6TAQAu9opvQ
	(envelope-from <linux-nfs+bounces-19208-lists+linux-nfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-nfs@lfdr.de>; Tue, 24 Feb 2026 20:59:22 +0100
X-Original-To: lists+linux-nfs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id C653018C40A
	for <lists+linux-nfs@lfdr.de>; Tue, 24 Feb 2026 20:59:21 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 2FAA13046EB2
	for <lists+linux-nfs@lfdr.de>; Tue, 24 Feb 2026 19:59:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8156F32ABF1;
	Tue, 24 Feb 2026 19:59:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="PK4yrVG5"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5D055279DB6
	for <linux-nfs@vger.kernel.org>; Tue, 24 Feb 2026 19:59:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1771963159; cv=none; b=tl+91eukvlKwxizMyqRX9/nnL1zqD2Zq1c4K3VC6Zwe5Mi4vvil8IOBZbgnZ7tjfNnpfCLJv7n536Muu+pK+32LLoubuGUXWcKOTA3M+xcbsy2FLf4ohpLchQMLwGI7jb2rUtCHilQDtMc2IDpFLJ/X+gNwo7f+xyQKL+FQCglQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1771963159; c=relaxed/simple;
	bh=zn4oLBJKnm6yXGvrAe2iZCgCl49iNmJ0oqAWfT/dlNs=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=VTY0QzJg9f3ZdT37wtoM0bcHV2H+dj94zZwbUIPIg8zlYSpW6m2DM3/bkhUyWEjJbrKywCZOJx2TM02zGZvBmuxXqDhhHd8/1pYCI1Qlt3gWPHBoP7wnaZ4NV8zR8cYv1KmcYzWffKvkphFNtVQNmYcfNLBEIwmUisStCDToGSE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=PK4yrVG5; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 3DB7AC116D0;
	Tue, 24 Feb 2026 19:59:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1771963158;
	bh=zn4oLBJKnm6yXGvrAe2iZCgCl49iNmJ0oqAWfT/dlNs=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <f16c1806a705e08252b1b39ea44b1de1e6be17d6.camel@kernel.org>
...
Date: Tue, 24 Feb 2026 14:59:17 -0500
...
References: <20260224193354.57849-1-cel@kernel.org>
	 ...
	 <3a700716-9b7d-4bc5-8d9b-24bcd585df26@kernel.org>
...
X-Spamd-Result: default: False [-2.16 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	TAGGED_FROM(0.00)[bounces-19208-lists,linux-nfs=lfdr.de];
...
> > > > > buffer is kmalloc'd to hold it. If the allocation fails, rp_bufle=
n
...
> > > > >=20
> > > > > Fixes: 1e8e9913672a ("nfsd: fix heap overflow in NFSv4.0 LOCK rep=
lay cache")
...
> > > > > @@ -1496,8 +1496,24 @@ release_all_access(struct nfs4_ol_stateid =
*stp)
> > > > >  	}
> > > > >  }
> > > > > =20
> > > > > +/**
> > > > > + * nfs4_replay_free_cache - release dynamically allocated replay=
 buffer
> > > > > + * @rp: replay cache to reset
> > > > > + *
> > > > > + * If @rp->rp_buf points to a kmalloc'd buffer, free it and rese=
t
...
> > > > > +}
> > > > > +
> > > > >  static inline void nfs4_free_stateowner(struct nfs4_stateowner *=
sop)
> > > > >  {
...
> > > > > --- a/fs/nfsd/nfs4xdr.c
> > > > > +++ b/fs/nfsd/nfs4xdr.c
> > > > > @@ -6282,14 +6282,23 @@ nfsd4_encode_operation(struct nfsd4_compo=
undres *resp, struct nfsd4_op *op)
...
> > > > >   *
> > > > >   * Some responses can exceed this. A LOCK denial includes the co=
nflicting
> > > > > - * lock owner, which can be up to 1024 bytes (NFS4_OPAQUE_LIMIT)=
. Responses
> > > > > - * larger than REPLAY_ISIZE are not cached in rp_ibuf; only rp_s=
tatus is
> > > > > - * saved. Enlarging this constant increases the size of every
> > > > > - * nfs4_stateowner.
> > > > > + * lock owner, which can be up to 1024 bytes (NFS4_OPAQUE_LIMIT)=
. When a
> > > > > + * response exceeds REPLAY_ISIZE, a buffer is dynamically alloca=
ted. If
> > > > > + * that allocation fails, only rp_status is saved. Enlarging thi=
s constant
...
> > > >=20
> > > >=20
> > > > Certainly a reasonable approach if we care about full correctness w=
hen
