...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C6F5A32FDB7
	for <lists+linux-nfs@lfdr.de>; Sat,  6 Mar 2021 23:30:10 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229788AbhCFW30 (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Sat, 6 Mar 2021 17:29:26 -0500
Received: from mail.kernel.org ([198.145.29.99]:33980 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S229733AbhCFW3T (ORCPT <rfc822;linux-nfs@vger.kernel.org>);
        Sat, 6 Mar 2021 17:29:19 -0500
Received: by mail.kernel.org (Postfix) with ESMTPSA id 34D396509D
        for <linux-nfs@vger.kernel.org>; Sat,  6 Mar 2021 22:29:19 +0000 (UTC)
Subject: [PATCH v2 01/43] NFSD: Extract the svcxdr_init_encode() helper
From:   Chuck Lever <chuck.lever@oracle.com>
To:     linux-nfs@vger.kernel.org
Date:   Sat, 06 Mar 2021 17:29:18 -0500
Message-ID: <161506975837.4312.13103963568190520283.stgit@klimt.1015granger.net>
...
index 00f884e537f7..0587d6c19b2e 100644
--- a/fs/nfsd/nfs4proc.c
+++ b/fs/nfsd/nfs4proc.c
@@ -2261,25 +2261,6 @@ static bool need_wrongsec_check(struct svc_rqst *rqstp)
...
@@ -2334,10 +2315,14 @@ nfsd4_proc_compound(struct svc_rqst *rqstp)
...
+	xdr_reserve_space(resp->xdr, XDR_UNIT * 2 + args->taglen);
 	...
 	resp->tag = args->tag;
 	resp->rqstp = rqstp;
@@ -2443,7 +2428,7 @@ nfsd4_proc_compound(struct svc_rqst *rqstp)
 encode_op:
