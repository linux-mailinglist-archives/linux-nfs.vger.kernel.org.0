...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8EA464B117C
	for <lists+linux-nfs@lfdr.de>; Thu, 10 Feb 2022 16:18:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243520AbiBJPSD (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Thu, 10 Feb 2022 10:18:03 -0500
Received: from mxb-00190b01.gslb.pphosted.com ([23.128.96.19]:53676 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S243486AbiBJPSA (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Thu, 10 Feb 2022 10:18:00 -0500
Received: from fieldses.org (fieldses.org [IPv6:2600:3c00:e000:2f7::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 12F3B1B3;
        Thu, 10 Feb 2022 07:18:00 -0800 (PST)
Received: by fieldses.org (Postfix, from userid 2815)
        id 70D6EBC3; Thu, 10 Feb 2022 10:17:59 -0500 (EST)
DKIM-Filter: OpenDKIM Filter v2.11.0 fieldses.org 70D6EBC3
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=fieldses.org;
        s=default; t=1644506279;
        bh=5UEk2cDFMbUJ2XQejG7HBLD/Tg5EUm9/auH7ATlgvcc=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=gMCkDKLLOSjYUau1EmbMosrTrx5DEEri3jZI+S/RQNHY8gkuUQD+RnWO5y8zokTPP
         iy/d4vAJI05Bh0reJHE3YgP0RI2V5wrXyp5XrWlCWidTwyqeulyTuAlvegNrWLiVRD
         NqMeK+a57FD4k6u4vNf6WBQl+CC1HETgNkrTOdJ4=
Date:   Thu, 10 Feb 2022 10:17:59 -0500
...
Subject: Re: [PATCH RFC v12 3/3] nfsd: Initial implementation of NFSv4
 Courteous Server
Message-ID: <20220210151759.GE21434@fieldses.org>
...
In-Reply-To: <1644468729-30383-4-git-send-email-dai.ngo@oracle.com>
