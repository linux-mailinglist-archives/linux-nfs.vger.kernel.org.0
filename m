Return-Path: <linux-nfs+bounces-18869-lists+linux-nfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-nfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id gLK8FYCFi2neVAAAu9opvQ
	(envelope-from <linux-nfs+bounces-18869-lists+linux-nfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-nfs@lfdr.de>; Tue, 10 Feb 2026 20:22:40 +0100
X-Original-To: lists+linux-nfs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id A4CD011E9CF
	for <lists+linux-nfs@lfdr.de>; Tue, 10 Feb 2026 20:22:39 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 572B8301FF91
	for <lists+linux-nfs@lfdr.de>; Tue, 10 Feb 2026 19:22:38 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 76574327210;
	Tue, 10 Feb 2026 19:22:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="pFMmOwyM"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 516CA2DE6FF;
	Tue, 10 Feb 2026 19:22:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1770751356; cv=none; b=QPpbgOHSjIj5zp+OI8q8e8/Vyr44Ic0cGJGIoVBpFLxKmcoEUCr8MsgIwG/RSAuLuzZ2tA3FDQt6V09l3kJrnYaQsJRz7tzR8yfe9HXLj4sta8AtPQ4RHUmeGNjES8TAX0rBXnFYS64wREBAbgxXEEk0uxRWOBDLCdAuC2h6/DA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1770751356; c=relaxed/simple;
	bh=J1T6LYHWdl/+RNQBwKfoisfiU8zaU70NI6GlOY7COxw=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=eDqPNom1ECV+d8ZkOPK/WM1XNGt66mA4/0GfZbPYzj/ot2j7cTDmuASG5VDZMUeiig+e0wNybQtchsxk8Fsc2MJZjdBfiI8RpyvIUEmmkG9XQ0KQ4F67x9e4ilSFIbRnkrZaUmoEw5u5UQEQkEZZQ27vuK7bDV+WeRNMiUSD3ig=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=pFMmOwyM; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id C04A0C116C6;
	Tue, 10 Feb 2026 19:22:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1770751356;
	bh=J1T6LYHWdl/+RNQBwKfoisfiU8zaU70NI6GlOY7COxw=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <eb1757d7f2409ffb792d800166daff8a8c63b09e.camel@kernel.org>
...
Date: Tue, 10 Feb 2026 14:22:33 -0500
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-18869-lists,linux-nfs=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
...
> =20
> @@ -1531,8 +1532,19 @@ static void time_out_leases(struct inode *inode, s=
...
> @@ -271,6 +280,10 @@ nfsd4_alloc_layout_stateid(struct nfsd4_compound_sta=
te *cstate,
...
>  	return false;
>  }
> @@ -782,10 +793,117 @@ nfsd4_layout_lm_open_conflict(struct file *filp, i=
nt arg)
>  	return 0;
>  }
> =20
...
> +	ls->ls_fence_delay <<=3D 1;
> +	if (!ls->ls_fence_delay)
> +		ls->ls_fence_delay =3D (1 *HZ);
> +	else if (ls->ls_fence_delay > MAX_FENCE_DELAY)
> +		ls->ls_fence_delay =3D MAX_FENCE_DELAY;
