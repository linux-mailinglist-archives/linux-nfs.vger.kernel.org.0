Return-Path: <linux-nfs+bounces-81-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A59E7F9F9C
	for <lists+linux-nfs@lfdr.de>; Mon, 27 Nov 2023 13:35:39 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 6C9D61C20DA1
	for <lists+linux-nfs@lfdr.de>; Mon, 27 Nov 2023 12:35:38 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9B3D412E5C;
	Mon, 27 Nov 2023 12:35:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="ZjFXxBYq"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 76EF51DDCF;
	Mon, 27 Nov 2023 12:35:37 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 36C83C433C8;
	Mon, 27 Nov 2023 12:35:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1701088536;
	bh=raabkgIXLwasnnhp9lSdMvUEXT00UH3Q44zpSZwd1II=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <06427133d603e3ff521bcd1c3d0d3ba777848606.camel@kernel.org>
...
Date: Mon, 27 Nov 2023 07:35:34 -0500
...
References: <cover.1699095665.git.lorenzo@kernel.org>
	...
	, <0f0467f396777722022403727824104b4f0a8d85.camel@kernel.org>
	 <169982054606.2582.2797096885323571291@noble.neil.brown.name>
...
> > > > > This series is based on the commit below available in net-next tr=
ee
> > > > >=20
...
> > > > >=20
> > > > > =A0=A0=A0=A0The code supports dumps with no input attributes curr=
ently
> > > > > =A0=A0=A0=A0thru a combination of special-casing and luck.
> > > > > =A0=A0=A0=A0Clean up the handling of ops with no inputs. Create e=
mpty
...
> > > > multiple files like this, but it has some drawbacks, in particular =
with
...
> >=20
> > > >=20
> > > > Would it make more sense to instead have a single netlink command t=
hat
> > > > sets up ports and versions, and then spawns the requisite amount of
> > > > threads, all in one fell swoop?
> > >=20
> > > I do not have a strong opinion about it but I would say having a dedi=
cated
> > > set/get for each paramater allow us to have more granularity (e.g. if=
 you want
> > > to change just a parameter we do not need to send all of them to the =
kernel).
> > > What do you think?
> > >=20
> >=20
> > It's pretty rare to need to twiddle settings on the server while it's u=
p
