Return-Path: <linux-nfs+bounces-18805-lists+linux-nfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-nfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id QvBIO58jh2nrUAQAu9opvQ
	(envelope-from <linux-nfs+bounces-18805-lists+linux-nfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-nfs@lfdr.de>; Sat, 07 Feb 2026 12:35:59 +0100
X-Original-To: lists+linux-nfs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E96C105C22
	for <lists+linux-nfs@lfdr.de>; Sat, 07 Feb 2026 12:35:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 80F303019F31
	for <lists+linux-nfs@lfdr.de>; Sat,  7 Feb 2026 11:35:56 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9E73D30C619;
	Sat,  7 Feb 2026 11:35:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="V38WuvTQ"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7389C23B63C;
	Sat,  7 Feb 2026 11:35:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1770464155; cv=none; b=NyHVtk4vqec2HZPiXZwgWQZsSx1+HZw6AZ4yHhI5YnZGeIs39b5OmFC5gfYys8mmLpCBsm/iNeO78TtHf2hY7zrbnZcWA+ZRU69pRagNKlbizVqK3o8EGvZJ+OZFS868mGckV8VsZ/R86hEapEvURxQDaJw8XnFmw5Pm0Ax4k10=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1770464155; c=relaxed/simple;
	bh=INOjLccc8LtwpiyYYpCd7KKBkOG+vn21Gj8Mf2qQjdw=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=LZvsj7I/XtJQkG0ay586de4ot2Na2eZFshJJv9xl/0fzzBqYmBIFl3KKQ4mt8uh06THD1uaXwnoK58Slah4XpfPjo1oxHZumVr51kZT2J9vwCL3Okqx7/oh9D3V8PBaMtV8eNgicXTomeZYLJj1VPJSj30QtD9quglsUTtityJE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=V38WuvTQ; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id DAF64C116D0;
	Sat,  7 Feb 2026 11:35:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1770464155;
	bh=INOjLccc8LtwpiyYYpCd7KKBkOG+vn21Gj8Mf2qQjdw=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <c3000ddc3cd66f43898c7f7dd9926804d2280878.camel@kernel.org>
...
Date: Sat, 07 Feb 2026 06:35:52 -0500
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-18805-lists,linux-nfs=lfdr.de];
...
> =20
> +/*
> + * By default, if the server fails to fence a client, it retries the fen=
cing
> + * operation indefinitely to prevent data corruption. The admin needs to=
 take
> + * the following actions to restore access to the file for other clients=
:
> + *
> + *    . shutdown or power off the client being fenced.
> + *    . manually expire the client to release all its state on the serve=
r;
> + *      echo 'expire' > proc/fs/nfsd/clients/clientid/ctl'.
> + *
> + * The admim can control this behavior by setting nfsd4_fence_max_retrie=
s
> + * to specify the maximum number of retries. If the maximum is reached, =
the
> + * server gives up and removes the conflicting lease, allowing other cli=
ents
> + * to access the file.
> + */
> +static int nfsd4_fence_max_retries =3D 0;		/* default is retry forever *=
/
...
> +
>  const struct nfsd4_layout_ops *nfsd4_layout_ops[LAYOUT_TYPE_MAX] =3D  {
>  #ifdef CONFIG_NFSD_FLEXFILELAYOUT
>  	[LAYOUT_FLEX_FILES]	=3D &ff_layout_ops,
...
> @@ -271,6 +297,9 @@ nfsd4_alloc_layout_stateid(struct nfsd4_compound_stat=
e *cstate,
...
>  	return false;
>  }
> @@ -782,10 +809,112 @@ nfsd4_layout_lm_open_conflict(struct file *filp, i=
nt arg)
>  	return 0;
>  }
> =20
...
> +	}
> +	/* fence failed */
> +	bdev =3D nf->nf_file->f_path.mnt->mnt_sb->s_bdev;
> +	nfsd_file_put(nf);
> +
...
> +			ls->ls_fence_retries++ >=3D nfsd4_fence_max_retries)
> +		goto dispose;
