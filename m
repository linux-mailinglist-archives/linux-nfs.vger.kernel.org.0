Return-Path: <linux-nfs+bounces-14845-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 265ABBB1907
	for <lists+linux-nfs@lfdr.de>; Wed, 01 Oct 2025 21:05:59 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id D2B653C3504
	for <lists+linux-nfs@lfdr.de>; Wed,  1 Oct 2025 19:05:57 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 69AF725BEE7;
	Wed,  1 Oct 2025 19:05:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="QbjP1zbH"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 451F9213E89
	for <linux-nfs@vger.kernel.org>; Wed,  1 Oct 2025 19:05:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1759345555; cv=none; b=B0dmBrYjRoJ2X5r555FLOtn5ES1zlY/MVWKoY3qRQNxYnsBiFz/+aJ9OEUXOXZ+0oXnwaKgvaDw0YPJsou4Tz70OGSibSYzlwiw0ghd5ZpiztdwLepT7Qn7LVwBYdfMeONtMqfjlgF3HIaQEmUgmmvFpgZjKeX9ZZpNLSh1d68o=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1759345555; c=relaxed/simple;
	bh=X/AlRRCTxIkFlEY3+vkoN3NGQ7DpeeqccQPySGzXE0k=;
	h=From:To:Cc:Subject:Date:Message-ID:MIME-Version; b=aChj0vasJEpqYVgbAowxmZUDr4xuzkkdo6s550AEsEMhPin6NiSXTfsA6P/0fS8KvV3tcioJvArbYp02QuZrJK893PDPycjNuNzKwWMbGnxXQQ4JanZUtqdJS65/fanaGC0iOeBrSGS6FytyvqkZlApaIr2Nr7Hgn9+Z/Upz4uI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=QbjP1zbH; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id DDA28C4CEF1;
	Wed,  1 Oct 2025 19:05:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1759345554;
	bh=X/AlRRCTxIkFlEY3+vkoN3NGQ7DpeeqccQPySGzXE0k=;
	h=From:To:Cc:Subject:Date:From;
	b=
...
Subject: [PATCH v3] NFSD: Add a subsystem policy document
Date: Wed,  1 Oct 2025 15:05:51 -0400
Message-ID: <20251001190552.13063-1-cel@kernel.org>
...
---
 .../nfs/nfsd-maintainer-entry-profile.rst     | 524 ++++++++++++++++++
...
index 000000000000..425c93066779
--- /dev/null
...
+are referred to as "maintainers." Maintainers can also contribute
+code and reviews.
+
