Return-Path: <linux-nfs+bounces-2381-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A2EB87F1E2
	for <lists+linux-nfs@lfdr.de>; Mon, 18 Mar 2024 22:15:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 3902E1C2037D
	for <lists+linux-nfs@lfdr.de>; Mon, 18 Mar 2024 21:15:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9659459B42;
	Mon, 18 Mar 2024 21:15:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kuleuven.be header.i=@kuleuven.be header.b="atwRbdb/";
	dkim=pass (2048-bit key) header.d=esat.kuleuven.be header.i=@esat.kuleuven.be header.b="ixQAvIfI"
X-Original-To: linux-nfs@vger.kernel.org
Received: from icts-p-cavspool-1.kulnet.kuleuven.be (icts-p-cavspool-1.kulnet.kuleuven.be [134.58.240.194])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5323059B47
	for <linux-nfs@vger.kernel.org>; Mon, 18 Mar 2024 21:15:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=134.58.240.194
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710796526; cv=none; b=rg+E3bynvxChzaAlbVCF+W7fjoyunAWpTmFGivvKb+Uw8yaU4kmklVXb31CakEIxmAVLkl1WhbEHivuIbZ/MR8JuxpqzcYe0LjfAK2GIx9aLv0uH+6DJ63DVc+qdDfO26DShS8TO2hbY77FnPDb+WbZYFXGA9g1vI4ZDlMUDl9E=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710796526; c=relaxed/simple;
	bh=afneQpA2Zf7pWbcbGwH4SlOoGR0W8RbPCt5a0Ys1A88=;
	h=Message-ID:Date:MIME-Version:Subject:From:To:References:
	 In-Reply-To:Content-Type; b=PFE2n+vyD/wUnsXoxZvw8s5yLGvl88+uRrrFjSeBsxJ8Yk/Ih03thBZGF/haYLbo0cobfKxIBo9DxXeeLhh97Jzs96oEP4Pq+9CrEckBKU4x5xrXOoHcBpKLP+tru0iQxF0Yxgf/yd30sctPJx75k4AI9DDUfvlRsRNWjEHLRCE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=esat.kuleuven.be; spf=pass smtp.mailfrom=esat.kuleuven.be; dkim=pass (2048-bit key) header.d=kuleuven.be header.i=@kuleuven.be header.b=atwRbdb/; dkim=pass (2048-bit key) header.d=esat.kuleuven.be header.i=@esat.kuleuven.be header.b=ixQAvIfI; arc=none smtp.client-ip=134.58.240.194
...
Received: from icts-p-cavuit-1.kulnet.kuleuven.be (icts-p-cavuit-1.kulnet.kuleuven.be [134.58.240.132])
	by icts-p-cavspool-1.kulnet.kuleuven.be (Postfix) with ESMTP id 9237B2E45
	for <linux-nfs@vger.kernel.org>; Mon, 18 Mar 2024 22:15:18 +0100 (CET)
X-KULeuven-Envelope-From: rik.theys@esat.kuleuven.be
X-KULeuven-Scanned: Found to be clean
X-KULeuven-ID: 15BEA201AA.AC7FC
...
Received: from icts-p-ceifnet-smtps-1.kuleuven.be (icts-p-ceifnet-smtps.service.icts.svcd [IPv6:2a02:2c40:0:51:133:242:ac11:1c])
	by icts-p-cavuit-1.kulnet.kuleuven.be (Postfix) with ESMTP id 15BEA201AA;
	Mon, 18 Mar 2024 22:15:09 +0100 (CET)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=kuleuven.be;
	s=kuleuven-cav-1; t=1710796508;
	bh=eFlpz4+OyL7dSR3Tm46WNbBX0VcMnijbSEBVt6uyRz4=;
	h=Date:Subject:From:To:References:In-Reply-To;
	b=
Received: from hydrogen.esat.kuleuven.be (hydrogen.esat.kuleuven.be [134.58.56.153])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by icts-p-ceifnet-smtps-1.kuleuven.be (Postfix) with ESMTPS id 92CDBD4F41DAD;
	Mon, 18 Mar 2024 22:15:08 +0100 (CET)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=esat.kuleuven.be;
	s=esat20220324; t=1710796508;
	bh=eFlpz4+OyL7dSR3Tm46WNbBX0VcMnijbSEBVt6uyRz4=;
	h=Date:Subject:From:To:References:In-Reply-To:From;
	b=
X-KULeuven-ESAT-Envelope-Sender: rik.theys@esat.kuleuven.be
Received: from [192.168.1.178] (d54c12615.access.telenet.be [84.193.38.21])
	...
	(No client certificate requested)
	by hydrogen.esat.kuleuven.be (Postfix) with ESMTPSA id 731CB6000E;
	Mon, 18 Mar 2024 22:15:08 +0100 (CET)
Message-ID: <41325088-aa6d-4dcf-b105-8994350168c3@esat.kuleuven.be>
Date: Mon, 18 Mar 2024 22:15:08 +0100
Precedence: bulk
...
In-Reply-To: <e3ba6e04-ea06-4035-8546-639f11d6b79c@esat.kuleuven.be>
