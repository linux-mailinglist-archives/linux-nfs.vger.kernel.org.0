...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CE49A64A362
	for <lists+linux-nfs@lfdr.de>; Mon, 12 Dec 2022 15:31:43 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232498AbiLLObl (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Mon, 12 Dec 2022 09:31:41 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48836 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232280AbiLLObe (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Mon, 12 Dec 2022 09:31:34 -0500
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 18B5E13CD4
        for <linux-nfs@vger.kernel.org>; Mon, 12 Dec 2022 06:31:23 -0800 (PST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id ABA0960FF4
        for <linux-nfs@vger.kernel.org>; Mon, 12 Dec 2022 14:31:22 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 63FBBC433EF;
        Mon, 12 Dec 2022 14:31:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1670855482;
        bh=XfK4PKYNCfcWHqk1Ar0UUs2C/zZ1v7onM5ym1reqPvI=;
        h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
        b=
Message-ID: <a47cc610af621e95ba359388e93d988f1ef5b17f.camel@kernel.org>
...
Date:   Mon, 12 Dec 2022 09:31:19 -0500
...
> > > > >    *
> > > > > @@ -1572,11 +1565,6 @@ nfsd4_cleanup_inter_ssc(struct vfsmount *s=
s_mnt, struct file *filp,
> > > > >   {
> > > > >   }
> > > > >  =20
> > > > > -static void
...
> > > > > @@ -1852,8 +1841,10 @@ nfsd4_copy(struct svc_rqst *rqstp, struct =
...
h the
> > > > refcounting around ss_mnt elsewhere in this code.=A0nfsd4_ssc_setup=
_dul
...
> > > > BUG_ON?
> > >=20
> > > if ni is not found on the list then it's a bug somewhere so I will ad=
d
> > > a BUG_ON on this.
> > >=20
> >=20
