Return-Path: <linux-nfs+bounces-14522-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id A12C1B81529
	for <lists+linux-nfs@lfdr.de>; Wed, 17 Sep 2025 20:18:57 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 32CB2188A496
	for <lists+linux-nfs@lfdr.de>; Wed, 17 Sep 2025 18:19:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3CF202FE06E;
	Wed, 17 Sep 2025 18:18:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="ftK/s5MV"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1793B2FC00C
	for <linux-nfs@vger.kernel.org>; Wed, 17 Sep 2025 18:18:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1758133132; cv=none; b=HQD2iwaTM7f6ZaJh5aBbewbERsKC5GjVwS4OgKBLvBwGrBGFefJfF5N1E1re4oSzOBeszv0HRPHF6g1sal7XKZzNqk9ARSqzzoEndGexkSojXshjuMr1LKsaTJ03deeZuGwCwXqiDBehvPpRFNOk0glk07ATcz/Vp7W9JCbE1SQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1758133132; c=relaxed/simple;
	bh=gdc4eVR5NZ4xSZ4yNxcet5wzPOzP+NfRYchhSz9cfKI=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=cssyC9OGR59JwvTfjT4uBLRCGfuzgqwimfwX2O0UrFbffOk45ZGTe0iHN1SabmuG2X/COFvjIIsP5FQDgFhPhXbOm/pMmPdBCjw+/+KuDyvZu2Z5QH1rHQyobO2i6Evy2U03j1L/m/u0GimZR99OJiU28ZLOp345JqN9AHI6a8Y=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=ftK/s5MV; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 71689C4CEE7;
	Wed, 17 Sep 2025 18:18:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1758133131;
	bh=gdc4eVR5NZ4xSZ4yNxcet5wzPOzP+NfRYchhSz9cfKI=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
	b=
From: Mike Snitzer <snitzer@kernel.org>
To: Anna Schumaker <anna@kernel.org>
Cc: Trond Myklebust <trond.myklebust@hammerspace.com>,
	linux-nfs@vger.kernel.org
Subject: [PATCH v10 5/7] nfs/localio: add proper O_DIRECT support for READ and WRITE
Date: Wed, 17 Sep 2025 14:18:41 -0400
Message-ID: <20250917181843.33865-6-snitzer@kernel.org>
...
---
 fs/nfs/localio.c | 265 +++++++++++++++++++++++++++++++++++++----------
 1 file changed, 209 insertions(+), 56 deletions(-)

diff --git a/fs/nfs/localio.c b/fs/nfs/localio.c
index c99b139c603d0..768af570183af 100644
--- a/fs/nfs/localio.c
+++ b/fs/nfs/localio.c
@@ -30,14 +30,23 @@
...
@@ -446,15 +556,12 @@ nfs_local_read_done(struct nfs_local_kiocb *iocb, long status)
 	struct nfs_pgio_header *hdr = iocb->hdr;
...
@@ -482,6 +589,7 @@ static void nfs_local_read_aio_complete(struct kiocb *kiocb, long ret)
 	struct nfs_local_kiocb *iocb =
...
@@ -496,12 +604,21 @@ static void nfs_local_call_read(struct work_struct *work)
...
@@ -631,14 +748,14 @@ nfs_local_write_done(struct nfs_local_kiocb *iocb, long status)
...
@@ -646,11 +763,11 @@ nfs_local_write_done(struct nfs_local_kiocb *iocb, long status)
...
@@ -667,6 +784,7 @@ static void nfs_local_write_aio_complete(struct kiocb *kiocb, long ret)
 	struct nfs_local_kiocb *iocb =
 		container_of(kiocb, struct nfs_local_kiocb, kiocb);
...
@@ -683,13 +801,48 @@ static void nfs_local_call_write(struct work_struct *work)
...
+	}
 	...
 	revert_creds(save_cred);
@@ -758,7 +911,7 @@ nfs_local_iocb_init(struct nfs_pgio_header *hdr, struct nfsd_file *localio)
 	iocb->hdr = hdr;
