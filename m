Return-Path: <linux-nfs+bounces-20672-lists+linux-nfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-nfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id ECctN6bG02nrlwcAu9opvQ
	(envelope-from <linux-nfs+bounces-20672-lists+linux-nfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-nfs@lfdr.de>; Mon, 06 Apr 2026 16:43:50 +0200
X-Original-To: lists+linux-nfs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E9133A4538
	for <lists+linux-nfs@lfdr.de>; Mon, 06 Apr 2026 16:43:50 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 53FB6301B738
	for <lists+linux-nfs@lfdr.de>; Mon,  6 Apr 2026 14:38:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BDFE12F3C0A;
	Mon,  6 Apr 2026 14:38:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="YDXxEUEC"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9A2CB25D527
	for <linux-nfs@vger.kernel.org>; Mon,  6 Apr 2026 14:38:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1775486307; cv=none; b=f9scAEG0ygO50rM1ORTN3HEXVb1UiUFKTQ8psH+f7jdo68BXWCr9xZNcT5nTdIaLm6eZ88Y/Ou7Gj2/P9Und9JCz0hA9RDqBgJTgvUoY3pBJ/ytSKDttaXo+nzNdl9YXKnxYh9peldJwiCopH3jaF0Mx+OOjf8dfNtsU4RMMmqU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1775486307; c=relaxed/simple;
	bh=kYdaMf7g+ej9zCGEkJzPFJLqh6fd7nGXXBVqnd3fzsk=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=OaZ/iAsdFNdR/fTk+BNDGeZxftfTJRxF47+7efY8ekNbmQDr5sfksXkzmM2cGwWX7epLUAUEXQSzIazkQf8hfYAxcGs0NrPuWk2eHLCB13hUYQdB3BHnkw3kj0j0cxkUzyBVkDM+CtTCRMt8Csq+80KBmiNuPjDDXT88QoJQ6uk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=YDXxEUEC; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 7766FC4CEF7;
	Mon,  6 Apr 2026 14:38:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1775486307;
	bh=kYdaMf7g+ej9zCGEkJzPFJLqh6fd7nGXXBVqnd3fzsk=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <e812ca8b2caaf2cafaf94b7b5be487346fe07285.camel@kernel.org>
...
Date: Mon, 06 Apr 2026 10:38:24 -0400
...
X-Spamd-Result: default: False [-2.16 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-20672-lists,linux-nfs=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[peak-usage.bt:url,sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns]
X-Rspamd-Queue-Id: 3E9133A4538
...
> > > > +nfsd4_deleg_getattr_conflict(struct svc_rqst *rqstp, struct path *=
path,
...
,
> > rather than the vfs_getattr() call I added to nfsd4_deleg_getattr_confl=
ict().
> >=20
> > Here's the stack depth for nfsd4_deleg_getattr_conflict():
> >=20
> > # echo nfsd4_deleg_getattr_conflict=20
> > > /sys/kernel/debug/tracing/stack_trace_filter
> > # echo 0 >/sys/kernel/debug/tracing/stack_max_size=20
> > # cat /sys/kernel/debug/tracing/stack_trace
...
> >=20
> > Manually inspecting function graphs of vfs_getattr(), it looks like the=
 deepest
> > function (that we can trace) is avc_lookup(), so here's a bpftrace scri=
pt that
> > prints the stack depth from avc_lookup() via nfsd4_deleg_getattr_confli=
ct()
> > (I mostly punted to Gemini for this):
> >=20
> > # cat peak-usage.bt=20
> > kprobe:nfsd4_deleg_getattr_conflict {
> >     @in_deleg_conflict[tid] =3D 1;
> > }
> >=20
> > kprobe:avc_lookup /@in_deleg_conflict[tid]/ {
> >     $stack_size =3D (uint64)16384;=20
> >     $sp =3D reg("sp");
> >     $stack_base =3D $sp & ~($stack_size - 1);
> >     $total_used =3D $stack_base + $stack_size - $sp;
> >=20
> >     if ($total_used > @max_depth_bytes) {
> >         @max_depth_bytes =3D $total_used;
> >         @deepest_stack =3D kstack;
> >     }
> > }
> >=20
...
> away with
>=20
>         if (i_size_read(inode) !=3D ncf->ncf_cb_fsize)
>=20
> rather than
>=20
...
>                 goto out_status;
>         }
>         if (stat->size !=3D ncf->ncf_cb_fsize)
>=20
