Return-Path: <linux-nfs+bounces-15538-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [IPv6:2605:f480:58:1:0:1994:3:14])
	by mail.lfdr.de (Postfix) with ESMTPS id 0663BBFE18E
	for <lists+linux-nfs@lfdr.de>; Wed, 22 Oct 2025 21:51:54 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id B5DBB4E2FA4
	for <lists+linux-nfs@lfdr.de>; Wed, 22 Oct 2025 19:51:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 77A5225F7A5;
	Wed, 22 Oct 2025 19:51:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="jWgFib/q"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 521C825228D
	for <linux-nfs@vger.kernel.org>; Wed, 22 Oct 2025 19:51:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1761162709; cv=none; b=KKsvnyAzDGmvXibSe6sO9nF1nmcwvWx+DGsaC0bP2IihEiNfKJMSuXhRV58Wqq4KY7sn1TlPNbpAvZubsYsPYRUkitakVe/3eZfSwQqHHbwObRdpfMaP4eey+SPNSqcjbzveJm/Cysv0/Qw2LPyU6h8nlQllKn3KNC2f6JGXXNk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1761162709; c=relaxed/simple;
	bh=4zGAxqTFsJxA/8sBxQ2uCuOI1Zx8M5lSfmEWjnOStFQ=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=sLKYY6X5Ux2MXJ9v/vvZ3JcDT7l0116PiO3H7jFcWt0TG+djzBd15+PqUb0gflLoPQUZXF/WzcqfsZkijRG2gqA6Y2jrIPuLQhEbF/CyVvKmCIR/p6bnTdL51yJnNfpe4/V1JMSCzxv0djYC7ksdkb9uclMEomCLba9ljenN/+8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=jWgFib/q; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 3E566C4CEE7;
	Wed, 22 Oct 2025 19:51:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1761162708;
	bh=4zGAxqTFsJxA/8sBxQ2uCuOI1Zx8M5lSfmEWjnOStFQ=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <f1aae34ddba90583b20d56d9b66efe09b8e8fa31.camel@kernel.org>
...
Cc: Olga Kornievskaia <okorniev@redhat.com>, chuck.lever@oracle.com, 
 ...
 tom@talpey.com
Date: Wed, 22 Oct 2025 15:51:47 -0400
In-Reply-To: <CAN-5tyHWWkmgcFCgpZR2Bqm7tAued_JPZ-i0rGaa+FzLtFhMjw@mail.gmail.com>
...
> On Wed, Oct 22, 2025 at 12:06=E2=80=AFPM Jeff Layton <jlayton@kernel.org>=
 wrote:
> >=20
...
> > > >         return rc;
> > >=20
> > > Aren't these svc4proc changes defeat the purpose of the following com=
mit:
> > >=20
...
> > >=20
> > >     Instead of trusting that struct file_lock returns completely unch=
anged
> > >     after vfs_test_lock() when there's no conflicting lock, stash awa=
y our
> > >     nlm_lockowner reference so we can properly release it for all cas=
es.
> > >=20
> > >=20
> > >     This defends against another file_lock implementation overwriting=
 fl_owner
