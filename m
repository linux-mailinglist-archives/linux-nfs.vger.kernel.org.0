...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 304C048CE12
	for <lists+linux-nfs@lfdr.de>; Wed, 12 Jan 2022 22:56:39 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233893AbiALV4f (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Wed, 12 Jan 2022 16:56:35 -0500
Received: from us-smtp-delivery-124.mimecast.com ([170.10.133.124]:25551 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S233849AbiALV4e (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Wed, 12 Jan 2022 16:56:34 -0500
...
Subject: [PATCH v6] cifs: Support fscache indexing rewrite
MIME-Version: 1.0
...
[Note: This has been detached from my fscache-rewrite pull request and sta=
cked
...
@@ -1376,12 +1373,19 @@ struct inode *cifs_root_iget(struct super_block *s=
b)
 		inode =3D ERR_PTR(rc);
 	}
 =
...
@@ -2784,8 +2791,10 @@ cifs_setattr_unix(struct dentry *direntry, struct i=
attr *attrs)
 		goto out;
 =
...
@@ -2980,8 +2989,10 @@ cifs_setattr_nounix(struct dentry *direntry, struct=
 iattr *attrs)
