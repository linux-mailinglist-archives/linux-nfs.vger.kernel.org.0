Return-Path: <linux-nfs+bounces-15481-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [142.0.200.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 4FCDDBF7CF8
	for <lists+linux-nfs@lfdr.de>; Tue, 21 Oct 2025 19:03:22 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id 4EEEF4F62D5
	for <lists+linux-nfs@lfdr.de>; Tue, 21 Oct 2025 17:03:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 623D21373;
	Tue, 21 Oct 2025 17:03:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="LKYb9a1+"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3C88434847A
	for <linux-nfs@vger.kernel.org>; Tue, 21 Oct 2025 17:03:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1761066196; cv=none; b=tMMOUpFCcqHpTC3nK6sYUB9yvt0iw1pGCXI0j5WH4ssDrmP61iLJw3AkDnlWzldBAE4u3Ha+GW2jBL2HBBo2T+W7BgNvmALQQ3+I2DLlAwX93uDFrWUSw/UgZhf8cnW/A2k/2Fpcm63r4tcetOxNLXV2dPhBoru/bIyJykkNldM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1761066196; c=relaxed/simple;
	bh=8N0fnPKehSPZJyBshEHXocnNBSBW/xlBdz5JC0bRk5o=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=tefEcOwcjtsuFpT/jgUyk1x2ZUxscf2kHbSz+nAtmxzzO6Enc5H1DAtLO1KsL/44ra2nvg77Oe2gTXGSDYwtZk0qsF1yppVCQjOmLQaMCvL6P5+XeytaCX0rbhLgdAI4VXPvTl5WyXi84d1ikAXGJjIagdUlHcH+l4DwBEgjFWo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=LKYb9a1+; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 1D0A7C4CEF5;
	Tue, 21 Oct 2025 17:03:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1761066195;
	bh=8N0fnPKehSPZJyBshEHXocnNBSBW/xlBdz5JC0bRk5o=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <ff353db93ca47b8fae530695ea44c0a34cd40af8.camel@kernel.org>
...
Cc: Olga Kornievskaia <okorniev@redhat.com>, chuck.lever@oracle.com, 
 ...
 tom@talpey.com
Date: Tue, 21 Oct 2025 13:03:14 -0400
In-Reply-To: <CAN-5tyGK4MHgYaN1SqpygtvWM8BFrapT-rXY_y9msVfnRjN1Jw@mail.gmail.com>
...
> > > > > When it's reexport, filp->f_op->lock is set and when vfs_test_loc=
k()
...
> > > > >=20
> > > > > The proposed solution is to intentionally clear fl_lmops pointer =
to
...
> > > > > kernel: BUG: KASAN: slab-use-after-free in nlmsvc_put_lockowner+0=
x30/0x250 [lockd]
> > > > > kernel: Read of size 4 at addr ffff0000bf3bca10 by task lockd/609=
2
> > > > > kernel:
> > > > > kernel: CPU: 0 UID: 0 PID: 6092 Comm: lockd Kdump: loaded Not tai=
nted 6.18.0-rc1+ #23 PREEMPT(voluntary)
> > > > > kernel: Hardware name: VMware, Inc. VMware20,1/VBSA, BIOS VMW201.=
...
> > > > > kernel:  ret_from_fork+0x10/0x20
> > > > > kernel:
> > > > > kernel: The buggy address belongs to the object at ffff0000bf3bca=
00
...
> > > > > kernel: page: refcount:0 mapcount:0 mapping:0000000000000000 inde=
x:0x0 pfn:0x13f3bc
> > > > > kernel: flags: 0x2fffff00000000(node=3D0|zone=3D2|lastcpupid=3D0x=
fffff)
> > > > > kernel: page_type: f5(slab)
> > > > > kernel: raw: 002fffff00000000 ffff0000800028c0 dead000000000122 0=
000000000000000
> > > > > kernel: raw: 0000000000000000 0000000080200020 00000000f5000000 0=
000000000000000
> > > > > kernel: page dumped because: kasan: bad access detected
> > > > > kernel:
> > > > > kernel: Memory state around the buggy address:
> > > > > kernel:  ffff0000bf3bc900: fa fb fb fb fb fb fb fb fc fc fc fc fc=
 fc fc fc
> > > > > kernel:  ffff0000bf3bc980: fa fb fb fb fb fb fb fb fc fc fc fc fc=
 fc fc fc
> > > > > kernel: >ffff0000bf3bca00: fa fb fb fb fb fb fb fb fc fc fc fc fc=
 fc fc fc
> > > > > kernel:                          ^
> > > > > kernel:  ffff0000bf3bca80: fa fb fb fb fb fb fb fb fc fc fc fc fc=
 fc fc fc
> > > > > kernel:  ffff0000bf3bcb00: fc fc fc fc fc fc fc fc fc fc fc fc fc=
 fc fc fc
> > > > > kernel: =3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
...
> > > > > kernel: WARNING: CPU: 0 PID: 6092 at lib/refcount.c:87 refcount_d=
ec_not_one+0x198/0x1b0
> > > > > kernel: Modules linked in: rpcrdma rdma_cm iw_cm ib_cm ib_core nf=
sd nfsv3 nfs_acl nfs lockd grace nfs_localio netfs ext4 crc16 mbcache jbd2 =
overlay uinput snd_seq_dummy snd_hrtimer qrtr rfkill vfat fat uvcvideo snd_=
hda_codec_generic videobuf2_vmalloc videobuf2_memops uvc snd_hda_intel vide=
obuf2_v4l2 videobuf2_common snd_intel_dspcfg videodev snd_hda_codec snd_hda=
_core mc snd_hwdep snd_seq snd_seq_device snd_pcm snd_timer snd soundcore s=
g loop auth_rpcgss vsock_loopback vmw_vsock_virtio_transport_common vmw_vso=
ck_vmci_transport vmw_vmci vsock xfs 8021q garp stp llc mrp nvme nvme_core =
nvme_keyring nvme_auth ghash_ce hkdf e1000e sr_mod cdrom vmwgfx drm_ttm_hel=
per ttm sunrpc dm_mirror dm_region_hash dm_log iscsi_tcp libiscsi_tcp libis=
csi scsi_transport_iscsi fuse dm_multipath dm_mod nfnetlink
> > > > > kernel: CPU: 0 UID: 0 PID: 6092 Comm: lockd Kdump: loaded Tainted=
: G    B               6.18.0-rc1+ #23 PREEMPT(voluntary)
> > > > > kernel: Tainted: [B]=3DBAD_PAGE
> > > > > kernel: Hardware name: VMware, Inc. VMware20,1/VBSA, BIOS VMW201.=
00V.24006586.BA64.2406042154 06/04/2024
> > > > > kernel: pstate: 61400005 (nZCv daif +PAN -UAO -TCO +DIT -SSBS BTY=
PE=3D--)
> > > > > kernel: pc : refcount_dec_not_one+0x198/0x1b0
> > > > > kernel: lr : refcount_dec_not_one+0x198/0x1b0
> > > > > kernel: sp : ffff80008a627930
> > > > > kernel: x29: ffff80008a627990 x28: ffff0000bf3bca00 x27: ffff0000=
ba5c7000
> > > > > kernel: x26: 1fffe000191eeb84 x25: 1ffff000114c4f48 x24: ffff0000=
c8f75c24
> > > > > kernel: x23: 0000000000000007 x22: ffff80008a627950 x21: 1ffff000=
114c4f26
> > > > > kernel: x20: 00000000ffffffff x19: ffff0000bf3bca10 x18: 00000000=
00000310
> > > > > kernel: x17: 0000000000000000 x16: 0000000000000000 x15: 00000000=
00000000
> > > > > kernel: x14: 0000000000000000 x13: 0000000000000001 x12: ffff6000=
4fd90aa3
> > > > > kernel: x11: 1fffe0004fd90aa2 x10: ffff60004fd90aa2 x9 : dfff8000=
00000000
> > > > > kernel: x8 : 00009fffb026f55e x7 : ffff00027ec85513 x6 : 00000000=
00000001
> > > > > kernel: x5 : ffff00027ec85510 x4 : ffff60004fd90aa3 x3 : ffff8000=
80787bc0
> > > > > kernel: x2 : 0000000000000000 x1 : 0000000000000000 x0 : ffff0000=
a75a8000
> > > > > kernel: Call trace:
...
> > > > > @@ -652,6 +652,7 @@ nlmsvc_testlock(struct svc_rqst *rqstp, struc=
t nlm_file *file,
...
> > >=20
> > > I have no claim that this solution is the best. I was contemplating o=
n
...
> > > 3. After vfs_test_lock() fl_lmops is still set so lock_release_privat=
e
...
> > >=20
> > > Reexport is where I'm hazy. I'm assuming that reexported server opene=
d
...
> > > ->lock() is set . Both are confusing and I would say warrant a commen=
t
