Return-Path: <linux-nfs+bounces-18924-lists+linux-nfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-nfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id uAp+LVpvj2m3QwEAu9opvQ
	(envelope-from <linux-nfs+bounces-18924-lists+linux-nfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-nfs@lfdr.de>; Fri, 13 Feb 2026 19:37:14 +0100
X-Original-To: lists+linux-nfs@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id D0E22138F93
	for <lists+linux-nfs@lfdr.de>; Fri, 13 Feb 2026 19:37:11 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id C11D9302EA94
	for <lists+linux-nfs@lfdr.de>; Fri, 13 Feb 2026 18:37:10 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 62BDE27FD40;
	Fri, 13 Feb 2026 18:37:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=oracle.com header.i=@oracle.com header.b="A+6wksCm"
X-Original-To: linux-nfs@vger.kernel.org
Received: from mx0b-00069f02.pphosted.com (mx0b-00069f02.pphosted.com [205.220.177.32])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6B3E51F9ECB;
	Fri, 13 Feb 2026 18:37:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=205.220.177.32
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1771007827; cv=none; b=EcRBlxKAtezhelp+FAuCKGr+tpi1gIMgJ8Yst9H2YhhJU9byTIBL0oM8XST1Su4gvKcWlDep5Zz2Ken94AW0KXC1R1GrMo/ugTrRsR9cmbjzV/Ag6DYNe8b8UgGrYrc0pKYMNECVm6GqcybR7yiKDVb+C57b9QIeHQbX2qSXOJM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1771007827; c=relaxed/simple;
	bh=RbvVtIniNKY1mBmBWlNWxG/feF8CWrJK5Jausn+dx8g=;
	h=From:To:Cc:Subject:Date:Message-ID:MIME-Version; b=GhC7gim09bJuIH9G/FFjanXdK3o+SuOSqMzjbVOQFgWXOBLQKIB+XmnMMJZjngi7WfAFcJqAric8G6sP0SQ9SkquUufMAhyL1jPNB647gCpjqGt3WxBI/QDQBI7xdOZR822y2DgV1BJg8uSZRpYTXF9AppsSxvioQbr6vIYptU4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=oracle.com; spf=pass smtp.mailfrom=oracle.com; dkim=pass (2048-bit key) header.d=oracle.com header.i=@oracle.com header.b=A+6wksCm; arc=none smtp.client-ip=205.220.177.32
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=oracle.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=oracle.com
Received: from pps.filterd (m0246631.ppops.net [127.0.0.1])
	by mx0b-00069f02.pphosted.com (8.18.1.11/8.18.1.11) with ESMTP id 61DDbMru3345484;
	Fri, 13 Feb 2026 18:36:53 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=cc
	:content-transfer-encoding:date:from:message-id:mime-version
	:subject:to; s=corp-2025-04-25; bh=w3te57qz4lwokpAeoMPhjaz3UUF+L
	J79trhHlK3zj9I=; b=A+6wksCmAROWyKSJy7ay1E+N+ysCJdeIRqsHeWlWV09sz
	
Received: from iadpaimrmta03.imrmtpd1.prodappiadaev1.oraclevcn.com (iadpaimrmta03.appoci.oracle.com [130.35.103.27])
	by mx0b-00069f02.pphosted.com (PPS) with ESMTPS id 4c7s7ry3dn-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
	Fri, 13 Feb 2026 18:36:52 +0000 (GMT)
Received: from pps.filterd (iadpaimrmta03.imrmtpd1.prodappiadaev1.oraclevcn.com [127.0.0.1])
	by iadpaimrmta03.imrmtpd1.prodappiadaev1.oraclevcn.com (8.18.1.2/8.18.1.2) with ESMTP id 61DHa9JF022523;
	Fri, 13 Feb 2026 18:36:52 GMT
Received: from pps.reinject (localhost [127.0.0.1])
	by iadpaimrmta03.imrmtpd1.prodappiadaev1.oraclevcn.com (PPS) with ESMTPS id 4c828env41-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
	Fri, 13 Feb 2026 18:36:52 +0000
Received: from iadpaimrmta03.imrmtpd1.prodappiadaev1.oraclevcn.com (iadpaimrmta03.imrmtpd1.prodappiadaev1.oraclevcn.com [127.0.0.1])
	by pps.reinject (8.17.1.5/8.17.1.5) with ESMTP id 61DIap4i024772;
	Fri, 13 Feb 2026 18:36:51 GMT
Received: from labops-common-sca-01.us.oracle.com (labops-common-sca-01.us.oracle.com [10.132.26.161])
	by iadpaimrmta03.imrmtpd1.prodappiadaev1.oraclevcn.com (PPS) with ESMTP id 4c828env3g-1;
	Fri, 13 Feb 2026 18:36:51 +0000
...
Subject: [PATCH v12 1/1] NFSD: Enforce timeout on layout recall and integrate lease manager fencing
Date: Fri, 13 Feb 2026 10:36:30 -0800
Message-ID: <20260213183647.4045478-1-dai.ngo@oracle.com>
...
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 bulkscore=0 adultscore=0 phishscore=0
 ...
 definitions=main-2602130143
X-Authority-Analysis: v=2.4 cv=PZbyRyhd c=1 sm=1 tr=0 ts=698f6f45 b=1 cx=c_pps
 a=qoll8+KPOyaMroiJ2sR5sw==:117 a=qoll8+KPOyaMroiJ2sR5sw==:17
 a=HzLeVaNsDn8A:10 a=VkNPw1HP01LnGYTKEx00:22 a=Mpw57Om8IfrbqaoTuvik:22
 a=GgsMoib0sEa3-_RKJdDe:22 a=yPCof4ZbAAAA:8 a=qEu-IRwdT1xVvaKju64A:9 cc=ntf
 awl=host:12149
X-Proofpoint-Spam-Details-Enc: AW1haW4tMjYwMjEzMDE0MyBTYWx0ZWRfX9Gf5T9931JKx
 
X-Proofpoint-ORIG-GUID: TrDPqP3ek7doZAxZenP3mm8mM_-tJa2P
X-Proofpoint-GUID: TrDPqP3ek7doZAxZenP3mm8mM_-tJa2P
...
X-Spamd-Result: default: False [0.84 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-18924-lists,linux-nfs=lfdr.de];
...
---
 ...
 .../admin-guide/nfs/pnfs-scsi-server.rst      |  31 ++++
 Documentation/filesystems/locking.rst         |   2 +
 fs/locks.c                                    |  26 +++-
 fs/nfsd/blocklayout.c                         |  42 +++++-
 fs/nfsd/nfs4layouts.c                         | 141 +++++++++++++++++-
...
v12:
   . remove unused dispose list nfsd4_layout_fence_worker.
   . fix break_time value in __break_lease.
   . replace refcount_inc with refcount_inc_not_zero in
...
index 46f229f740c8..98279befe23a 100644
--- a/fs/locks.c
+++ b/fs/locks.c
...
@@ -1660,9 +1672,13 @@ int __break_lease(struct inode *inode, unsigned int flags)
 restart:
...
index ad7af8cfcf1f..01902e16529b 100644
...
@@ -782,10 +793,132 @@ nfsd4_layout_lm_open_conflict(struct file *filp, int arg)
 	return 0;
 }
