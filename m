Return-Path: <linux-nfs+bounces-2403-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 570AF88058F
	for <lists+linux-nfs@lfdr.de>; Tue, 19 Mar 2024 20:41:32 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 9670CB22975
	for <lists+linux-nfs@lfdr.de>; Tue, 19 Mar 2024 19:41:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7AABC39FD6;
	Tue, 19 Mar 2024 19:41:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kuleuven.be header.i=@kuleuven.be header.b="cHdcNrO+";
	dkim=pass (2048-bit key) header.d=esat.kuleuven.be header.i=@esat.kuleuven.be header.b="MMJq/UoE"
X-Original-To: linux-nfs@vger.kernel.org
Received: from icts-p-cavuit-3.kulnet.kuleuven.be (icts-p-cavuit-3.kulnet.kuleuven.be [134.58.240.133])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1164E20B21
	for <linux-nfs@vger.kernel.org>; Tue, 19 Mar 2024 19:41:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=134.58.240.133
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710877284; cv=none; b=kicM9VSf9mzo8a+noCz57/HauEjMlSTfJWRA7Rdj7THT2GDQppLfriHs9DHp4yQNkhJmOmh8PVAy2RAuC/T3ADrar11lyI2j1SSj4CjmDwf/haQmyJ4l8fN442bshMokHr2/HWosDUvVbRwWykQjEM6e6g3eDN241hZ0cQ5AlDI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710877284; c=relaxed/simple;
	bh=kubmZb3+xPYDkJJKeaLR3W0PTQXPj79BKwOFw369fdY=;
	h=Message-ID:Date:MIME-Version:Subject:To:References:From:
	 In-Reply-To:Content-Type; b=OqGe++90Q/meOxMLpKMXcLba9ZVjLGbSqLXY6+8501Cs0VSw1zufBDWVtil2AGK5QW6KVMe7iw3stS5qyfHwDrGeHyskvwKgD1PQNpz/DUn7pGeKA8tW4g+z43TrIUgVKroZeAM0aPffcZ+P/16QBAPVsONZdF/HvaWrG8TZE9Y=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=esat.kuleuven.be; spf=pass smtp.mailfrom=esat.kuleuven.be; dkim=pass (2048-bit key) header.d=kuleuven.be header.i=@kuleuven.be header.b=cHdcNrO+; dkim=pass (2048-bit key) header.d=esat.kuleuven.be header.i=@esat.kuleuven.be header.b=MMJq/UoE; arc=none smtp.client-ip=134.58.240.133
...
X-KULeuven-ID: 3557D201AF.A84D8
...
Received: from icts-p-ceifnet-smtps-1.kuleuven.be (icts-p-ceifnet-smtps.service.icts.svcd [IPv6:2a02:2c40:0:51:133:242:ac11:1c])
	by icts-p-cavuit-3.kulnet.kuleuven.be (Postfix) with ESMTP id 3557D201AF;
	Tue, 19 Mar 2024 20:41:13 +0100 (CET)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=kuleuven.be;
	s=kuleuven-cav-1; t=1710877272;
	bh=NvUnVdk806sG15xBxznJYpt+FPMYVr8vBo+GhvAikhY=;
	h=Date:Subject:To:References:From:In-Reply-To;
	b=
Received: from hydrogen.esat.kuleuven.be (hydrogen.esat.kuleuven.be [134.58.56.153])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by icts-p-ceifnet-smtps-1.kuleuven.be (Postfix) with ESMTPS id 81E5FD4F41ACD;
	Tue, 19 Mar 2024 20:41:12 +0100 (CET)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=esat.kuleuven.be;
	s=esat20220324; t=1710877272;
	bh=NvUnVdk806sG15xBxznJYpt+FPMYVr8vBo+GhvAikhY=;
	h=Date:Subject:To:References:From:In-Reply-To:From;
	b=
X-KULeuven-ESAT-Envelope-Sender: rik.theys@esat.kuleuven.be
X-KULeuven-ESAT-Envelope-Sender: rik.theys@esat.kuleuven.be
Received: from [192.168.1.178] (d54C12615.access.telenet.be [84.193.38.21])
	...
	(No client certificate requested)
	by hydrogen.esat.kuleuven.be (Postfix) with ESMTPSA id 5C2986000E;
	Tue, 19 Mar 2024 20:41:12 +0100 (CET)
Message-ID: <d90551d6-a48f-4c25-a2f0-8dbd2b5e5830@esat.kuleuven.be>
Date: Tue, 19 Mar 2024 20:41:11 +0100
Precedence: bulk
...
In-Reply-To: <50dd9475-b485-4b9b-bcbd-5f7dfabfbac5@oracle.com>
