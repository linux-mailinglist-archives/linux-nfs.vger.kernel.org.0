...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 66B81AC340
	for <lists+linux-nfs@lfdr.de>; Sat,  7 Sep 2019 01:36:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2392973AbfIFXgf (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Fri, 6 Sep 2019 19:36:35 -0400
Received: from mail-io1-f66.google.com ([209.85.166.66]:38480 "EHLO
        mail-io1-f66.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2393032AbfIFXgf (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Fri, 6 Sep 2019 19:36:35 -0400
Received: by mail-io1-f66.google.com with SMTP id p12so16623272iog.5
        for <linux-nfs@vger.kernel.org>; Fri, 06 Sep 2019 16:36:34 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=wh+xFaGuz7VyJ+8vf7usueOjkVnzcLIJjA1o9X1y3ws=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=wh+xFaGuz7VyJ+8vf7usueOjkVnzcLIJjA1o9X1y3ws=;
        b=
X-Gm-Message-State: APjAAAWsKvLCabJgipsIo44Rau++7Q5502oiMUwBcF6EkPqJmiQ/mhfl
        +P1cY8JL1tqDaD+/o4NyfEqSAV6/eY8=
X-Google-Smtp-Source: APXvYqz3dHaC03rnqEvPCeDamh3FDOC3D9/Zm57gxFU/KA9YLpNj31xGXZQevVMVDavc9g1amk6gmw==
X-Received: by 2002:a5d:8788:: with SMTP id f8mr12997063ion.20.1567812993993;
        Fri, 06 Sep 2019 16:36:33 -0700 (PDT)
Received: from Olgas-MBP-201.attlocal.net (172-10-226-31.lightspeed.livnmi.sbcglobal.net. [172.10.226.31])
        by smtp.gmail.com with ESMTPSA id r138sm10439360iod.59.2019.09.06.16.36.33
...
Subject: [PATCH v7 21/21] NFSD add nfs4 inter ssc to nfsd4_copy
Date:   Fri,  6 Sep 2019 19:36:11 -0400
Message-Id: <20190906233611.4031-22-olga.kornievskaia@gmail.com>
...
index 69dd53bec80b..630e94d5e6a9 100644
...
+do_callback:
 	...
 	if (!cb_copy)
 		goto out;
@@ -1276,11 +1503,20 @@ nfsd4_copy(struct svc_rqst *rqstp, struct nfsd4_compound_state *cstate,
 	__be32 status;
...
@@ -1291,15 +1527,15 @@ nfsd4_copy(struct svc_rqst *rqstp, struct nfsd4_compound_state *cstate,
...
@@ -1310,12 +1546,16 @@ nfsd4_copy(struct svc_rqst *rqstp, struct nfsd4_compound_state *cstate,
...
@@ -1326,7 +1566,7 @@ find_async_copy(struct nfs4_client *clp, stateid_t *stateid)
...
@@ -1342,17 +1582,18 @@ nfsd4_offload_cancel(struct svc_rqst *rqstp,
 		     union nfsd4_op_u *u)
 {
...
index b3c106878afd..6ca391e25a0d 100644
--- a/fs/nfsd/nfs4state.c
+++ b/fs/nfsd/nfs4state.c
@@ -5678,8 +5678,9 @@ _free_cpntf_state_locked(struct nfsd_net *nn, struct nfs4_cpntf_state *cps)
...
index 18d94ea984ba..033bfcb4d027 100644
--- a/fs/nfsd/nfssvc.c
+++ b/fs/nfsd/nfssvc.c
@@ -30,6 +30,12 @@
...
index 127c929039a9..6a9e4fd25fc5 100644
--- a/fs/nfsd/state.h
+++ b/fs/nfsd/state.h
@@ -678,6 +678,9 @@ extern struct nfsd4_copy *
...
index d76f9beddaf1..75b884f876a1 100644
--- a/fs/nfsd/xdr4.h
+++ b/fs/nfsd/xdr4.h
