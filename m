...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 36302BE4E6
	for <lists+linux-nfs@lfdr.de>; Wed, 25 Sep 2019 20:44:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2438107AbfIYSoT (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Wed, 25 Sep 2019 14:44:19 -0400
Received: from mail-io1-f65.google.com ([209.85.166.65]:36029 "EHLO
        mail-io1-f65.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2437582AbfIYSoT (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Wed, 25 Sep 2019 14:44:19 -0400
Received: by mail-io1-f65.google.com with SMTP id b136so1509859iof.3
        for <linux-nfs@vger.kernel.org>; Wed, 25 Sep 2019 11:44:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc:content-transfer-encoding;
        bh=/+3Q5JqAnWLC0kB4ZN2DWSe1cAaMlOsC1gqX6w2DM1Q=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=/+3Q5JqAnWLC0kB4ZN2DWSe1cAaMlOsC1gqX6w2DM1Q=;
        b=
X-Gm-Message-State: APjAAAVbcuto2zPFMZ2WweR38qBna05bKyVf/CclZQxaNI8bMvI5VD03
        2+3E5jY4NQTyeMYSnJrugMn6cOoj+5Ilgfwrh+PuzIiC
X-Google-Smtp-Source: APXvYqxwaLYQw+vm/iA/JkZBm/n09vX8tIXpbBoDs65c/O0It4of3p9QLfeDaP6+tV7/ztntKwzBJic/kYMHuiRK594=
X-Received: by 2002:a6b:6a01:: with SMTP id x1mr854266iog.119.1569437057705;
 Wed, 25 Sep 2019 11:44:17 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <57192382-86BE-4878-9AE0-B22833D56367@oracle.com>
From:   Kevin Vasko <kvasko@gmail.com>
Date:   Wed, 25 Sep 2019 13:44:06 -0500
Message-ID: <CAMd28E-zcjuCfVbDCra4Av3Ewsdd-Ai=E0j3tF2GKJ8P6nG8=w@mail.gmail.com>
...
like with NFSv4)=E2=80=A6however with NFSv3 it will halt for ~1 minute and
...
300 isn=E2=80=99t authenticating properly with larger writes (for whatever
reason) with Kerberos. This is also why I don=E2=80=99t see the problem whe=
n I
...
Unity box but I don=E2=80=99t see anything really useful regarding Kerberos
...
=3Dtcp,timeo=3D600,retrans=3D2,sec=3Dkrb5p,mountaddr=3D10.75.37.2,mountvers=
=3D3,mountport=3D1234,mountproto=3Dudp,local_lock=3Dnone,addr=3D10.75.37.2)
...
1048576000) =3D 1048576000
close(0)                                =3D 0
close(1)                                =3D -1 EACCES (Permission denied)
openat(AT_FDCWD, "/usr/share/locale/locale.alias", O_RDONLY|O_CLOEXEC) =3D =
0
fstat(0, {st_mode=3DS_IFREG|0644, st_size=3D2995, ...}) =3D 0
read(0, "# Locale name alias data base.\n#"..., 4096) =3D 2995
...
=3D -1 ENOENT (No such file or directory)
openat(AT_FDCWD,
"/usr/share/locale-langpack/en_US/LC_MESSAGES/libc.mo", O_RDONLY) =3D -1
ENOENT (No such file or directory)
openat(AT_FDCWD,
