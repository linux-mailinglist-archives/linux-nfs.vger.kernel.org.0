Return-Path: <linux-nfs+bounces-3668-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 4481F90495E
	for <lists+linux-nfs@lfdr.de>; Wed, 12 Jun 2024 05:08:21 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 5F4D91C231AD
	for <lists+linux-nfs@lfdr.de>; Wed, 12 Jun 2024 03:08:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 90EE7286A6;
	Wed, 12 Jun 2024 03:08:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="QE29d/xr"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6C52428385
	for <linux-nfs@vger.kernel.org>; Wed, 12 Jun 2024 03:08:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1718161691; cv=none; b=CEoDpJebX5FMqUPKJ23BrHkv8khY6+VIfyqyRs3gJCz4zjyhdfRB0Q/cU/9eitibY/vm7uoQ4E26AAqnFTsFxrrNogzXKutZ44UWp3exlAIMROk+hjzrkp1D+h+J6YDKY4Cv+/yWeedl0qpOpp6eGXM0o95A9/bJX0JAgLusfoQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1718161691; c=relaxed/simple;
	bh=DWzSXIeQu9Uc70wrWQRohNZIeHuCwZHn1bmENXNYxsw=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=FXBSlDt+ywvdbAT7zn/feHC8+co9ssQYJ431IcZTaleexxSvMP1PPGHTpjgS1/ET7tDKVQKfPwO8UwVCDqRK84vDvyMkltsajrGC9puTVcMvRxPrVVIh2Dw+EJ3E9xF5efCoPsJL4bZkLvR+mEn/GVObN5WMR/Irb3kmDS1J45o=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=QE29d/xr; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 1B66DC2BD10;
	Wed, 12 Jun 2024 03:08:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1718161691;
	bh=DWzSXIeQu9Uc70wrWQRohNZIeHuCwZHn1bmENXNYxsw=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
	b=
...
Subject: [RFC PATCH v2 12/15] nfsd: implement v3 and v4 server support for NFS_LOCALIO_PROGRAM
Date: Tue, 11 Jun 2024 23:07:49 -0400
Message-ID: <20240612030752.31754-13-snitzer@kernel.org>
...
index 6a418aa5614f..e35480595ec9 100644
--- a/fs/nfsd/localio.c
+++ b/fs/nfsd/localio.c
@@ -17,6 +17,9 @@
 #include "vfs.h"
...
@@ -182,3 +185,148 @@ EXPORT_SYMBOL_GPL(nfsd_open_local_fh);
...
index e67eb34a836b..22fb16258d44 100644
--- a/fs/nfsd/nfssvc.c
+++ b/fs/nfsd/nfssvc.c
@@ -38,6 +38,16 @@
