...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3D7F41A5768
	for <lists+linux-nfs@lfdr.de>; Sun, 12 Apr 2020 01:23:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730007AbgDKXVw (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Sat, 11 Apr 2020 19:21:52 -0400
Received: from mail.kernel.org ([198.145.29.99]:54356 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730396AbgDKXNU (ORCPT <rfc822;linux-nfs@vger.kernel.org>);
        Sat, 11 Apr 2020 19:13:20 -0400
Received: from sasha-vm.mshome.net (c-73-47-72-35.hsd1.nh.comcast.net [73.47.72.35])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id C1AEA20757;
        Sat, 11 Apr 2020 23:13:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1586646799;
        bh=YyeeTMFV0tgtAxT+kXpgph+CCmWOc2eIFn3ez047f7M=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=lPQ2FMhZZteO2xo9X6DyeDO7XOqGVX7tDSYjezMK9rPl+liwt7QxIjibkADjkEy8Y
         am2a8RK3nbobCoI0YgRTd+3lFqg75wWBTAP+h/NSBMTGO+8KZNw8jLUgRhBTON+rmg
         hQbXMDlEwTQpFE/MHgrAnucNmxV5dBtaZfcosGhs=
...
Subject: [PATCH AUTOSEL 4.19 62/66] nfsd: Don't add locks to closed or closing open stateids
Date:   Sat, 11 Apr 2020 19:11:59 -0400
Message-Id: <20200411231203.25933-62-sashal@kernel.org>
...
index ed73e86194fac..033f302d34e4c 100644
--- a/fs/nfsd/nfs4state.c
+++ b/fs/nfsd/nfs4state.c
@@ -469,6 +469,8 @@ find_any_file(struct nfs4_file *f)
 {
 	struct file *ret;
...
+		return NULL;
 	...
 	if (!ret) {
@@ -1205,6 +1207,12 @@ static void nfs4_put_stateowner(struct nfs4_stateowner *sop)
...
@@ -1272,9 +1280,11 @@ static bool unhash_lock_stateid(struct nfs4_ol_stateid *stp)
 {
...
@@ -1339,13 +1349,12 @@ static void release_open_stateid_locks(struct nfs4_ol_stateid *open_stp,
...
@@ -5772,21 +5781,21 @@ alloc_init_lock_stateowner(unsigned int strhashval, struct nfs4_client *clp,
 }
...
@@ -5802,11 +5811,11 @@ init_lock_stateid(struct nfs4_ol_stateid *stp, struct nfs4_lockowner *lo,
...
@@ -5815,22 +5824,26 @@ init_lock_stateid(struct nfs4_ol_stateid *stp, struct nfs4_lockowner *lo,
...
+	return NULL;
 ...
 static struct nfs4_ol_stateid *
@@ -5845,7 +5858,7 @@ find_or_create_lock_stateid(struct nfs4_lockowner *lo, struct nfs4_file *fi,
