...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1DA4D73095E
	for <lists+linux-nfs@lfdr.de>; Wed, 14 Jun 2023 22:43:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232934AbjFNUnu (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Wed, 14 Jun 2023 16:43:50 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60194 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231835AbjFNUns (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Wed, 14 Jun 2023 16:43:48 -0400
Received: from mail-lj1-x22e.google.com (mail-lj1-x22e.google.com [IPv6:2a00:1450:4864:20::22e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 83BA4268B
        for <linux-nfs@vger.kernel.org>; Wed, 14 Jun 2023 13:43:29 -0700 (PDT)
Received: by mail-lj1-x22e.google.com with SMTP id 38308e7fff4ca-2b1b1dd208dso14746521fa.0
        for <linux-nfs@vger.kernel.org>; Wed, 14 Jun 2023 13:43:29 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=umich.edu; s=google-2016-06-03; t=1686775408; x=1689367408;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=AwMiwIqZU1xkZZUPlK4BPQR3kPI2vXPpyCaBxwXG00c=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1686775408; x=1689367408;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=AwMiwIqZU1xkZZUPlK4BPQR3kPI2vXPpyCaBxwXG00c=;
        b=
X-Gm-Message-State: AC+VfDwFH9SHI7ADtrGdWZhfz/zS9OPczqD3TBaZ+LDt4+OGkECxs1KQ
        EGcvGqKqBAhMEg0EMjVEM6sAvGeNpwCVte71W54i095zOjNG+g==
X-Google-Smtp-Source: ACHHUZ6hP3kV6g1RoyaaGwsqchrAqyflgUVXWz29TkNri32bsZPZ4lDceUZhJ+GPu4rHSAEStK75Oe7YXkkPz5EWPHw=
X-Received: by 2002:a2e:a271:0:b0:2b1:b778:152f with SMTP id
 k17-20020a2ea271000000b002b1b778152fmr7647995ljm.3.1686775407231; Wed, 14 Jun
 2023 13:43:27 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <CAM5tNy6LEEWbwE8Ema5kEMCJ3oB=ta7HndbUCKXuF5QJkjSTWw@mail.gmail.com>
From:   Olga Kornievskaia <aglo@umich.edu>
Date:   Wed, 14 Jun 2023 16:43:15 -0400
Message-ID: <CAN-5tyGMfARBVM2ZPju5tJA9yM-DLNvcp-OqAEVEApXOQ4df5A@mail.gmail.com>
...
On Wed, Jun 14, 2023 at 4:24=E2=80=AFPM Rick Macklem <rick.macklem@gmail.co=
m> wrote:
>
> On Wed, Jun 14, 2023 at 12:58=E2=80=AFPM Olga Kornievskaia <aglo@umich.ed=
u> wrote:
> >
> >
> > Hi Trond,
...
> > error=3D-10052 (BADSESSION) session=3D0x90caa481 slot_nr=3D4 seq_nr=3D4=
259
...
> > error=3D-10052 (BADSESSION) session=3D0x90caa481 slot_nr=3D0 seq_nr=3D7=
673
> > highest_slotid=3D0 target_highest_slotid=3D0 status_flags=3D0x0 ()
...
> > error=3D0 (OK) cmd=3DSETLK:WRLCK range=3D146432:159743 fileid=3D00:3b:1=
29
...
> > error=3D-10052 (BADSESSION) session=3D0x90caa481 slot_nr=3D1 seq_nr=3D7=
805
> > highest_slotid=3D0 target_highest_slotid=3D0 status_flags=3D0x0 ()
...
> > error=3D0 (OK) cmd=3DSETLK:WRLCK range=3D2462720:2469375 fileid=3D00:3b=
:138
...
> > NFS OP uses slot=3D0 seq=3D0 sends it to server 1. Server 1 processes t=
he
...
> > (session is not frozen on the client yet) new NFS OP uses slot=3D0 seq=
=3D0
> > and sends it to server 1. Server 1 responds out of the session cache.
> To me, this sounds like a broken NFSv4.1/4.2 server. Once a session is ba=
d,
> I do not think there should ever be a reply that was cached in that bad s=
ession.
> Put another way, the server should not leave the "trunking group' (whatev=
er that
