...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 15D6B3BAA8D
	for <lists+linux-nfs@lfdr.de>; Sun,  4 Jul 2021 01:03:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229596AbhGCXGK (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Sat, 3 Jul 2021 19:06:10 -0400
Received: from smtp-out2.suse.de ([195.135.220.29]:50146 "EHLO
        smtp-out2.suse.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229520AbhGCXGJ (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Sat, 3 Jul 2021 19:06:09 -0400
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by smtp-out2.suse.de (Postfix) with ESMTPS id 9889E2030D;
        Sat,  3 Jul 2021 23:03:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
        t=1625353414; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=35UDAv53S7DghqMdlz8Dbsch7Y37NzNEidGgQo1ENJ8=;
        b=CE+1686E934LvldD4xmSN/vqldXJztC/ws62FdltzYQRhxUDcSW0IMVNtQB4WZYAmPlCw7
        Yw7jAg4/04EMqrAVQHm/+vr5USS6XZebQ+WYYwPXGkbEAutSZNISxukjcbtzS25bzPb8yK
        PFtFw/Pn/NtNFVtTDQXvFkyVmIyUMhI=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
        s=susede2_ed25519; t=1625353414;
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=35UDAv53S7DghqMdlz8Dbsch7Y37NzNEidGgQo1ENJ8=;
        b=MP3P4dnAntYSUbfFvvAt+iAY/Zp851u4On/6lYpX3Iq8EkKLtGPS1FmiwJMeq0SW3ZUUJ9
        DrxiPO8Cwj/EnYAQ==
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by imap2.suse-dmz.suse.de (Postfix) with ESMTPS id AAAC013485;
        Sat,  3 Jul 2021 23:03:32 +0000 (UTC)
Received: from dovecot-director2.suse.de ([192.168.254.65])
        by imap2.suse-dmz.suse.de with ESMTPSA
        id xLeEFsTs4GAKOwAAMHmgww
        (envelope-from <neilb@suse.de>); Sat, 03 Jul 2021 23:03:32 +0000
...
In-reply-to: <CAPt2mGNCV7Sh0uXA0ihpuSVcecXW=5cMUAfiS0tYr_cTQ0Du8w@mail.gmail.com>
...
Date:   Sun, 04 Jul 2021 09:03:29 +1000
Message-id: <162535340922.16506.4184249866230493262@noble.neil.brown.name>
Precedence: bulk
...
> unmounting.
>=20
> # mount -o vers=3D4.2 server1:/usr /mnt/server1
> # umount /mnt/server1
>=20
...
@@ -288,7 +298,7 @@ static struct nfs_client *nfs_match_client(const struct n=
...
+		const struct sockaddr *clap =3D (struct sockaddr *)&clp->cl_addr;
 		...
 		if (clp->cl_cons_state < 0)
 			continue;
@@ -320,11 +330,17 @@ static struct nfs_client *nfs_match_client(const struct=
