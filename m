Return-Path: <linux-nfs+bounces-22377-lists+linux-nfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-nfs@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id x4z1MIn/JmqgpQIAu9opvQ
	(envelope-from <linux-nfs+bounces-22377-lists+linux-nfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-nfs@lfdr.de>; Mon, 08 Jun 2026 19:44:41 +0200
X-Original-To: lists+linux-nfs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E96B6595B9
	for <lists+linux-nfs@lfdr.de>; Mon, 08 Jun 2026 19:44:41 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=kernel.org header.s=k20260515 header.b="jM8L3Z/1";
	spf=pass (mail.lfdr.de: domain of "linux-nfs+bounces-22377-lists+linux-nfs=lfdr.de@vger.kernel.org" designates 172.234.253.10 as permitted sender) smtp.mailfrom="linux-nfs+bounces-22377-lists+linux-nfs=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=quarantine) header.from=kernel.org;
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 09FD7332D349
	for <lists+linux-nfs@lfdr.de>; Mon,  8 Jun 2026 16:38:11 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 16EC133F8D6;
	Mon,  8 Jun 2026 16:38:04 +0000 (UTC)
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-alma10-1.taild15c8.ts.net [100.103.45.18])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B50C73CC7F1;
	Mon,  8 Jun 2026 16:38:02 +0000 (UTC)
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1780936684; cv=none; b=F+hL2yYIKroid0C0ekitP7wLtVmAtfUUbZOWNJMumIWJ6R6ElidKDflDXZodiZIUOeksklXmfq+dU+iLKoFLfEkeSP/9gd60oBkkOhXkjPOGcpisII1oAQZMZ/8OOGtKF9oHOlILOxonkNoLlll+e081uTQrMpmpTjAkDrX60EE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1780936684; c=relaxed/simple;
	bh=5DdLkMzRrEAvhwAc0qIEJQIrYipvLT7MDtA/eZEnF0U=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=ALvAhKza5z8qmnOF8cfgVyaoVqQIxzCeXh3Kpik7bUsGja0elRb7nWzgqVY478fwIMF8enQr3mSKkPmhuHqx+zCV0wDCZln2T/lOlo3G7zkkFVfo/UbTdqPFFFwBYo7jMNp6Zdrx555RlFJpRtAiTit3U3alCeHs5iAPFpxxPOo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=jM8L3Z/1; arc=none smtp.client-ip=100.103.45.18
Received: by smtp.kernel.org (Postfix) with ESMTPSA id F3AAC1F00893;
	Mon,  8 Jun 2026 16:38:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=kernel.org;
	s=k20260515; t=1780936682;
	bh=DApU5TlrL6usYvvj36d0vAgMIrDrbdr3UKG4H5QMHbc=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References;
	b=
Message-ID: <906ff2a1fa578558954b82941ce0809c4257e443.camel@kernel.org>
Subject: Re: [PATCH v4 03/21] nfs_common: add new NOTIFY4_* flags proposed
 in RFC8881bis
...
Cc: Alexander Aring <alex.aring@gmail.com>, Amir Goldstein
 <amir73il@gmail.com>,  Jan Kara <jack@suse.cz>, Alexander Viro
...
Date: Mon, 08 Jun 2026 12:37:59 -0400
...
References: <20260522-dir-deleg-v4-0-2acb883ac6bc@kernel.org>
	 ...
	 <bf852bf8-2d80-4b12-8d7c-bb0770c8b379@app.fastmail.com>
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-22377-lists,linux-nfs=lfdr.de];
	FROM_HAS_DN(0.00)[];
...
>=20
> > diff --git a/Documentation/sunrpc/xdr/nfs4_1.x=20
...
> >          NOTIFY4_REMOVE_ENTRY =3D 2,
> >          NOTIFY4_ADD_ENTRY =3D 3,
> >          NOTIFY4_RENAME_ENTRY =3D 4,
> > -        NOTIFY4_CHANGE_COOKIE_VERIFIER =3D 5
> > +        NOTIFY4_CHANGE_COOKIE_VERIFIER =3D 5,
> > +        /*
