Return-Path: <linux-nfs+bounces-10164-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id E415EA39FD6
	for <lists+linux-nfs@lfdr.de>; Tue, 18 Feb 2025 15:31:54 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 9D8891898F16
	for <lists+linux-nfs@lfdr.de>; Tue, 18 Feb 2025 14:30:11 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 09A8226A1A4;
	Tue, 18 Feb 2025 14:29:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="uy8PYNgy"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D2F4026A0BE;
	Tue, 18 Feb 2025 14:29:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1739888944; cv=none; b=dZqzDSIpVsK1kpCRg7JnlPbjsNjbEE7YUGp0tnjyREesqnPVMQuRVuhPesU+wXSLAOSXCUpZ9vP9hoR/dYMqsKfehTGW/i0fT9YxUSWAd61vg74nsUUGvQ5iy/fpofEmpkoIfYSSmvggebslSdbxHGmFN7/eEQ4r8zJLejBSNx4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1739888944; c=relaxed/simple;
	bh=kOzfz3ajDJQrOYL+B+PUnFzeDTEPCzHsMEVPG0PhoZk=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=t/RAXcawp+5dB67NgIOfwB0qf9rqlGfrVuxxl0gkvCePcDD/Xi56/hC+ClCxDi8j1R4JLumY8HFO9C4fmopCNU4A9Kinrl4Ur39SzIzmnyfMWgMFyDcN5jJVdCnPm/0ebf1aec2WXzX+rMh4dgx+WFV+ZAjKzJXwW1oX6rOPijk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=uy8PYNgy; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 3275AC4CEEC;
	Tue, 18 Feb 2025 14:29:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1739888944;
	bh=kOzfz3ajDJQrOYL+B+PUnFzeDTEPCzHsMEVPG0PhoZk=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <04ed0c70b85a1e8b66c25b9ad4d0aa4c2fb91198.camel@kernel.org>
...
Date: Tue, 18 Feb 2025 09:29:02 -0500
...
> > 3) The count is decreased in the release callback of rpc_task =E2=80=94=
 either
> > directly calling nfsd41_cb_inflight_end in nfsd4_cb_probe_release, or
> > calling nfsd41_destroy_cb in 	.
> >=20
> > However, in nfsd4_cb_release, if the current cb_work needs to restart, =
the
> > count will not be decreased, with the expectation that it will be reduc=
ed
...
> > @@ -1459,12 +1459,16 @@ static void nfsd4_cb_done(struct rpc_task *task=
, void *calldata)
