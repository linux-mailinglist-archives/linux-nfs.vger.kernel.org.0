Return-Path: <linux-nfs+bounces-4774-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A14992D2FB
	for <lists+linux-nfs@lfdr.de>; Wed, 10 Jul 2024 15:40:25 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 1BF7A1F24334
	for <lists+linux-nfs@lfdr.de>; Wed, 10 Jul 2024 13:40:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 17F771DDC5;
	Wed, 10 Jul 2024 13:40:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="gqjdXKGH"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E71CB193088
	for <linux-nfs@vger.kernel.org>; Wed, 10 Jul 2024 13:40:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1720618804; cv=none; b=OQK/hA6OabNHbKg3e/HTxWT54pHzvZOQDUwTXUDAA8DhGJRGpi2x0phQCKIBX/pW1FwKKig/3w7jFCI9uFYL0HtJYca2XXpVZ1ua6/4xaMAmesbTr3g3cAx6XmC9iM/roj0eew6aKuvOVqk7C8BZZTJTaOk6PTyqLz5wCrAvn+4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1720618804; c=relaxed/simple;
	bh=SJ+rMroBkb1OkzALP/KnSOLWH1IdFeZ6vHI8qFfAVOc=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=ZhbKU1O/vED742cp27KeWwQGJ1mUH5jrJn+iyLtlC+j+pYdn7ywmLRRPI8iE0plnUFzg4QcOu9SfdpTgA2uEDrbWVv0FC0RrL9jEPm7ZcLzrv6gnSkJf3C+uY2wqgBOq1FwidsXjFIqOC6NBOygukljOpKA78qm6y1abKee1sSk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=gqjdXKGH; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id EC1B4C32781;
	Wed, 10 Jul 2024 13:40:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1720618803;
	bh=SJ+rMroBkb1OkzALP/KnSOLWH1IdFeZ6vHI8qFfAVOc=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <ed0dcff753054e8fe651ce6ecc89d9c8bfc2d38e.camel@kernel.org>
Subject: Re: Leaked nfsd_file due to race condition and early unhash
 (fs/nfsd/filecache.c)
From: Jeff Layton <jlayton@kernel.org>
To: Youzhong Yang <youzhong@gmail.com>
Cc: Chuck Lever <chuck.lever@oracle.com>, linux-nfs@vger.kernel.org
Date: Wed, 10 Jul 2024 09:40:01 -0400
In-Reply-To: <CADpNCvZ0wpPqenm-Qydnpki7HgjUMNB+UgcFa9ZrTY4bK+wEFw@mail.gmail.com>
References: 
...
send-email or have a look over this page:
    ...
    https://www.kernel.org/doc/html/latest/process/email-clients.html#email=
-clients
...
>=20
> =C2=A0=C2=A0=C2=A0 nfsd: fix nfsd_file leaking due to mixed use of nf->nf=
_lru
>=20
> =C2=A0=C2=A0=C2=A0 nfsd_file_put() in one thread can race with another th=
read doing
> =C2=A0=C2=A0=C2=A0 garbage collection (running nfsd_file_gc() -> list_lru=
_walk() ->
> =C2=A0=C2=A0=C2=A0 nfsd_file_lru_cb()):
>=20
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * In nfsd_file_put(), nf->nf_ref is 1, so =
it tries to do
> nfsd_file_lru_add().
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * nfsd_file_lru_add() returns true (with N=
FSD_FILE_REFERENCED
> bit set)
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * garbage collector kicks in, nfsd_file_lr=
u_cb() clears
> REFERENCED bit and
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 returns LRU_ROTATE.
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * garbage collector kicks in again, nfsd_f=
ile_lru_cb() now
> decrements nf->nf_ref
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 to 0, runs nfsd_file_unhash(),=
 removes it from the LRU and
> adds to the dispose
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 list [list_lru_isolate_move(lr=
u, &nf->nf_lru, head)]
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * nfsd_file_put() detects NFSD_FILE_HASHED=
 bit is cleared, so
> it
> tries to remove
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 the 'nf' from the LRU [if (!nf=
sd_file_lru_remove(nf))]. The
> 'nf' has been added
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 to the 'dispose' list by nfsd_=
file_lru_cb(), so
> nfsd_file_lru_remove(nf) simply
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 treats it as part of the LRU a=
nd removes it, which leads to
> its removal from
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 the 'dispose' list.
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * At this moment, 'nf' is unhashed with it=
s nf_ref being 0, and
> not on the LRU.
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 nfsd_file_put() continues its =
execution [if
> (refcount_dec_and_test(&nf->nf_ref))],
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 as nf->nf_ref is already 0, nf=
->nf_ref is set to
> REFCOUNT_SATURATED, and the 'nf'
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 gets no chance of being freed.
>=20
> =C2=A0=C2=A0=C2=A0 nfsd_file_put() can also race with nfsd_file_cond_queu=
e():
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * In nfsd_file_put(), nf->nf_ref is 1, so =
it tries to do
> nfsd_file_lru_add().
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * nfsd_file_lru_add() sets REFERENCED bit =
and returns true.
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * Some userland application runs 'exportfs=
 -f' or something
> like
> that, which triggers
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 __nfsd_file_cache_purge() -> n=
fsd_file_cond_queue().
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * In nfsd_file_cond_queue(), it runs [if
> (!nfsd_file_unhash(nf))], unhash is done
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 successfully.
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * nfsd_file_cond_queue() runs [if (!nfsd_f=
ile_get(nf))], now
> nf->nf_ref goes to 2.
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * nfsd_file_cond_queue() runs [if (nfsd_fi=
le_lru_remove(nf))],
> it succeeds.
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * nfsd_file_cond_queue() runs [if
> (refcount_sub_and_test(decrement, &nf->nf_ref))]
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 (with "decrement" being 2), so=
 the nf->nf_ref goes to 0, the
> 'nf' is added to the
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 dispose list [list_add(&nf->nf=
_lru, dispose)]
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * nfsd_file_put() detects NFSD_FILE_HASHED=
 bit is cleared, so
> it
> tries to remove
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 the 'nf' from the LRU [if (!nf=
sd_file_lru_remove(nf))],
> although the 'nf' is not
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 in the LRU, but it is linked i=
n the 'dispose' list,
> nfsd_file_lru_remove() simply
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 treats it as part of the LRU a=
nd removes it. This leads to
> its
> removal from
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 the 'dispose' list!
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 * Now nf->ref is 0, unhashed. nfsd_file_pu=
t() continues its
> execution and set
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 nf->nf_ref to REFCOUNT_SATURAT=
ED.
>=20
> =C2=A0=C2=A0=C2=A0 As shown in the above analysis, using nf_lru for both =
the LRU
> list
> and dispose list
> =C2=A0=C2=A0=C2=A0 can cause the leaks. This patch adds a new list_head n=
f_gc in
> struct nfsd_file, and uses
> =C2=A0=C2=A0=C2=A0 it for the dispose list.
>=20
> =C2=A0=C2=A0=C2=A0 Signed-off-by: Youzhong Yang <youzhong@gmail.com>
>=20
...
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 nf->nf_birthtime =3D ktime_get=
();
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 nf->nf_file =3D NULL;
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 nf->nf_cred =3D get_current_cr=
ed();
...
> -=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 nf =3D list_first_entry(dispose, struct nfsd_file,
> nf_lru);
> -=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 list_del_init(&nf->nf_lru);
> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 nf =3D list_first_entry(dispose, struct nfsd_file,
> nf_gc);
> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 list_del_init(&nf->nf_gc);
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
...
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 while(!list_empty(dispose)) {
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0 struct nfsd_file *nf =3D list_first_entry(dispose,
> -=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 struct nfsd_file,
> nf_lru);
> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
...
> nf_gc);
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0 struct nfsd_net *nn =3D net_generic(nf->nf_net,
> nfsd_net_id);
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0 struct nfsd_fcache_disposal *l =3D nn->fcache_disposal;
>=20
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0 spin_lock(&l->lock);
> -=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 list_move_tail(&nf->nf_lru, &l->freeme);
> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 list_move_tail(&nf->nf_gc, &l->freeme);
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0 spin_unlock(&l->lock);
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0 svc_wake_up(nn->nfsd_serv);
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 }
> @@ -503,7 +504,8 @@ nfsd_file_lru_cb(struct list_head *item, struct
> list_lru_one *lru,
>=20
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 /* Refcount went to zero. Unha=
sh it and queue it to the
> dispose list */
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 nfsd_file_unhash(nf);
> -=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 list_lru_isolate_move(lru, &nf->nf_=
lru, head);
> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 list_lru_isolate(lru, &nf->nf_lru);
> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 list_add(&nf->nf_gc, head);
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 this_cpu_inc(nfsd_file_evictio=
ns);
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 trace_nfsd_file_gc_disposed(nf=
);
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 return LRU_REMOVED;
> @@ -578,7 +580,7 @@ nfsd_file_cond_queue(struct nfsd_file *nf, struct
> list_head *dispose)
>=20
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 /* If refcount goes to 0, then=
 put on the dispose list */
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 if (refcount_sub_and_test(decr=
ement, &nf->nf_ref)) {
> -=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 list_add(&nf->nf_lru, dispose);
> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0 list_add(&nf->nf_gc, dispose);
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0 trace_nfsd_file_closing(nf);
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 }
> =C2=A0}
> @@ -654,8 +656,8 @@ nfsd_file_close_inode_sync(struct inode *inode)
>=20
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 nfsd_file_queue_for_close(inod=
e, &dispose);
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 while (!list_empty(&dispose)) =
{
> -=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
...
>=20
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 struct nfsd_file_mark=C2=A0=C2=
=A0 *nf_mark;
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 struct list_head=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 nf_lru;
> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 struct list_head=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0 nf_gc;
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 struct rcu_head=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 nf_rcu;
> =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 ktime_t=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
 nf_birthtime;
> =C2=A0};
>=20
...
> > > Thanks.
> > >=20
> > > On Tue, Jul 9, 2024 at 3:05=E2=80=AFPM Jeff Layton <jlayton@kernel.or=
g>
> > > wrote:
> > > >=20
...
> > > > > >=20
> > > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 if (refcount_dec_and=
_test(&nf->nf_ref))
> > > > > > =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0 nfsd_file_free(nf);
> > > > > >=20
...
> > > > > > > > > nfsd_file_lru_cb()):
> > > > > > > > >=20
> > > > > > > > > =C2=A0 * In nfsd_file_put(), nf->nf_ref is 1, so it tries
> > > > > > > > > to do
> > > > > > > > > nfsd_file_lru_add().
> > > > > > > > > =C2=A0 * nfsd_file_lru_add() returns true (with
> > > > > > > > > NFSD_FILE_REFERENCED
> > > > > > > > > bit set)
> > > > > > > > > =C2=A0 * garbage collector kicks in, nfsd_file_lru_cb()
> > > > > > > > > clears
> > > > > > > > > REFERENCED bit and
...
> > > > > > > > > decrements nf->nf_ref
> > > > > > > > > =C2=A0=C2=A0=C2=A0 to 0, runs nfsd_file_unhash(), removes=
 it from
> > > > > > > > > the LRU
> > > > > > > > > and
> > > > > > > > > adds to
> > > > > > > > > the dispose
> > > > > > > > > =C2=A0=C2=A0=C2=A0 list [list_lru_isolate_move(lru, &nf->=
nf_lru,
> > > > > > > > > head)]
