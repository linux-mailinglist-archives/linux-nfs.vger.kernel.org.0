...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8A68F382221
	for <lists+linux-nfs@lfdr.de>; Mon, 17 May 2021 01:59:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234659AbhEQABB convert rfc822-to-8bit (ORCPT
        <rfc822;lists+linux-nfs@lfdr.de>); Sun, 16 May 2021 20:01:01 -0400
Received: from mx2.suse.de ([195.135.220.15]:45272 "EHLO mx2.suse.de"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S234603AbhEQAA7 (ORCPT <rfc822;linux-nfs@vger.kernel.org>);
        Sun, 16 May 2021 20:00:59 -0400
X-Virus-Scanned: by amavisd-new at test-mx.suse.de
Received: from relay2.suse.de (unknown [195.135.221.27])
        by mx2.suse.de (Postfix) with ESMTP id 25518B153;
        Sun, 16 May 2021 23:59:43 +0000 (UTC)
...
Subject: [PATCH] SUNRPC in case of backlog, hand free slots directly to waiting task
Date:   Mon, 17 May 2021 09:59:10 +1000
Message-id: <162120955003.6103.15898898016096767274@noble.neil.brown.name>
Precedence: bulk
...
index 612f0a641f4c..bcc273d08805 100644
--- a/net/sunrpc/clnt.c
+++ b/net/sunrpc/clnt.c
...
index 691ccf8049a4..4755cc5ee24a 100644
--- a/net/sunrpc/xprt.c
+++ b/net/sunrpc/xprt.c
@@ -70,6 +70,7 @@
...
@@ -1607,10 +1608,26 @@ static void xprt_add_backlog(struct rpc_xprt *xprt, struct rpc_task *task)
...
@@ -1698,11 +1715,11 @@ EXPORT_SYMBOL_GPL(xprt_alloc_slot);
...
@@ -1790,6 +1807,10 @@ xprt_request_init(struct rpc_task *task)
...
+
 	...
 	req->rq_xprt    = xprt;
 	req->rq_buffer  = NULL;
@@ -1850,8 +1871,10 @@ void xprt_retry_reserve(struct rpc_task *task)
 	struct rpc_xprt *xprt = task->tk_xprt;
...
@@ -1876,24 +1899,27 @@ void xprt_release(struct rpc_task *task)
 	}
