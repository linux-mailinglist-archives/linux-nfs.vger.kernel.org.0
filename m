21 +0000 (UTC)
Received: from dovecot-director2.suse.de ([2a07:de40:b281:106:10:150:64:167])
	by imap1.dmz-prg2.suse.org with ESMTPSA
	id 3EX8KQ3Trmc6bwAAD6G6ig
	(envelope-from <neilb@suse.de>); Fri, 14 Feb 2025 05:22:21 +0000
...
Subject: [PATCH 1/3] Change inode_operations.mkdir to return struct dentry *
Date: Fri, 14 Feb 2025 16:16:41 +1100
Message-ID: <20250214052204.3105610-2-neilb@suse.de>
...
Some filesystems, such as NFS, do not have complete control of
sequencing on the actual filesystem (e.g.  on a different server) and
may find that the inode created for a mkdir request already exists in
the icache and dcache by the time the mkdir request returns.  For
example, if the filesystem is mounted twice the file could be visible on
the other mount before it is on the original mount, and a pair of
name_to_handle_at(), open_by_handle_at() could instantiate the directory
inode with an IS_ROOT() dentry before the first mkdir returns.
...
resulting dentry.  With this patch the returned dentry is *always* the
one passed in - or an ERR_PTR().  A future patch will change NFS - the
only filesystem which handles this - to return that actual dentry used.
...
---
 ...
 57 files changed, 375 insertions(+), 225 deletions(-)
...
index 1639e78e3146..3ef268591b66 100644
...
index 31eea688609a..0c10723f6513 100644
...
index 3e68521f4e2f..ef1bf2525611 100644
--- a/fs/9p/vfs_inode.c
+++ b/fs/9p/vfs_inode.c
...
+				     struct dentry *dentry, umode_t mode)
 {
 	int err;
 	u32 perm;
@@ -692,8 +692,10 @@ static int v9fs_vfs_mkdir(struct mnt_idmap *idmap, struct inode *dir,
...
index 143ac03b7425..1f129aa697cc 100644
...
@@ -417,7 +417,10 @@ static int v9fs_vfs_mkdir_dotl(struct mnt_idmap *idmap,
 	p9_fid_put(fid);
...
index 8c154490a2d6..d924572f0dbc 100644
--- a/fs/affs/namei.c
+++ b/fs/affs/namei.c
...
index 02cbf38e1a77..15c3cf09fa7e 100644
--- a/fs/afs/dir.c
+++ b/fs/afs/dir.c
...
@@ -1344,7 +1344,10 @@ static int afs_mkdir(struct mnt_idmap *idmap, struct inode *dir,
...
index 530d18827e35..2b6a53f7aa82 100644
--- a/fs/autofs/root.c
+++ b/fs/autofs/root.c
...
index 90ade8f648d9..1c7ea982a499 100644
--- a/fs/bcachefs/fs.c
+++ b/fs/bcachefs/fs.c
@@ -858,10 +858,16 @@ static int bch2_symlink(struct mnt_idmap *idmap,
...
+	int err = bch2_mknod(idmap, vdir, dentry, mode|S_IFDIR, 0);
+
+	if (err)
+		return ERR_PTR(err);
+	else
...
index a9322601ab5c..ceaac826355a 100644
--- a/fs/btrfs/inode.c
+++ b/fs/btrfs/inode.c
@@ -6739,18 +6739,24 @@ static int btrfs_link(struct dentry *old_dentry, struct inode *dir,
 	return err;
 }
...
+	err = btrfs_create_common(dir, dentry, inode);
+	if (err)
+		return ERR_PTR(err);
+	else
+		return dentry;
...
index 62e99e65250d..efca19a381de 100644
--- a/fs/ceph/dir.c
+++ b/fs/ceph/dir.c
...
@@ -1173,7 +1173,10 @@ static int ceph_mkdir(struct mnt_idmap *idmap, struct inode *dir,
 	else
 		d_drop(dentry);
...
index a3e2dfeedfbf..1f95f42e789c 100644
--- a/fs/coda/dir.c
+++ b/fs/coda/dir.c
...
index 7d10278db30d..bae8304d9246 100644
--- a/fs/configfs/dir.c
+++ b/fs/configfs/dir.c
...
+				     struct dentry *dentry, umode_t mode)
 {
 	int ret = 0;
 	int module_got = 0;
@@ -1461,7 +1461,10 @@ static int configfs_mkdir(struct mnt_idmap *idmap, struct inode *dir,
 	put_fragment(frag);
...
index a9819ddb1ab8..7445c32c1e95 100644
...
@@ -526,7 +526,10 @@ static int ecryptfs_mkdir(struct mnt_idmap *idmap, struct inode *dir,
...
index 691dd77b6ab5..ec880735846f 100644
--- a/fs/exfat/namei.c
+++ b/fs/exfat/namei.c
...
@@ -877,7 +877,10 @@ static int exfat_mkdir(struct mnt_idmap *idmap, struct inode *dir,
...
index 8346ab9534c1..4c7295746f2b 100644
--- a/fs/ext2/namei.c
+++ b/fs/ext2/namei.c
...
@@ -258,7 +259,10 @@ static int ext2_mkdir(struct mnt_idmap * idmap,
...
index 536d56d15072..6da7935cfd4a 100644
--- a/fs/ext4/namei.c
+++ b/fs/ext4/namei.c
...
@@ -3066,7 +3066,10 @@ static int ext4_mkdir(struct mnt_idmap *idmap, struct inode *dir,
 out_retry:
...
index a278c7da8177..5c0409c5385b 100644
--- a/fs/f2fs/namei.c
+++ b/fs/f2fs/namei.c
...
index f06f6ba643cc..2ae5b5a69d68 100644
...
index 926c26e90ef8..8a32cb9ced12 100644
...
index 198862b086ff..cf6ac3e37c82 100644
--- a/fs/fuse/dir.c
+++ b/fs/fuse/dir.c
...
index 6fbbaaad1cd0..e48a9eece720 100644
--- a/fs/gfs2/inode.c
+++ b/fs/gfs2/inode.c
@@ -1248,14 +1248,20 @@ static int gfs2_symlink(struct mnt_idmap *idmap, struct inode *dir,
...
+	int err;
+
+	err = gfs2_create_inode(dir, dentry, NULL, S_IFDIR | mode, 0, NULL, dsize, 0);
+	if (err)
+		return ERR_PTR(err);
+	else
+		return dentry;
...
index b75c26045df4..3d835e7cbfe0 100644
--- a/fs/hfs/dir.c
+++ b/fs/hfs/dir.c
...
index f5c4b3e31a1c..96836afbb4f5 100644
--- a/fs/hfsplus/dir.c
+++ b/fs/hfsplus/dir.c
...
index e0741e468956..6caccd4f673f 100644
...
index d0edf9ed33b6..9234e405df64 100644
--- a/fs/hpfs/namei.c
+++ b/fs/hpfs/namei.c
...
index 0fc179a59830..b6066bcb0f64 100644
--- a/fs/hugetlbfs/inode.c
+++ b/fs/hugetlbfs/inode.c
@@ -991,14 +991,17 @@ static int hugetlbfs_mknod(struct mnt_idmap *idmap, struct inode *dir,
 	return 0;
 }
...
index 2b2938970da3..0d3cf10e7237 100644
--- a/fs/jffs2/dir.c
+++ b/fs/jffs2/dir.c
...
index fc8ede43afde..922a23c6179f 100644
--- a/fs/jfs/namei.c
+++ b/fs/jfs/namei.c
...
+ * RETURN:	The dentry or ERR_PTR() of errors from subroutines
  *
  * note:
...
@@ -308,7 +308,10 @@ static int jfs_mkdir(struct mnt_idmap *idmap, struct inode *dip,
       out1:
...
index 5f0f8b95f44c..1b112c84ff03 100644
--- a/fs/kernfs/dir.c
+++ b/fs/kernfs/dir.c
@@ -1230,24 +1230,27 @@ static struct dentry *kernfs_iop_lookup(struct inode *dir,
...
index 5d9c1406fe27..0fc29a3ed049 100644
--- a/fs/minix/namei.c
+++ b/fs/minix/namei.c
...
@@ -128,7 +128,10 @@ static int minix_mkdir(struct mnt_idmap *idmap, struct inode *dir,
...
index 6659e3be52ce..6094d93ed7d3 100644
--- a/fs/namei.c
+++ b/fs/namei.c
@@ -4291,6 +4291,7 @@ int vfs_mkdir(struct mnt_idmap *idmap, struct inode *dir,
 {
 	int error;
...
+	struct dentry *de;
 	...
 	if (error)
@@ -4307,9 +4308,14 @@ int vfs_mkdir(struct mnt_idmap *idmap, struct inode *dir,
...
index 56cf16a72334..1bf728367426 100644
--- a/fs/nfs/dir.c
+++ b/fs/nfs/dir.c
...
index 953fbd5f0851..c86df905948b 100644
--- a/fs/nilfs2/namei.c
+++ b/fs/nilfs2/namei.c
...
@@ -258,7 +258,10 @@ static int nilfs_mkdir(struct mnt_idmap *idmap, struct inode *dir,
 	else
...
index abf7e81584a9..dcf33098e278 100644
--- a/fs/ntfs3/namei.c
+++ b/fs/ntfs3/namei.c
...
index 2a7f36643895..370480c258a3 100644
...
index 0ec63a1a94b8..819da0cc780d 100644
--- a/fs/ocfs2/namei.c
+++ b/fs/ocfs2/namei.c
...
@@ -657,7 +657,10 @@ static int ocfs2_mkdir(struct mnt_idmap *idmap,
 	if (ret)
 		mlog_errno(ret);
...
index 6bda275826d6..0e1c53bb948d 100644
--- a/fs/omfs/dir.c
+++ b/fs/omfs/dir.c
@@ -279,10 +279,17 @@ static int omfs_add_node(struct inode *dir, struct dentry *dentry, umode_t mode)
 	return err;
 }
...
index 200558ec72f0..7be2c17a749b 100644
...
@@ -366,7 +366,10 @@ static int orangefs_mkdir(struct mnt_idmap *idmap, struct inode *dir,
...
index c9993ff66fc2..74a0541a8619 100644
...
index 8006faaaf0ec..d285152ca0af 100644
--- a/fs/ramfs/inode.c
+++ b/fs/ramfs/inode.c
@@ -119,13 +119,15 @@ ramfs_mknod(struct mnt_idmap *idmap, struct inode *dir,
 	return error;
 }
...
index 9cc31cf6ebd0..5c7d7563fd7a 100644
...
+		return ERR_CAST(tlink);
 	...
 	xid = get_xid();
@@ -2270,7 +2270,10 @@ int cifs_mkdir(struct mnt_idmap *idmap, struct inode *inode,
...
index fb8bd8437872..8132f6835e7b 100644
--- a/fs/sysv/namei.c
+++ b/fs/sysv/namei.c
...
+				 struct dentry *dentry, umode_t mode)
 {
 	struct inode * inode;
 	int err;
@@ -137,7 +137,10 @@ static int sysv_mkdir(struct mnt_idmap *idmap, struct inode *dir,
...
index 53214499e384..5e946db59611 100644
...
@@ -141,7 +141,10 @@ static int tracefs_syscall_mkdir(struct mnt_idmap *idmap,
...
index fda82f3e16e8..b960cb0dec1a 100644
--- a/fs/ubifs/dir.c
+++ b/fs/ubifs/dir.c
...
index 2cb49b6b0716..4916a6bba5fe 100644
--- a/fs/udf/namei.c
+++ b/fs/udf/namei.c
...
index 38a024c8cccd..f64a40e00528 100644
--- a/fs/ufs/namei.c
+++ b/fs/ufs/namei.c
...
index a859ac9b74ba..57bc2557182c 100644
--- a/fs/vboxsf/dir.c
+++ b/fs/vboxsf/dir.c
...
index 40289fe6f5b2..b93283f0a7af 100644
--- a/fs/xfs/xfs_iops.c
+++ b/fs/xfs/xfs_iops.c
@@ -298,14 +298,21 @@ xfs_vn_create(
...
+	int err;
+
+	err = xfs_generic_create(idmap, dir, dentry, mode | S_IFDIR, 0, NULL);
+	if (err)
+		return ERR_PTR(err);
+	else
+		return dentry;
...
index be3ad155ec9f..67eb77f75b40 100644
--- a/include/linux/fs.h
+++ b/include/linux/fs.h
@@ -2199,8 +2199,8 @@ struct inode_operations {
 	int (*unlink) (struct inode *,struct dentry *);
...
index 9aaf5124648b..7decda734c68 100644
...
index 4ea6109a8043..18f0450690aa 100644
--- a/mm/shmem.c
+++ b/mm/shmem.c
...
index c07d150685d7..13b8829079a1 100644
...
@@ -1843,7 +1843,10 @@ static int ns_mkdir_op(struct mnt_idmap *idmap, struct inode *dir,
