...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id ABAB0669C64
	for <lists+linux-nfs@lfdr.de>; Fri, 13 Jan 2023 16:32:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230257AbjAMPc6 (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Fri, 13 Jan 2023 10:32:58 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53422 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230200AbjAMPcC (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Fri, 13 Jan 2023 10:32:02 -0500
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F04DD7BCFB
        for <linux-nfs@vger.kernel.org>; Fri, 13 Jan 2023 07:25:42 -0800 (PST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 7E5366212C
        for <linux-nfs@vger.kernel.org>; Fri, 13 Jan 2023 15:25:42 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 9DD6CC433D2;
        Fri, 13 Jan 2023 15:25:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1673623541;
        bh=i4hr3CoKaerZ+7qSXP2PF47E+GyOLN2XoMm8jU7Raeo=;
        h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
        b=
Subject: [PATCH v1 40/41] SUNRPC: Add RFC 8009 encryption KUnit tests
From:   Chuck Lever <cel@kernel.org>
To:     linux-nfs@vger.kernel.org
Cc:     dhowells@redhat.com, simo@redhat.com
Date:   Fri, 13 Jan 2023 10:25:40 -0500
Message-ID: <167362354078.8960.9453466829845461400.stgit@bazille.1015granger.net>
...
index f2b84a07d1a1..e37d341a761b 100644
--- a/net/sunrpc/auth_gss/gss_krb5_crypto.c
+++ b/net/sunrpc/auth_gss/gss_krb5_crypto.c
@@ -881,10 +881,27 @@ gss_krb5_aes_decrypt(struct krb5_ctx *kctx, u32 offset, u32 len,
 	return ret;
 }
...
@@ -931,6 +948,7 @@ krb5_etm_checksum(struct crypto_sync_skcipher *cipher,
...
index 3d4d1208ba19..bcc8992e274a 100644
