...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 95D9F7B6D76
	for <lists+linux-nfs@lfdr.de>; Tue,  3 Oct 2023 17:54:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231669AbjJCPyU (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Tue, 3 Oct 2023 11:54:20 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58624 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231799AbjJCPyT (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Tue, 3 Oct 2023 11:54:19 -0400
Received: from mail-lj1-x233.google.com (mail-lj1-x233.google.com [IPv6:2a00:1450:4864:20::233])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 53E88AD
        for <linux-nfs@vger.kernel.org>; Tue,  3 Oct 2023 08:54:14 -0700 (PDT)
Received: by mail-lj1-x233.google.com with SMTP id 38308e7fff4ca-2c15463e031so2064231fa.1
        for <linux-nfs@vger.kernel.org>; Tue, 03 Oct 2023 08:54:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=umich.edu; s=google-2016-06-03; t=1696348452; x=1696953252; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=a3h8n1luCpmQGggs7a1QLD56aayeVZvUt/vuqE376ic=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1696348452; x=1696953252;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=a3h8n1luCpmQGggs7a1QLD56aayeVZvUt/vuqE376ic=;
        b=
X-Gm-Message-State: AOJu0YzRmLTtb0wlV92Z7oZJyTbQ6Vh7SKCLAXOgPyoZbh9xNFVmDMZT
        UeVPDv2adWkQ5yCeU/yowu/+seXFOVacVJ1wAnnSV1qx
X-Google-Smtp-Source: AGHT+IErJQ+xMy4KeDJEJ5tCFhgzAPt4yrby1MeMcBaEyrkx3FO7Pz8qg5lNHdio8/h28uounXAlIcnQy6si+AluCJA=
X-Received: by 2002:a2e:240c:0:b0:2bf:e5dc:aa68 with SMTP id
 k12-20020a2e240c000000b002bfe5dcaa68mr10173416ljk.3.1696348452192; Tue, 03
 Oct 2023 08:54:12 -0700 (PDT)
MIME-Version: 1.0
References: <20230927192712.317799-1-trondmy@kernel.org> <CAN-5tyF9rKdu0D-7nUFQtq1BWQABb+mdY3sLrDY1-sU_Q2p8fA@mail.gmail.com>
 ...
 <CAN-5tyE3VuSSqmQyUvi9mxhV0-PVfJUK50P9mdJ+x36YFP9wYQ@mail.gmail.com> <688C5594-9744-43D7-ACE3-69A7167E0AE5@oracle.com>
In-Reply-To: <688C5594-9744-43D7-ACE3-69A7167E0AE5@oracle.com>
From:   Olga Kornievskaia <aglo@umich.edu>
Date:   Tue, 3 Oct 2023 11:54:00 -0400
Message-ID: <CAN-5tyEtKf3_k2B=5umH3PzTxSoHrayWuyCqNTthORZ0q1w03Q@mail.gmail.com>
...
On Tue, Oct 3, 2023 at 11:32=E2=80=AFAM Chuck Lever III <chuck.lever@oracle=
.com> wrote:
>
>
>
...
> >>> On Sat, Sep 30, 2023 at 7:06=E2=80=AFPM Trond Myklebust <trondmy@hamm=
erspace.com> wrote:
> >>>>
...
> >>>>>> the
> >>>>>> server's TCP layer to push back and recall that the connection fro=
m
...
a
> >>>>>> potential infinite time out. I've seen this livelock in action, an=
d
> >>>>>> I'm
...
> >>> on how to transition out of TIME_WAIT state. I'm also hearing that th=
e
...
> >>> linux client code. I'm clearly missing something. How are you possibl=
y
> >>> OK with breaking the reply cache?
> >>>
> >>
> >> Is it really breaking things though if you can't connect otherwise? Be=
ar
> >> in mind that if you're dealing with NAT'ed setup, and you wait until t=
he
> >> connection is completely forgotten, then the NAT'ing firewall is likel=
y
...
> >>>>>
> >>>>
> >>>> This is not a 'peculiar server' vs 'normal server' problem. The reus=
e
> >>>> of ports in this way violates the TCP protocol, and has been a probl=
em
> >>>
> >>> I disagree here. Even the RFC quoted by the blogger says that reuse o=
f
> >>> port is allowed.
> >>>
> >>>> for NFS/TCP since the beginning. However, it was never a problem for
> >>>> the older connectionless UDP protocol, which is where the practice o=
f
...
> >>>> recently saw that does not suffice to avoid live lock, after a syste=
m
...
> >>>   77 2023-10-03 10:17:04.328371 192.168.1.106 =E2=86=92 192.168.1.134=
 TCP 66
> >>> 2049 =E2=86=92 909 [ACK] Seq=3D1113 Ack=3D1501 Win=3D31872 Len=3D0 TS=
val=3D3542359002
> >>> TSecr=3D3081600630
...
> >>>  260 2023-10-03 10:18:04.341860 192.168.1.134 =E2=86=92 192.168.1.106=
 TCP 74
> >>> [TCP Port numbers reused] 909 =E2=86=92 2049 [SYN] Seq=3D0 Win=3D3212=
0 Len=3D0
...
> >>>  266 2023-10-03 10:18:07.380801 192.168.1.134 =E2=86=92 192.168.1.106=
 TCP 74
> >>> 954 =E2=86=92 2049 [SYN] Seq=3D0 Win=3D32120 Len=3D0 MSS=3D1460 SACK_=
PERM
...
> >>>  275 2023-10-03 10:18:10.423352 192.168.1.134 =E2=86=92 192.168.1.106=
 TCP 74
> >>> 856 =E2=86=92 2049 [SYN] Seq=3D0 Win=3D32120 Len=3D0 MSS=3D1460 SACK_=
PERM
...
> >>>  286 2023-10-03 10:18:13.466277 192.168.1.134 =E2=86=92 192.168.1.106=
 TCP 74
> >>> 957 =E2=86=92 2049 [SYN] Seq=3D0 Win=3D32120 Len=3D0 MSS=3D1460 SACK_=
PERM
...
> >>>  289 2023-10-03 10:18:16.509229 192.168.1.134 =E2=86=92 192.168.1.106=
 TCP 74
> >>> 695 =E2=86=92 2049 [SYN] Seq=3D0 Win=3D32120 Len=3D0 MSS=3D1460 SACK_=
PERM
...
> >>>  294 2023-10-03 10:18:19.551062 192.168.1.134 =E2=86=92 192.168.1.106=
 TCP 74
> >>> 940 =E2=86=92 2049 [SYN] Seq=3D0 Win=3D32120 Len=3D0 MSS=3D1460 SACK_=
PERM
...
> >>>  300 2023-10-03 10:18:22.590380 192.168.1.134 =E2=86=92 192.168.1.106=
 TCP 74
> >>> 810 =E2=86=92 2049 [SYN] Seq=3D0 Win=3D32120 Len=3D0 MSS=3D1460 SACK_=
PERM
...
> >>>  308 2023-10-03 10:18:25.628256 192.168.1.134 =E2=86=92 192.168.1.106=
 TCP 74
> >>> 877 =E2=86=92 2049 [SYN] Seq=3D0 Win=3D32120 Len=3D0 MSS=3D1460 SACK_=
PERM
...
> >>>  312 2023-10-03 10:18:28.665682 192.168.1.134 =E2=86=92 192.168.1.106=
 TCP 74
> >>> 934 =E2=86=92 2049 [SYN] Seq=3D0 Win=3D32120 Len=3D0 MSS=3D1460 SACK_=
PERM
...
> >>>  320 2023-10-03 10:18:31.702236 192.168.1.134 =E2=86=92 192.168.1.106=
 TCP 74
> >>> 803 =E2=86=92 2049 [SYN] Seq=3D0 Win=3D32120 Len=3D0 MSS=3D1460 SACK_=
PERM
...
> >>>  322 2023-10-03 10:18:31.702729 192.168.1.134 =E2=86=92 192.168.1.106=
 TCP 66
> >>> 803 =E2=86=92 2049 [ACK] Seq=3D1 Ack=3D1 Win=3D32128 Len=3D0 TSval=3D=
3081688040
> >>> TSecr=3D1993141756
...
> >>>  324 2023-10-03 10:18:31.702893 192.168.1.106 =E2=86=92 192.168.1.134=
 TCP 66
> >>> 2049 =E2=86=92 803 [ACK] Seq=3D1 Ack=3D173 Win=3D31872 Len=3D0 TSval=
=3D1993141756
> >>> TSecr=3D3081688040
...
> >>>  750 2023-10-03 10:19:01.880616 192.168.1.134 =E2=86=92 192.168.1.106=
 TCP 66
> >>> 803 =E2=86=92 2049 [ACK] Seq=3D173 Ack=3D141 Win=3D32000 Len=3D0 TSva=
l=3D3081718241
> >>> TSecr=3D1993171927
> >>>
> >>>
> >>>> SYNs. If the server is not replying to our SYN packets, then the TCP
> >>>> layer will back off and retransmit. So there is already a backoff-re=
try
