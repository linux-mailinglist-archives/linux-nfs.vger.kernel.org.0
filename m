Return-Path: <linux-nfs+bounces-9118-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E529A09C5B
	for <lists+linux-nfs@lfdr.de>; Fri, 10 Jan 2025 21:26:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 8D73B3A6D4E
	for <lists+linux-nfs@lfdr.de>; Fri, 10 Jan 2025 20:26:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D4C04211A20;
	Fri, 10 Jan 2025 20:26:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="B92teyz4"
X-Original-To: linux-nfs@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8ADB120766D
	for <linux-nfs@vger.kernel.org>; Fri, 10 Jan 2025 20:26:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1736540779; cv=none; b=EiAiib9vQJjYm25rXeZPNsQpscECLr2DwDev4v2puAkllHEBvHa3o0qcOhUvhxx8ckMPKZhKEP4JT2ITwyO0QC7CX36NSioPOwt0bmJquMO36GTOEMEyQWjnvcwUm4wxXprV26xXh5vLtzgkHZc7xDjsiDDj6ETryC20FT44VnI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1736540779; c=relaxed/simple;
	bh=Zesvp5Bct08QHSHhPxQE8aAvPupCCnhCTv/qAcmFJM0=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=ot0CWiDbpT4ov6qnVEcaj2ccPU9vLHS4nBcv3/WpFw7JQCJ3VtLfHNWktO0mqqndZGn55ZVvQ3c0kkCEihu7SFmOgEWf72je1tnltbhZUUPbdUB4UTxPM79YIDmVvDhBhsSGJ0tOTOZKp2fTKPmG3zFk6Ksmr/911hPcdZiZr2o=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=B92teyz4; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1736540770;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 in-reply-to:in-reply-to:references:references;
	bh=UgxAxNSjGv1+E6eBgkBJ/+sjI3QvvKyQNAGq/LSshDk=;
	b=B92teyz4x5KxQV9nAo6qLJCfRSw4qgIw7QZu5tlDDgYgNLCz1mlBBGWvmfMmScBwcJCYMJ
	cnranRAsS6Z3+9k+kmoZnMHmIxZWM/c9buzP/EU1Pj/QBVk1wSgckH3rowYY1cauNh3ONC
	usMTakvpV3xEHclJj44uAygBRg7y42M=
Received: from mx-prod-mc-03.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-564-4MroSlRlOJ-HeLaqWjZ9gQ-1; Fri,
 10 Jan 2025 15:26:06 -0500
X-MC-Unique: 4MroSlRlOJ-HeLaqWjZ9gQ-1
X-Mimecast-MFC-AGG-ID: 4MroSlRlOJ-HeLaqWjZ9gQ
Received: from mx-prod-int-04.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-04.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.40])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-03.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 29E9E1956063;
	Fri, 10 Jan 2025 20:26:05 +0000 (UTC)
Received: from aion.redhat.com (unknown [10.22.80.211])
	by mx-prod-int-04.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id C475819560AD;
	Fri, 10 Jan 2025 20:26:02 +0000 (UTC)
Received: by aion.redhat.com (Postfix, from userid 1000)
	id BEEFD2EA23D; Fri, 10 Jan 2025 15:26:00 -0500 (EST)
Date: Fri, 10 Jan 2025 15:26:00 -0500
...
Message-ID: <Z4GCWEPwKufXCCEZ@aion>
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="2ZtD+S9duMp0yK6X"
...
On Fri, 10 Jan 2025, Scott Mayhew wrote:
...
do=0A        for c40 in \  \#; do=0A          for v40 in n y; do=0A        =
   ...
   for c42 in \  \#; do=0A                  for v42 in n y; do=0A          =
          (( i++ ))=0A                    if [ "$v3" =3D "n" -a "$v4" =3D "=
n" -a "$c3" !=3D "#" -a "$c4" !=3D "#" ]; then=0A                      echo=
 -e "skip $i: ${c3}vers3=3D$v3 ${c4}vers4=3D$v4 ${c40}vers4.0=3D$v40 ${c41}=
vers4.1=3D$v41 ${c42}vers4.2=3D$v42"=0A                      continue=0A   =
                 fi=0A                    echo -e "test $i: ${c3}vers3=3D$v=
...
skip 1:  vers3=n  vers4=n  vers4.0=n  vers4.1=n  vers4.2=n
skip 2:  vers3=n  vers4=n  vers4.0=n  vers4.1=n  vers4.2=y
skip 3:  vers3=n  vers4=n  vers4.0=n  vers4.1=n #vers4.2=n
skip 4:  vers3=n  vers4=n  vers4.0=n  vers4.1=n #vers4.2=y
skip 5:  vers3=n  vers4=n  vers4.0=n  vers4.1=y  vers4.2=n
skip 6:  vers3=n  vers4=n  vers4.0=n  vers4.1=y  vers4.2=y
skip 7:  vers3=n  vers4=n  vers4.0=n  vers4.1=y #vers4.2=n
skip 8:  vers3=n  vers4=n  vers4.0=n  vers4.1=y #vers4.2=y
skip 9:  vers3=n  vers4=n  vers4.0=n #vers4.1=n  vers4.2=n
skip 10:  vers3=n  vers4=n  vers4.0=n #vers4.1=n  vers4.2=y
skip 11:  vers3=n  vers4=n  vers4.0=n #vers4.1=n #vers4.2=n
skip 12:  vers3=n  vers4=n  vers4.0=n #vers4.1=n #vers4.2=y
skip 13:  vers3=n  vers4=n  vers4.0=n #vers4.1=y  vers4.2=n
skip 14:  vers3=n  vers4=n  vers4.0=n #vers4.1=y  vers4.2=y
skip 15:  vers3=n  vers4=n  vers4.0=n #vers4.1=y #vers4.2=n
skip 16:  vers3=n  vers4=n  vers4.0=n #vers4.1=y #vers4.2=y
skip 17:  vers3=n  vers4=n  vers4.0=y  vers4.1=n  vers4.2=n
skip 18:  vers3=n  vers4=n  vers4.0=y  vers4.1=n  vers4.2=y
skip 19:  vers3=n  vers4=n  vers4.0=y  vers4.1=n #vers4.2=n
skip 20:  vers3=n  vers4=n  vers4.0=y  vers4.1=n #vers4.2=y
skip 21:  vers3=n  vers4=n  vers4.0=y  vers4.1=y  vers4.2=n
skip 22:  vers3=n  vers4=n  vers4.0=y  vers4.1=y  vers4.2=y
skip 23:  vers3=n  vers4=n  vers4.0=y  vers4.1=y #vers4.2=n
skip 24:  vers3=n  vers4=n  vers4.0=y  vers4.1=y #vers4.2=y
skip 25:  vers3=n  vers4=n  vers4.0=y #vers4.1=n  vers4.2=n
skip 26:  vers3=n  vers4=n  vers4.0=y #vers4.1=n  vers4.2=y
skip 27:  vers3=n  vers4=n  vers4.0=y #vers4.1=n #vers4.2=n
skip 28:  vers3=n  vers4=n  vers4.0=y #vers4.1=n #vers4.2=y
skip 29:  vers3=n  vers4=n  vers4.0=y #vers4.1=y  vers4.2=n
skip 30:  vers3=n  vers4=n  vers4.0=y #vers4.1=y  vers4.2=y
skip 31:  vers3=n  vers4=n  vers4.0=y #vers4.1=y #vers4.2=n
skip 32:  vers3=n  vers4=n  vers4.0=y #vers4.1=y #vers4.2=y
skip 33:  vers3=n  vers4=n #vers4.0=n  vers4.1=n  vers4.2=n
skip 34:  vers3=n  vers4=n #vers4.0=n  vers4.1=n  vers4.2=y
skip 35:  vers3=n  vers4=n #vers4.0=n  vers4.1=n #vers4.2=n
skip 36:  vers3=n  vers4=n #vers4.0=n  vers4.1=n #vers4.2=y
skip 37:  vers3=n  vers4=n #vers4.0=n  vers4.1=y  vers4.2=n
skip 38:  vers3=n  vers4=n #vers4.0=n  vers4.1=y  vers4.2=y
skip 39:  vers3=n  vers4=n #vers4.0=n  vers4.1=y #vers4.2=n
skip 40:  vers3=n  vers4=n #vers4.0=n  vers4.1=y #vers4.2=y
skip 41:  vers3=n  vers4=n #vers4.0=n #vers4.1=n  vers4.2=n
skip 42:  vers3=n  vers4=n #vers4.0=n #vers4.1=n  vers4.2=y
skip 43:  vers3=n  vers4=n #vers4.0=n #vers4.1=n #vers4.2=n
skip 44:  vers3=n  vers4=n #vers4.0=n #vers4.1=n #vers4.2=y
skip 45:  vers3=n  vers4=n #vers4.0=n #vers4.1=y  vers4.2=n
skip 46:  vers3=n  vers4=n #vers4.0=n #vers4.1=y  vers4.2=y
skip 47:  vers3=n  vers4=n #vers4.0=n #vers4.1=y #vers4.2=n
skip 48:  vers3=n  vers4=n #vers4.0=n #vers4.1=y #vers4.2=y
skip 49:  vers3=n  vers4=n #vers4.0=y  vers4.1=n  vers4.2=n
skip 50:  vers3=n  vers4=n #vers4.0=y  vers4.1=n  vers4.2=y
skip 51:  vers3=n  vers4=n #vers4.0=y  vers4.1=n #vers4.2=n
skip 52:  vers3=n  vers4=n #vers4.0=y  vers4.1=n #vers4.2=y
skip 53:  vers3=n  vers4=n #vers4.0=y  vers4.1=y  vers4.2=n
skip 54:  vers3=n  vers4=n #vers4.0=y  vers4.1=y  vers4.2=y
skip 55:  vers3=n  vers4=n #vers4.0=y  vers4.1=y #vers4.2=n
skip 56:  vers3=n  vers4=n #vers4.0=y  vers4.1=y #vers4.2=y
skip 57:  vers3=n  vers4=n #vers4.0=y #vers4.1=n  vers4.2=n
skip 58:  vers3=n  vers4=n #vers4.0=y #vers4.1=n  vers4.2=y
skip 59:  vers3=n  vers4=n #vers4.0=y #vers4.1=n #vers4.2=n
skip 60:  vers3=n  vers4=n #vers4.0=y #vers4.1=n #vers4.2=y
skip 61:  vers3=n  vers4=n #vers4.0=y #vers4.1=y  vers4.2=n
skip 62:  vers3=n  vers4=n #vers4.0=y #vers4.1=y  vers4.2=y
skip 63:  vers3=n  vers4=n #vers4.0=y #vers4.1=y #vers4.2=n
skip 64:  vers3=n  vers4=n #vers4.0=y #vers4.1=y #vers4.2=y
