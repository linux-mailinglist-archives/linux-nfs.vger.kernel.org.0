...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B33E9698596
	for <lists+linux-nfs@lfdr.de>; Wed, 15 Feb 2023 21:32:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229478AbjBOUce (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Wed, 15 Feb 2023 15:32:34 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50290 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229748AbjBOUce (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Wed, 15 Feb 2023 15:32:34 -0500
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.220.29])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 45B8939BB5
        for <linux-nfs@vger.kernel.org>; Wed, 15 Feb 2023 12:32:32 -0800 (PST)
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by smtp-out2.suse.de (Postfix) with ESMTPS id 048B91F88B;
        Wed, 15 Feb 2023 20:32:31 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
        t=1676493151; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=Gsh1Vi2BVzsf2G2LniR8GDoFKvuu0tArWvz7vs9MmIU=;
        b=k2+fftRTiS960to0NNI8t1ow21qttl1ncbk0Znrugj9+HKuUU8IMQEfpJU9YHkTl+QNozn
        ZBqiI0QCgvZwVc11i/re6KcPtBbaG2ND29RUmWzB33OX41DiZ9Q/2CgY52uJu13/pBM1bP
        61eGGuBQ4pkYyBMVIv9b0tVkfiu/m5o=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
        s=susede2_ed25519; t=1676493151;
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=Gsh1Vi2BVzsf2G2LniR8GDoFKvuu0tArWvz7vs9MmIU=;
        b=+Kl+aKqCFoafafMAUvusVungEUU0+5t3OCyX2W47lIdKY3fSoqrrwIjp15KzCH5GvWeImY
        SozbwjFVFOt0DFCQ==
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by imap2.suse-dmz.suse.de (Postfix) with ESMTPS id 07070134BA;
        Wed, 15 Feb 2023 20:32:28 +0000 (UTC)
Received: from dovecot-director2.suse.de ([192.168.254.65])
        by imap2.suse-dmz.suse.de with ESMTPSA
        id NAoFJ1xB7WP6HwAAMHmgww
        (envelope-from <neilb@suse.de>); Wed, 15 Feb 2023 20:32:28 +0000
...
Date:   Thu, 16 Feb 2023 07:32:25 +1100
Message-id: <167649314509.15170.15885497881041431304@noble.neil.brown.name>
...
@@ -1808,6 +1810,66 @@ static int nfs_inode_finish_partial_attr_update(const =
...
+
 static int nfs_refresh_inode_locked(struct inode *inode,
 				    struct nfs_fattr *fattr)
 {
@@ -1818,8 +1880,12 @@ static int nfs_refresh_inode_locked(struct inode *inod=
e,
=20
...
=20
 	...
 	return ret;
@@ -1910,6 +1976,8 @@ int nfs_post_op_update_inode_force_wcc_locked(struct in=
...
@@ -2064,6 +2132,15 @@ static int nfs_update_inode(struct inode *inode, struc=
t nfs_fattr *fattr)
=20
...
@@ -2085,8 +2162,11 @@ static int nfs_update_inode(struct inode *inode, struc=
t nfs_fattr *fattr)
