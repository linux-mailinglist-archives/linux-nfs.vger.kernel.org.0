...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5042611882B
	for <lists+linux-nfs@lfdr.de>; Tue, 10 Dec 2019 13:31:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727131AbfLJMbr (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Tue, 10 Dec 2019 07:31:47 -0500
Received: from us-smtp-2.mimecast.com ([207.211.31.81]:21071 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1727577AbfLJMb3 (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Tue, 10 Dec 2019 07:31:29 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        ...
        bh=L7GomaXy3NSy+VZ+3fqcJgcRZ3RjuoRRRUdtpeBxkHI=;
        b=EyvDR2/0M3brOeIB4vh0O3GW7tdf5dnmyh4c/yYMfbkTQTigk/AHi9G24N0yp7rd+Nib+p
        fHfbV9XWeqOldFB5Cm/ViESn4Rknftwu3jKJCGkGpTX+pq/9BeZzyrZ3PW1mp6NUv9gsJ3
        9mewhxUBM0Gf9dY1ANzu/1lT5bOibuI=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-49-dEoDWKVoMBy82_QJ_DRgjg-1; Tue, 10 Dec 2019 07:31:19 -0500
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.12])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id DB67D107ACC9;
        Tue, 10 Dec 2019 12:31:17 +0000 (UTC)
Received: from coeurl.usersys.redhat.com (ovpn-123-90.rdu2.redhat.com [10.10.123.90])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 74FED60BE2;
        Tue, 10 Dec 2019 12:31:17 +0000 (UTC)
Received: by coeurl.usersys.redhat.com (Postfix, from userid 1000)
        id 14FA720C4B; Tue, 10 Dec 2019 07:31:16 -0500 (EST)
From:   Scott Mayhew <smayhew@redhat.com>
To:     anna.schumaker@netapp.com, trond.myklebust@hammerspace.com
Cc:     dhowells@redhat.com, viro@zeniv.linux.org.uk,
        linux-nfs@vger.kernel.org, linux-fsdevel@vger.kernel.org,
        linux-kernel@vger.kernel.org, linux-security-module@vger.kernel.org
Subject: [PATCH v6 25/27] NFS: Add fs_context support.
Date:   Tue, 10 Dec 2019 07:31:13 -0500
Message-Id: <20191210123115.1655-26-smayhew@redhat.com>
In-Reply-To: <20191210123115.1655-1-smayhew@redhat.com>
References: <20191210123115.1655-1-smayhew@redhat.com>
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.12
X-MC-Unique: dEoDWKVoMBy82_QJ_DRgjg-1
...
---
 ...
 fs/nfs/namespace.c      | 136 +++++++-----
 fs/nfs/nfs3proc.c       |   2 +-
 fs/nfs/nfs4_fs.h        |   9 +-
 fs/nfs/nfs4file.c       |   1 +
 fs/nfs/nfs4namespace.c  | 293 ++++++++++++++-----------
 fs/nfs/nfs4proc.c       |   2 +-
...
+=09=09goto out_fc;
=20
 =09if (nfs_mountpoint_expiry_timeout < 0)
-=09=09goto out;
+=09=09goto out_fc;
=20
...
=20
 /*
@@ -100,21 +128,32 @@ static char *nfs4_path(struct dentry *dentry, char *b=
...
+=09=09=09__func__, path, ctx->nfs_server.export_path);
 ...
 =09}
=20
@@ -236,55 +275,83 @@ nfs4_negotiate_security(struct rpc_clnt *clnt, struct=
 inode *inode,
 =09return new;
 }
=20
...
=20
 /**
@@ -293,38 +360,23 @@ static struct vfsmount *try_location(struct nfs_clone=
_mount *mountdata,
...
c];
=20
@@ -332,15 +384,12 @@ static struct vfsmount *nfs_follow_referral(struct de=
ntry *dentry,
...
=20
 /*
@@ -348,71 +397,73 @@ static struct vfsmount *nfs_follow_referral(struct de=
ntry *dentry,
...
--- a/fs/nfs/nfs4proc.c
+++ b/fs/nfs/nfs4proc.c
@@ -10001,7 +10001,7 @@ const struct nfs_rpc_ops nfs_v4_clientops =3D {
