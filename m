...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        ...
        b=M4Rwr4zUpIH4t7C9MFAeluB1yDt3eiMKwToiWqfoRx74X8XimgsM7Jtz2DzwyGOjl
         v5/dn9FuVR7t6LcX6gDtnkDAkarSGdnlG7dyq7Rm2XTMgLOxrFhUQT+G4Xt1+cEPMs
         369gnc7sAyV6y18zChXmSwdy+oGvxe0y+vCimhzI=
From:   trondmy@kernel.org
To:     linux-nfs@vger.kernel.org
Subject: [PATCH v4 02/21] NFS: Remove unnecessary inode lock in nfs_fsync_dir()
Date:   Sat,  7 Nov 2020 09:03:06 -0500
Message-Id: <20201107140325.281678-3-trondmy@kernel.org>
X-Mailer: git-send-email 2.28.0
In-Reply-To: <20201107140325.281678-2-trondmy@kernel.org>
