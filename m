Return-Path: <linux-nfs+bounces-2583-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 981A1893F06
	for <lists+linux-nfs@lfdr.de>; Mon,  1 Apr 2024 18:11:04 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id BB5951C214B3
	for <lists+linux-nfs@lfdr.de>; Mon,  1 Apr 2024 16:11:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F203B446AC;
	Mon,  1 Apr 2024 16:11:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="aOS6p8o+"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CC2A48F5C
	for <linux-nfs@vger.kernel.org>; Mon,  1 Apr 2024 16:11:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711987862; cv=none; b=jJPpH3r9A85IbmrEvKUb+eCMgKLDTQ1eNOL9szK7YN2qr4XUuf8/P6KGzh053ab9KWJ5fv6LtBTCjAFSmb9uUdoPPpzbyaZMUkrEuoeJXqaVZyCtkySpnA0I/fimuoC8QBxwfPANLXoysXDH7X5gpvpQ8D52YdcHGARubpDCP0o=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711987862; c=relaxed/simple;
	bh=d8mgjpaFKQnVyJgfATbXAqQlyYrBaZ4FgW2bUnUJtCE=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=fLcl7bFL9d/HlqV7DwJ1F7fwlBcJyZLsSJMw3B32yVA0u/yMIs2qw8gWJl0tNfvG3DBssVztTggzGIXYXhQM1ZkR1qHUdIl5pu5Lf1KkBrIdCyt0lQPcIoils8eSPLX6WCuSoxzemY7xTA8A+ZmSYtKWw9eoUQyA5RYvmsCIGTs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=aOS6p8o+; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 3EB62C43390;
	Mon,  1 Apr 2024 16:11:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1711987862;
	bh=d8mgjpaFKQnVyJgfATbXAqQlyYrBaZ4FgW2bUnUJtCE=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <4120c697bc92a27ed1f9a7289cb6113f19fe20de.camel@kernel.org>
...
Date: Mon, 01 Apr 2024 12:11:01 -0400
...
> > > > > > It could be straightforward, however, to move the callback_wq i=
nto
> > > > > > struct nfs4_client so that each client can have its own workque=
ue.
> > > > > > Then we can take some time and design something less brittle an=
d
> > > > > > more scalable (and maybe come up with some test infrastructure =
so
...
> >     deprecated.
> >    =20
> >     We don't actually care about ordering necessarily, but we do depend=
 on
> >     running at most one work item at a time: nfsd4_process_cb_update()
> >     assumes that no other thread is running it, and that no new callbac=
ks
