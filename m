Return-Path: <linux-nfs+bounces-12248-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 9974CAD3866
	for <lists+linux-nfs@lfdr.de>; Tue, 10 Jun 2025 15:12:33 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 1E0F716BE69
	for <lists+linux-nfs@lfdr.de>; Tue, 10 Jun 2025 13:06:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C850D2D29A6;
	Tue, 10 Jun 2025 12:59:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="IaIt2nv3"
X-Original-To: linux-nfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A09032D29A5
	for <linux-nfs@vger.kernel.org>; Tue, 10 Jun 2025 12:59:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1749560383; cv=none; b=MqIRBltSf7eark0nxebtD9hINNxMswO2ZdHk/xKKdsQ+A0usEA6birn3wEupSqlmAkWM6CWJvwDjaHK3AnbdJ8ewp61dLpY6EJWW4agQKKjuTNjvtsSkMuHzx/v4IGKWb32kUiENn/0IjLRUKqjinWuY/tBco4MHlN9TsuniAL4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1749560383; c=relaxed/simple;
	bh=SBpPOJPz5KDsPJWlVZbS4vgrWWzz+7dWQ+VD5rNi5uU=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=a/gGTr60lp9QD1YYB2jb2b6FsnuIT+EOgiM2qswVche0tp+D8VveQbYktBeRfoNB2/L8POsG06+7USeYUVqznrXeIEWEAgawV95qLipMrj9ndCkR+WSs+sZAwCvFCS/luTSnRdphUtAJjsbHCUORzLoYQcZ75aTxw5Yku0rkICA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=IaIt2nv3; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 23C67C4CEEF;
	Tue, 10 Jun 2025 12:59:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1749560383;
	bh=SBpPOJPz5KDsPJWlVZbS4vgrWWzz+7dWQ+VD5rNi5uU=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <3287ef4d7b7f0cec80e2f29eabf17ec32310c60d.camel@kernel.org>
Subject: Re: [nfsv4] Re: simple NFSv4.1/4.2 test of remove while holding a
 delegation
From: Jeff Layton <jlayton@kernel.org>
To: Rick Macklem <rick.macklem@gmail.com>
Cc: Dai Ngo <dai.ngo@oracle.com>, NFSv4 <nfsv4@ietf.org>, Linux NFS Mailing
 List <linux-nfs@vger.kernel.org>
Date: Tue, 10 Jun 2025 08:59:42 -0400
In-Reply-To: <CAM5tNy5nx=XQ2gTjhaE6h5z+SJMnKKeMZzPDMiMnkWZbGm6fCQ@mail.gmail.com>
References: 
	<CAM5tNy7kfqToA8p4-=LOnhvZuk36vocy32U6kgT+561uOWR_iQ@mail.gmail.com>
	 ...
	 <CAM5tNy5nx=XQ2gTjhaE6h5z+SJMnKKeMZzPDMiMnkWZbGm6fCQ@mail.gmail.com>
...
> > > > > I was surprised to see quite different results from the Linux knf=
sd
> > > > > and Solaris 11.4 NFSv4.1/4.2 servers. I think both these servers
> > > > > provide FH4_PERSISTENT file handles, although I suppose I
> > > > > should check that?
> > > > >=20
> > > > > First, the test OPEN/CREATEs a regular file called "foo" (only on=
e
...
.
> > > > > It does not say anything w.r.t. the fh arg. needing to be for a f=
ile
> > > > > that still exists.) Neither of these servers sets
> > > > > OPEN4_RESULT_PRESERVE_UNLINKED in the OPEN reply.
> > > > >=20
> > > > > So, it looks like "file object no longer exists" is indicated eit=
her
> > > > > by a NFS4ERR_STALE reply to either PUTFH or GETATTR
> > > > > OR
> > > > > by a successful reply, but with nlinks =3D=3D 0 for the GETATTR r=
eply.
> > > > >=20
> > > > > To be honest, I kinda like the Linux knfsd version, but I am wond=
ering
...
> > >   still work (which seems to be the case for the 6.12 server I am usi=
ng for
> > >   testing).
> > >=20
> >=20
...
> >=20
> > The inode will still exist in core (with nlinks =3D=3D 0) until its las=
t
...
> that the file object will be deleted if the client holds a write delegati=
on and
...
> > >      away with saying "the server should just discard the delegation =
as
...
> I'm not sure. So long as the server guarantees that the file object has b=
een
> deleted by the REMOVE, throwing NFS4ERR_STALE seems a reasonable alternat=
ive?
>=20
...
> > > > -Dai
> > > >=20
> > > > > (I don't think it is, but there is a discussion in 18.25.4 which =
says
> > > > > "When the determination above cannot be made definitively because
> > > > > delegations are being held, they MUST be recalled.." but everythi=
ng
> > > > > above that is a may/MAY, so it is not obvious to me if a server r=
eally
> > > > > needs to case?)
> > > > >=20
