...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 426E337A517
	for <lists+linux-nfs@lfdr.de>; Tue, 11 May 2021 12:52:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230237AbhEKKxo (ORCPT <rfc822;lists+linux-nfs@lfdr.de>);
        Tue, 11 May 2021 06:53:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56020 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231557AbhEKKxf (ORCPT
        <rfc822;linux-nfs@vger.kernel.org>); Tue, 11 May 2021 06:53:35 -0400
Received: from mail-pj1-x1030.google.com (mail-pj1-x1030.google.com [IPv6:2607:f8b0:4864:20::1030])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 81D80C06175F
        for <linux-nfs@vger.kernel.org>; Tue, 11 May 2021 03:52:29 -0700 (PDT)
Received: by mail-pj1-x1030.google.com with SMTP id na14-20020a17090b4c0eb029015cbbd5f028so828857pjb.1
        for <linux-nfs@vger.kernel.org>; Tue, 11 May 2021 03:52:29 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=bytedance-com.20150623.gappssmtp.com; s=20150623;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=fDVkMdVlv8miwozjHsh7GB2JUg1dHMhy3ePeK1EeLfQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=fDVkMdVlv8miwozjHsh7GB2JUg1dHMhy3ePeK1EeLfQ=;
        b=
X-Gm-Message-State: AOAM533vzEOkzGra1DSRFBZyS5QE4fHIMsSOidZL5ToBCq6jTkfL87pb
        Jkwn3wCMriyCXvQca6n1XH2R9Q==
X-Google-Smtp-Source: ABdhPJzUQgX4EQDAVnICVpPGPzOizsrTZ/06l+VKMq2ca5pTUrG1ja598LWNzyIuEJT9fqzlK2kiDg==
X-Received: by 2002:a17:902:f203:b029:ee:af8f:8e4b with SMTP id m3-20020a170902f203b02900eeaf8f8e4bmr28587257plc.23.1620730348945;
        Tue, 11 May 2021 03:52:28 -0700 (PDT)
Received: from localhost.localdomain ([139.177.225.240])
        by smtp.gmail.com with ESMTPSA id n18sm13501952pgj.71.2021.05.11.03.52.21
...
Subject: [PATCH 10/17] fs: introduce alloc_inode_sb() to allocate filesystems specific inode
Date:   Tue, 11 May 2021 18:46:40 +0800
Message-Id: <20210511104647.604-11-songmuchun@bytedance.com>
...
---
 ...
 59 files changed, 66 insertions(+), 58 deletions(-)
...
index 9114e0a0e7b4..4fc2ddb9e5ca 100644
--- a/fs/block_dev.c
+++ b/fs/block_dev.c
...
index 4af336008b12..2262f58c0179 100644
--- a/fs/btrfs/inode.c
+++ b/fs/btrfs/inode.c
@@ -8830,7 +8830,7 @@ struct inode *btrfs_alloc_inode(struct super_block *sb)
...
index 689e3ffd29d7..d5e95b524293 100644
--- a/fs/ceph/inode.c
+++ b/fs/ceph/inode.c
@@ -443,7 +443,7 @@ struct inode *ceph_alloc_inode(struct super_block *sb)
...
index e0c5e860a0ee..7cd5c389fbf9 100644
--- a/fs/cifs/cifsfs.c
+++ b/fs/cifs/cifsfs.c
@@ -360,7 +360,7 @@ static struct inode *
...
index a2a42335e8fd..1403b4bd6514 100644
--- a/fs/hugetlbfs/inode.c
+++ b/fs/hugetlbfs/inode.c
@@ -1103,7 +1103,7 @@ static struct inode *hugetlbfs_alloc_inode(struct super_block *sb)
...
index af48d1b722f0..68b9167ad18b 100644
--- a/fs/inode.c
+++ b/fs/inode.c
...
index 8031464ed4ae..815d7289bf93 100644
--- a/ipc/mqueue.c
+++ b/ipc/mqueue.c
...
index a08cedefbfaa..dad27ca340ef 100644
--- a/mm/shmem.c
+++ b/mm/shmem.c
@@ -3772,7 +3772,7 @@ static struct kmem_cache *shmem_inode_cachep;
