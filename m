Return-Path: <linux-nfs+bounces-11765-lists+linux-nfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-nfs@lfdr.de
Delivered-To: lists+linux-nfs@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 6368AAB994A
	for <lists+linux-nfs@lfdr.de>; Fri, 16 May 2025 11:48:18 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 2EA8E16B8DE
	for <lists+linux-nfs@lfdr.de>; Fri, 16 May 2025 09:48:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A3005231827;
	Fri, 16 May 2025 09:48:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kuleuven.be header.i=@kuleuven.be header.b="XUHETNPw";
	dkim=pass (2048-bit key) header.d=esat.kuleuven.be header.i=@esat.kuleuven.be header.b="UuIcCWrG"
...
Received: from icts-p-cavspool-1.kulnet.kuleuven.be (icts-p-cavspool-1.kulnet.kuleuven.be [134.58.240.194])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CA35B217F34
	for <linux-nfs@vger.kernel.org>; Fri, 16 May 2025 09:48:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=134.58.240.194
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1747388889; cv=none; b=HZ6KVGeWhnWpe0/KSuzLnU7VYDPakc8WVW56rzv3o35GfcqYPlL3d62U+59Wo5ijbOT7ymx9JR0+S7CifPxKU1sDLF0bar04N+O45rM0nvxkJzhDoW3GLJjYQEOcFqVaSPIT6nA7xV4fc/g9wVXWhla8CrAm0ySLFD1aVq2u+RQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1747388889; c=relaxed/simple;
	bh=bjYe9nvmcKoPbEW1g9GMnk5jfpK5wRFmUs0f0OETVGk=;
	h=Message-ID:Date:MIME-Version:Subject:From:To:Cc:References:
	 In-Reply-To:Content-Type; b=fmBXYicdxGKFnNrzr8kIRFC2XMB2P8aaiKfxDXH1Be/HQYFIwlkX6HBNKzSWKJgxyDqo3DeHce1pRZd+p6LTZZcjZkClONRdv1CBlKugHwA5UUCKkTF0ebVfRIwnfDJYYi6icGjI0NwGIBRR3XeaY+gb+PYQdMl1MxzxxnUiGeg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=esat.kuleuven.be; spf=pass smtp.mailfrom=esat.kuleuven.be; dkim=pass (2048-bit key) header.d=kuleuven.be header.i=@kuleuven.be header.b=XUHETNPw; dkim=pass (2048-bit key) header.d=esat.kuleuven.be header.i=@esat.kuleuven.be header.b=UuIcCWrG; arc=none smtp.client-ip=134.58.240.194
...
Received: from icts-p-cavuit-3.kulnet.kuleuven.be (icts-p-cavuit-3.kulnet.kuleuven.be [134.58.240.133])
	by icts-p-cavspool-1.kulnet.kuleuven.be (Postfix) with ESMTP id AA1F68080
	for <linux-nfs@vger.kernel.org>; Fri, 16 May 2025 11:48:01 +0200 (CEST)
X-KULeuven-Envelope-From: rik.theys@esat.kuleuven.be
X-KULeuven-Scanned: Found to be clean
X-KULeuven-ID: 675B3200D2.A5543
...
Received: from icts-p-ceifnet-smtps-0.kuleuven.be (icts-p-ceifnet-smtps.service.icts.svcd [IPv6:2a02:2c40:0:51:208:242:ac11:c])
	by icts-p-cavuit-3.kulnet.kuleuven.be (Postfix) with ESMTP id 675B3200D2;
	Fri, 16 May 2025 11:47:53 +0200 (CEST)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=kuleuven.be;
	s=kuleuven-cav-1; t=1747388873;
	bh=SL0Ux2x6fcnEZeKLpzrX1Wksi7cLShi9vemNuYR1qgQ=;
	h=Date:Subject:From:To:Cc:References:In-Reply-To;
	b=
Received: from hydrogen.esat.kuleuven.be (hydrogen.esat.kuleuven.be [134.58.56.153])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by icts-p-ceifnet-smtps-0.kuleuven.be (Postfix) with ESMTPS id 34D01D4EE7D20;
	Fri, 16 May 2025 11:47:53 +0200 (CEST)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=esat.kuleuven.be;
	s=esat20220324; t=1747388873;
	bh=SL0Ux2x6fcnEZeKLpzrX1Wksi7cLShi9vemNuYR1qgQ=;
	h=Date:Subject:From:To:Cc:References:In-Reply-To:From;
	b=
X-KULeuven-ESAT-Envelope-Sender: rik.theys@esat.kuleuven.be
Received: from [192.168.1.113] (d54C12615.access.telenet.be [84.193.38.21])
	...
	(No client certificate requested)
	by hydrogen.esat.kuleuven.be (Postfix) with ESMTPSA id 1BB926000E;
	Fri, 16 May 2025 11:47:53 +0200 (CEST)
Message-ID: <8abc8a16-cbdb-4285-a2da-62f57fbbb165@esat.kuleuven.be>
Date: Fri, 16 May 2025 11:47:52 +0200
Precedence: bulk
...
In-Reply-To: <b8f4f808-48df-4659-9afb-2f9994b22e7b@esat.kuleuven.be>
